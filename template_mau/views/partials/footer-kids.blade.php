    ...
    <div class="container">
        <div class="row accordion" id="footer-accordion">
            ...
            <div class="col-md-2 col-lg-2 mb-2 accordion-item footer-accordion-item">
                ...
                <h5 class="d-none d-md-block font-futura fw-normal">Categories</h5>
            ...
            <div class="col-md-3 col-lg-2 mb-2 accordion-item footer-accordion-item">
                ...
                <h5 class="d-none d-md-block font-futura fw-normal">Infomation</h5>
            ...
            <div class="col-md-3 col-lg-2 mb-2 accordion-item footer-accordion-item">
                ...
                <h5 class="d-none d-md-block font-futura fw-normal">Useful links</h5>
            ...
            <div class="col-md-10 col-lg-3 mb-2 accordion-item footer-accordion-item">
                ...
                <h5 class="d-none d-md-block font-futura fw-normal">Newsletter Signup</h5>
                    ...
                    <div class="mt-md-4 pt-md-2">
                        ...
                        <form id="contact_form" class="d-block">
                            <div class="footer-subscribe position-relative">
                                ...
                                <button type="submit" class="btn footer-kids-btn btn-dark position-absolute rounded-pill">
                                    <span>Subscribe</span>
                                </button>
                            </div>
                        </form>
...
<div class="footer-alt mb-5 mb-lg-0 py-4 bg-pink2">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 text-lg-start text-center text-white">
                Copyright ©
                <script>document.write(new Date().getFullYear())</script> <a href="#!" class="text-white">Kalles</a> all
