<div id="kalles-section-header_top">
    <div class="h__top d-flex align-items-center header-trend-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-custom py-0 d-flex align-items-center">
        <div class="container-fluid">
                                        ...
                                        <div class="row p-4">
                                                ...
                                                <div class="swiper saleSwiper">
                                                    <div class="swiper-wrapper">
                                                        <div class="swiper-slide">
                                                            <div x-data="{ imageUrl: '/build/images/home-bags/pr-26.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                                                                <div class="position-relative overflow-hidden">
                                                                    <img :src="isHovered ? '/build/images/home-bags/pr-26.jpg' : imageUrl" alt="" class="img-fluid">
                                                                ...
                                                                <a href="{{ url('product/product-detail-layout-01')}}" class="mt-3 d-block text-center">
                                                                    <h6 class="mb-1"> Antihero Fortnight Backpack</h6>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div x-data="{ imageUrl: '/build/images/home-bags/pr-03.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                                                                <div class="position-relative overflow-hidden">
                                                                    <img :src="isHovered ? '/build/images/home-bags/pr-03.jpg' : imageUrl" alt="" class="img-fluid">
                                                                    <a href="#" class="d-lg-none position-absolute " style="z-index: 1; top:10px; left:10px;" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o text-white"></i></a>
                                                                    <a href="#" class="wishlistadd d-none d-lg-flex position-absolute" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o text-white"></i></a>
                                                                ...
                                                                <a href="{{ url('product/product-detail-layout-01')}}" class="mt-3 d-block text-center">
                                                                    <h6 class="mb-1"> Crumpler The Drewbob 200</h6>
                                                                    <p class="mb-0 fs-14 text-muted">
                                                                        <span>$79.00</span>
                                                                    </p>
                                                                </a>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div x-data="{ imageUrl: '/build/images/home-bags/pr-01.jpg' }" class="topbar-product-card pb-3">
                                                                <div class="position-relative overflow-hidden">
                                                                ...
                                                                <div class="mt-3 text-center">
                                                                    <h6 class="mb-1"><a href="{{ url('product/product-detail-layout-01')}}" class="product-title">Tactical Bags</a>
                                                                    </h6>
                                                                    <p class="mb-0 fs-14 text-muted">
                                                                        <span>$51.00 – $56.00</span>
                                                                    </p>
                                            ...
                                            <div class="col-lg-6 cat-section p-0 ps-4">
                                                <a href="{{url( 'shop_pages.shop-left-sidebar')}}" class="d-block position-relative cat_grid_item overflow-hidden " style="height: 350px;">
                                                    <div class="h-100 w-100 cat-grid-img" style="background-image: url('{{ asset('/build/images/home-fashion-trend/megamenu-banner.jpg')}}"></div>
                                                    <div class="cat-grid-button text-body">
                                                        <div class="cat_grid_item__title">Messenger</div>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
            ...
            <div class="topbar-toolbar d-flex align-items-center gap-3">
                <a data-bs-toggle="offcanvas" href="#searchOffcanvas" aria-controls="searchOffcanvas"><i class="iccl iccl-search" style="transform: rotate(90deg);"></i></a>
