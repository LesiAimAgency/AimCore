<div id="pop-main" class="d-none d-lg-block">
    <div class="pop-up d-none">
        <div class="pop-card position-relative d-flex align-items-center">
            <div class="popup-img">
                <a href="#!">
                    <img src="{{ URL::asset('/build/images/popup/pr-1.jpg')}}" alt="">
                </a>
            </div>
    ...
    <div class="pop-up d-none">
        <div class="pop-card position-relative d-flex align-items-center">
            <div class="popup-img">
                <a href="#!">
                    <img src="{{ URL::asset('/build/images/popup/pr-2.jpg')}}" alt="">
                </a>
            </div>
            <div class="text-start popup-text">
    ...
    <div class="pop-up d-none">
        <div class="pop-card position-relative d-flex align-items-center">
            <div class="popup-img">
                <a href="#!">
                    <img src="{{ URL::asset('/build/images/popup/pr-3.jpg')}}" alt="">
                </a>
            </div>
            <div class="text-start popup-text">
    ...
    <div class="pop-up d-none">
        <div class="pop-card position-relative d-flex align-items-center">
            <div class="popup-img">
                <a href="#!">
                    <img src="{{ URL::asset('/build/images/about-us/mem-02.jpeg')}}" alt="">
                </a>
            </div>
            <div class="text-start popup-text">
                <p class="mb-0">Hau (California) <span class="text-muted">purchased</span></p>
