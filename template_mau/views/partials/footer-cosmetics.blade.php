<footer class="footer bg-light">
    <div class="container">
        <div class="row accordion" id="footer-accordion">
            <div class="col-lg-3 col-md-4 mb-2 footer-accordion-item accordion-item">
                <button class="accordion-button footer-accordion-button px-0 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                    <h5 class="font-playfair">Get in touch</h5>
                </button>
                <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <a href="#!">
                        <img src="{{ URL::asset('/build/images/svg/kalles.svg')}}" alt="" height="29">
                    </a>
                    <div class="mt-4 pt-2">
            ...
            <div class="col-lg-2 col-md-2 mb-2 accordion-item footer-accordion-item">
                <button class="accordion-button footer-accordion-button px-0 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                    <h5 class="font-playfair">Categories</h5>
                </button>
                <h5 class="fw-medium d-none d-md-block font-playfair">Categories</h5>
                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="mt-md-4 pt-md-2">
                        <ul class="menu list-unstyled">
                            <li class="menu-item">
                                <a href="{{ url('shop_pages/shop-filter-sidebar')}}" class="text-muted">Men</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ url('shop_pages/shop-filter-sidebar')}}" class="text-muted">Women</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ url('shop_pages/shop-1600px-layout')}}" class="text-muted">Accessories</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ url('shop_pages/shop-1600px-layout')}}" class="text-muted">Shoes</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ url('shop_pages/shop-1600px-layout')}}" class="text-muted">Denim</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ url('shop_pages/shop-1600px-layout')}}" class="text-muted">Dress</a>
                            </li>
                        </ul>
                    </div>
                </div>
            </div><!--end col-->
            <div class="col-lg-2 col-md-3 mb-2 accordion-item footer-accordion-item">
                <button class="accordion-button footer-accordion-button px-0 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                    <h5 class="font-playfair">Infomation</h5>
                </button>
                <h5 class="fw-medium d-none d-md-block font-playfair">Infomation</h5>
            ...
            <div class="col-lg-2 col-md-3 mb-2 accordion-item footer-accordion-item">
                <button class="accordion-button footer-accordion-button px-0 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                    <h5 class="font-playfair">Useful links</h5>
                </button>
                <h5 class="fw-medium d-none d-md-block font-playfair">Useful links</h5>
            ...
            <div class="col-lg-3 col-md-10 mb-2 accordion-item footer-accordion-item">
                <button class="accordion-button footer-accordion-button px-0 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                    <h5 class="font-playfair">Newsletter Signup</h5>
                </button>
                <h5 class="fw-medium d-none d-md-block font-playfair">Newsletter Signup</h5>
                    ...
                    <div class="mt-md-4 pt-md-2">
                        ...
                        <form id="contact_form" class="d-block">
                            <div class="footer-subscribe position-relative">
                                <input type="email" name="email" placeholder="Your email address" value="" class="input-text form-control w-100 rounded-pill" required="required">
                                <button type="submit" class="btn bg-lima text-white position-absolute rounded-pill">
                                    <span>Subscribe</span>
                                </button>
                            </div>
                        </form>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 text-lg-start text-center text-muted">
                Copyright ©
                <script>document.write(new Date().getFullYear())</script> <a href="#!" class="text-lima">Kalles</a> all
