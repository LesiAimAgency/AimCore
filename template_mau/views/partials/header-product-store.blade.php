<div id="kalles-section-header_top " class="header-lingeries navbar-product">
    <div class="h__top d-flex align-items-center">
        <div class="container-fluid">
            <div class="row align-items-center py-1 py-md-0">
                ...
                <div class="col-md-5 col-xl-4 col-12">
                    <div class="header-text text-center fs-12 text-white py-1 py-md-0">
                        Summer sale discount off <span class="cr text-muted">50%</span>! <a href="{{ url('shop_pages/shop')}}" class="text-reset">Shop Now</a>
                    </div>
                </div>
                <div class="col-md-2 col-xl-4 col-12">
                    <div class="dropdown text-center text-md-end position-relative">
                        <a href="#!" class="fs-12 currency-button text-white" type="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <nav class=" navbar navbar-expand-lg navbar-custom py-0 d-flex align-items-center" :class="{ ' shadow-sm' : showMenuScroll }" @scroll.window="showMenuScroll = (window.pageYOffset > 0) ? true : false">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="{{ url('index')}}"><img src="{{ URL::asset('/build/images/home-one-product-store/header-logo-01.png')}}" alt="" width="95"></a>
            <div class="collapse navbar-collapse mobile-menu-navbar " id="navbarSupportedContent">
                <div class="d-none d-lg-block mx-auto ">
                    <ul class="navbar-nav light-navbar  mx-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown dropdown-mega-xxl">
                            <a class="nav-link fw-medium text-white" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                Demo
                            </a>
                        ...
                        <li class="nav-item dropdown dropdown-mega-xxl">
                            <a class="nav-link position-relative text-white" href="{{ url('shop_pages/shop-filter-sidebar')}}" data-bs-toggle="dropdown" aria-expanded="false">
                                Shop <span class="badge bg-info fw-normal">New</span>
                            </a>
                            <div class="dropdown-menu p-3">
                                <div class="row g-0">
                                    ...
                                    <div class="col-lg-6 cat-section p-4">
                                        <a href="{{url( 'shop_pages.shop-left-sidebar')}}" class="d-block position-relative cat_grid_item overflow-hidden " style="height: 380px;">
                                            <div class="h-100 w-100 cat-grid-img" style="background-image: url('{{ asset('/build/images/home-one-product-store/mega-menu-banner.jpg')}}"></div>
                        ...
                        <li class="nav-item dropdown dropdown-mega-xxl">
                            <a class="nav-link fw-medium text-white" href="{{ url('product/product-detail-layout-01')}}" data-bs-toggle="dropdown" aria-expanded="false">
                                Product
                            </a>
                            <div class="dropdown-menu">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-2">
                                        <div class="dropdown-sub-column-item">
                                            ...
                                            <a href="#!" class="dropdown-menu-title">Pharmacy</a>
                                            <a href="#!" class="dropdown-menu-title">Dress</a>
                                            <a href="#!" class="dropdown-menu-title">Men</a>
                                        </div>
                                    </div>
                                    <div class="col-lg-10">
                                        <!-- Swiper -->
                                        <div class="swiper mySwiper">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <div class="topbar-product-card pb-3">
                                                        <div class="position-relative">
                                                            <img src="{{ URL::asset('/build/images/home-one-product-store/pr-01.jpg')}}" alt="" class="img-fluid">
                                                        ...
                                                        <div class="mt-3">
                                                            <h6 class="mb-1"><a href="#!" class="product-title">Lucky Wooden Elephant</a></h6>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="topbar-product-card pb-3">
                                                        <div class="position-relative">
                                                            <img src="{{ URL::asset('/build/images/home-one-product-store/pr-03.jpg')}}" alt="" class="img-fluid">
                                                            <a href="#" class="wishlistadd position-absolute" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                                                        ...
                                                        <div class="mt-3">
                                                            <h6 class="mb-1"><a href="{{ url('product/product-detail-layout-01')}}" class="product-title">Fish Cut Out Set</a></h6>
                                                            <p class="mb-0 fs-14 text-muted">$36.00</p>
                                                        </div>
                                                    </div>
                                                </div><!--end slide-->
                                                <div class="swiper-slide">
                                                    <div x-data="{ imageUrl: '/build/images/home-one-product-store/pr-05.png' }" class="topbar-product-card pb-3">
                                                        <div class="position-relative">
                                                        ...
                                                        <div class="mt-3">
                                                            <h6 class="mb-1"><a href="#!" class="product-title">Decorative Christmas Fox</a></h6>
                                                            <p class="mb-0 fs-14 text-muted">$50.00</p>
                                                ...
                                                <div class="swiper-slide">
                                                    <div x-data="{ imageUrl: '/build/images/home-one-product-store/pr-07.png' }" class="topbar-product-card pb-3">
                                                        <div class="position-relative">
                                                            <img :src="imageUrl" alt="" class="img-fluid">
                                                            <a href="#" class="wishlistadd position-absolute" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                                                        ...
                                                        <div class="mt-3">
                                                            <h6 class="mb-1"><a href="#!" class="product-title">Cape Cottage Playhouse</a></h6>
                        ...
                        <li class="nav-item dropdown dropdown-mega-lg">
                            <a class="nav-link fw-medium text-white" href="{{ url('portfolio/portfolio-3-columns')}}" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Portfolio
                            </a>
                        ...
                        <li class="nav-item dropdown dropdown-mega-lg">
                            <a class="nav-link fw-medium text-white" href="#!" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Blog
                            </a>
                            <ul class="dropdown-menu dropdown-sub-column">
            ...
            <div class="topbar-toolbar d-flex align-items-center gap-3">
                <a href="#!" role="presentation" data-bs-toggle="modal" data-bs-target="#searchModal">
                    <i class="iccl iccl-search text-white"></i>
                </a>
                <a class="d-md-block d-none" data-bs-toggle="offcanvas" href="#accountOffcanvas" aria-controls="accountOffcanvas"><i class="iccl iccl-user text-white"></i></a>
                <a class="d-md-block d-none" href="#!"><i class="iccl iccl-heart text-white"></i><span class="tcount bg-dark text-white rounded-circle d-flex align-items-center justify-content-center">3</span></a>
                <a data-bs-toggle="offcanvas" href="#shoppingCartOffcanvas" aria-controls="shoppingCartOffcanvas"><i class="iccl iccl-cart text-white"></i><span class="tcount bg-dark text-white rounded-circle d-flex align-items-center justify-content-center">5</span></a>
            </div>
        </div>
    </nav>
</div>
