<div id="kalles-section-header_top" class="header-lingeries">
    <nav class="navbar navbar-expand-lg navbar-custom py-0 d-flex align-items-center" :class="{ 'bg-white shadow-sm' : showMenuScroll }" @scroll.window="showMenuScroll = (window.pageYOffset > 0) ? true : false">
        <div class="container-fluid w-100 d-inline-block">
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-5 col-auto">
                    ...
                    <div class="collapse navbar-collapse flex-grow-1" id="navbarSupportedContent">
                        <div class="d-none d-lg-block">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0 lingeries-header">
                                                ...
                                                <div class="row p-4">
                                                    <div class="col-lg-6 p-0">
                                                        <div class="dropdown-sub-column-item position-relative cat_grid_item overflow-hidden h-100">
                                                            <img src="{{ URL::asset('/build/images/home-jewelry/mega-shop-01.jpg')}}" alt="" class="img-fluid">
                                                    ...
                                                    <div class="col-lg-6 p-0 ps-4">
                                                        <div class="dropdown-sub-column-item position-relative cat_grid_item overflow-hidden h-100">
                                                            <img src="{{ URL::asset('/build/images/home-jewelry/mega-shop-02.jpg')}}" alt="" class="img-fluid">
                                                            <a href="{{url( 'shop_pages.shop-left-sidebar')}}" class="btn bg-white px-5 fw-medium mb-4 position-absolute bottom-0 start-50 translate-middle-x">
                                                                Jewellery
                                                            </a>
                                                        </div>
                                ...
                                <li class="nav-item dropdown dropdown-mega-3xl">
                                    ...
                                    <div class="dropdown-menu ms-0">
                                        <div class="row">
                                            <div class="col-lg-2">
                                                <div class="dropdown-sub-column-item">
                                                    <a href="#!" class="dropdown-menu-title">Categories</a>
                                                    <a href="#!" class="dropdown-menu-title">Gift ideas</a>
                                                    <a href="#!" class="dropdown-menu-title">Women</a>
                                                    <a href="#!" class="dropdown-menu-title">Home Decor</a>
                                                    <a href="#!" class="dropdown-menu-title">Kids & Babies</a>
                                                    <a href="#!" class="dropdown-menu-title">Kniting & Sewing</a>
                                                    <a href="#!" class="dropdown-menu-title">Kitchen</a>
                                                </div>
                                            </div>
                                            <div class="col-lg-10">
                                                <!-- Swiper -->
                                                <div class="swiper mySwiper">
                                                    <div class="swiper-wrapper">
                                                        <div class="swiper-slide">
                                                            <div class="topbar-product-card pb-3">
                                                                <div class="position-relative">
                                                                    <img src="{{ URL::asset('/build/images/home-jewelry/pr-01.jpg')}}" alt="" class="img-fluid w-100">
                                                                    ...
                                                                    <div class="product-button d-flex flex-column gap-2">
                                                                        <a href="#!" class="btn  fs-14"><span>Quick
                                                                ...
                                                                <div class="mt-3">
                                                                    <h6 class="mb-1"><a href="#!" class="product-title">Patrizia Heart Earrings</a>
                                                                    </h6>
                                                                    <p class="mb-0 fs-14 text-muted">$1245.00</p>
                                                                </div>
                                                            </div>
                                                        </div><!--end slide-->
                                                        <div class="swiper-slide">
                                                            <div class="topbar-product-card pb-3">
                                                                <div class="position-relative">
                                                                    <img src="{{ URL::asset('/build/images/home-jewelry/pr-03.jpg')}}" alt="" class="img-fluid w-100">
                                                                    <a href="#" class="wishlistadd position-absolute" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                                                                ...
                                                                <div class="mt-3">
                                                                    <h6 class="mb-1"><a href="{{ url('product/product-detail-layout-01')}}" class="product-title">Swarovski Gaby Ring</a>
                                                                    </h6>
                                                                    <p class="mb-0 fs-14 text-muted">$309.00</p>
                                                                </div>
                                                            </div>
                                                        </div><!--end slide-->
                                                        <div class="swiper-slide">
                                                            <div x-data="{ imageUrl: '/build/images/home-jewelry/pr-05.jpg' }" class="topbar-product-card pb-3">
                                                                <div class="position-relative">
                                                                ...
                                                                <div class="mt-3">
                                                                    <h6 class="mb-1"><a href="#!" class="product-title">Arlean Earrings</a></h6>
                                                                    <p class="mb-0 fs-14 text-muted">$899.00-$935.00</p>
                                                                </div>
                                                            </div>
                                                        </div><!--end slide-->
                                                        <div class="swiper-slide">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div x-data="{ imageUrl: '/build/images/home-jewelry/pr-07.jpg' }" class="topbar-product-card pb-3">
                                                                <div class="position-relative">
                                                                    <span class="new-label bg-warning text-white rounded-circle">
                                                                        -12% </span>
                                                                    <img :src="imageUrl" alt="" class="img-fluid w-100">
                                                                    <a href="#" class="wishlistadd position-absolute" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                                                                ...
                                                                <div class="mt-3">
                                                                    <h6 class="mb-1"><a href="#!" class="product-title">Glamira Loberta Ring</a></h6>
                                                                    <p class="mb-0 fs-14 text-muted">
                                                                        <del>$4200.00</del>
                                                                        <span class="text-danger">$3699.00</span>
                                                                    </p>
                ...
                <div class="col-lg-5 col-auto lingeries-header">
