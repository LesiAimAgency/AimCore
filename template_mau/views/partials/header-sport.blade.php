<div id="kalles-section-header_top" class="navbar-sport">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse mobile-menu-navbar" id="navbarSupportedContent">
                <div class="d-none d-lg-block mx-auto">
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0 sport-header">
                        <li class="nav-item dropdown dropdown-mega-xxl">
                            <a class="nav-link fs-14 text-uppercase fw-medium" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                Demo
                            </a>
                                ...
                                <div class="row">
                                            ...
                                            <ul class="sub-column-menu">
                                                <li>
                                                    <a class="text-muted position-relative d-inline-flex" href="{{ url('index')}}">Home Default
                                                        <span class="position-absolute badge bg-danger rounded-pill fw-normal text-white" style="right:-40px; top: 10px;">Hot</span>
                                                    </a>
                                                </li>
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-classic')}}">Home Classic <span class="position-absolute badge bg-danger rounded-pill fw-normal text-white" style="right:-40px; top: 10px;">Hot</span></a>
                                                </li>
                                                ...
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-medical')}}">Home Medical <span class="position-absolute badge bg-danger rounded-pill fw-normal text-white" style="right:-40px; top: 10px;">Hot</span></a>
                                                </li>

                                                <li><a class="text-muted" href="{{ url('home_pages/home-flower')}}">Home Flower</a></li>
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-furniture')}}">Home Furniture<span class="position-absolute badge bg-danger rounded-pill fw-normal text-white" style="right:-40px; top: 10px;">Hot</span></a></li>
                                                ...
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-cosmetics')}}">Home Cosmetics <span class="position-absolute badge rounded-pill fw-normal text-white" style="right:-40px; top: 10px; background-color: #01bad4;">new</span></a></li>
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-glasses')}}">Home Glasses <span class="position-absolute badge rounded-pill fw-normal text-white" style="right:-40px; top: 10px; background-color: #01bad4;">new</span></a></li>
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-shoes')}}" <span class="position-absolute badge bg-danger rounded-pill fw-normal text-white" style="right:-40px; top: 10px;">Hot</span></a></li>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="dropdown-sub-column-item">
                                            ...
                                            <ul class="sub-column-menu">
                                                ...
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-one-product-store')}}">One Product Store <span class="position-absolute badge bg-danger rounded-pill fw-normal text-white" style="right:-40px; top: 10px;">Hot</span></a>
                                                ...
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-sport')}}">Home Sport <span class="position-absolute badge rounded-pill fw-normal text-white" style="right:-40px; top: 10px; background-color: #01bad4;">new</span></a>
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-jewelry')}}">Home Jewelry <span class="position-absolute badge rounded-pill fw-normal text-white" style="right:-40px; top: 10px; background-color: #01bad4;">new</span></a>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="dropdown-sub-column-item">
                                            ...
                                            <ul class="sub-column-menu">
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('shop_pages/shop-filter-sidebar')}}">Filter Options <span class="position-absolute badge bg-danger rounded-pill fw-normal text-white" style="right:-40px; top: 10px;">Hot</span></a></li>
                                                ...
                                                <li><a class="text-muted" href="{{ url('product/product-detail-variant-images-grouped')}}">Variant
                                                        Images Grouped</a></li>
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-rtl')}}">Demo RTL <span class="position-absolute badge bg-danger rounded-pill fw-normal text-white" style="right:-40px; top: 10px;">Hot</span></a></li>
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('shop_pages/shop-grid-list-switcher')}}">Grid/List
                                                        switcher <span class="position-absolute badge bg-danger rounded-pill fw-normal text-white" style="right:-40px; top: 10px;">Hot</span></a></li>
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-shoes')}}">Compare  <span class="position-absolute badge rounded-pill fw-normal text-white" style="right:-40px; top: 10px; background-color: #01bad4;">new</span></a></li>
                        ...
                        <li class="nav-item dropdown dropdown-mega-xxl">
                            <a class="nav-link fs-14 text-uppercase fw-medium position-relative" href="{{ url('shop_pages/shop-filter-sidebar')}}" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <div class="row g-0">
                                            <div class="col-lg-6">
                                                <div class="dropdown-sub-column-item">
                                                    ...
                                                    <ul class="sub-column-menu">
                                                        ...
                                                        <li><a class="text-muted" href="{{ url('shop_pages/shop-packery-layout')}}">Packery Layout</a></li>
                                                        <li><a class="text-muted" href="{{ url('shop_pages/shop-masonry-layout')}}">Masonry Layout</a></li>
                                                        <li><a class="text-muted" href="{{ url('shop_pages/shop-full-width-layout')}}">Full Width Layout</a>
                                                        </li>
                                                        <li><a class="text-muted" href="{{ url('shop_pages/shop-1600px-layout')}}">1600px Layout</a></li>
                                                        <li><a class="text-muted" href="{{url( 'shop_pages.shop-left-sidebar')}}">Left Sidebar</a></li>
                                                        <li><a class="text-muted" href="{{ url('shop_pages/shop-right-sidebar')}}">Right Sidebar</a></li>
                                                        <li><a class="text-muted" href="{{ url('shop_pages/shop-hidden-sidebar')}}">Hidden sidebar</a></li>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="dropdown-sub-column-item">
                                                    ...
                                                    <ul class="sub-column-menu">
                                                        <li>
                                                            <a class="text-muted" href="{{ url('shop_pages/shop-filter-sidebar')}}">Filter options</a>
                                                        </li>
                                                        <li><a class="text-muted" href="{{ url('shop_pages/shop-filter-sidebar')}}">Filter area</a></li>
                                                        <li><a class="text-muted" href="{{ url('shop_pages/shop-filter-sidebar')}}">Filter Sidebar</a></li>
                                                        <li>
                                                            <a href="{{ url('shop_pages/shop-load-more')}}">Load more button</a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ url('shop_pages/shop-load-more')}}">Infinite scrolling</a>
                                                        </li>
                                                        <li><a class="text-muted" href="">Collection list</a>
                                                        </li>
                                                        <li><a class="text-muted" href="{{ url('home_pages/home-classic')}}">Hidden Search</a>
                                                        </li>
                                                        <li><a class="text-muted" href="{{ url('home_pages/home-categories-links')}}"> Search fullscreen</a>
                                                        </li>
                                                        <li><a class="text-muted" href="{{ url('shop_pages/checkout')}}">Checkout</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row p-4 pt-0">
                                            <div class="col-lg-6 p-0">
                                                <div class="dropdown-sub-column-item position-relative cat_grid_item overflow-hidden h-100">
                                                    <img src="{{ URL::asset('/build/images/home-sport/megamenu-01.jpg')}}" alt="" class="img-fluid">
                                            ...
                                            <div class="col-lg-6 p-0">
                                                <div class="dropdown-sub-column-item position-relative cat_grid_item overflow-hidden h-100">
                                                    <img src="{{ URL::asset('/build/images/home-sport/megamenu-02.jpg')}}" alt="" class="img-fluid">
                                                    <a href="#!" class="btn bg-white px-5 fw-medium mb-4 position-absolute bottom-0 start-50 translate-middle-x">
                                                        Accessories
                                                    </a>
                                                </div>
                        ...
                        <li class="nav-item dropdown dropdown-mega-xxl">
                            <a class="nav-link fs-14 text-uppercase fw-medium" href="{{ url('product/product-detail-layout-01')}}" data-bs-toggle="dropdown" aria-expanded="false">
                                Product
                            </a>
                            <div class="dropdown-menu">
                                <div class="row">
                                        ...
                                        <div class="dropdown-sub-column-item">
                                            ...
                                            <ul class="sub-column-menu">
                                                ...
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('product/product-detail-grouped-product')}}">Grouped
                                                        Product <span class="position-absolute badge bg-danger rounded-pill fw-normal text-white" style="right:-40px; top: 10px;">Hot</span></a></li>
                                            ...
                                            <ul class="sub-column-menu">
                                                <li>
                                                    <a class="text-muted position-relative d-inline-flex" href="{{ url('product/product-detail-frequently-bought-together')}}" style="white-space: nowrap;">Frequently
                                                        Bought Together <span class="position-absolute badge bg-danger rounded-pill fw-normal text-white" style="right:-40px; top: 10px; ">Hot</span></a>
                                                </li>
                                                <li><a class="text-muted" href="{{ ('product.product-detail-pre-orders')}}">Product
                                                        pre-orders</a>
                                                </li>
                                                <li>
                                                    <a class="text-muted position-relative d-inline-flex" href="{{ url('product/product-detail-tab-accordion')}}">Product Upsell<span class="position-absolute badge bg-danger rounded-pill fw-normal text-white" style="right:-40px; top: 10px;">Hot</span></a>
                                                </li>
                                                <li>
                                                    <a class="text-muted position-relative d-inline-flex" href="{{ url('product/product-detail-description-with-lookbook')}}">Description
                                                        with Lookbook<span class="position-absolute badge bg-danger rounded-pill fw-normal text-white" style="right:-40px; top: 10px;">Hot</span></a>
                                                </li>
                                                ...
                                                <li>
                                                    <a class="text-muted position-relative d-inline-flex" href="{{ ('product.product-detail-variant-images-grouped')}}">Variant
                                                        Images Grouped<span class="position-absolute badge bg-danger rounded-pill fw-normal text-white" style="right:-40px; top: 10px;">Hot</span></a>
                                                </li>
                                                ...
                                                <li>
                                                    <a class="text-muted position-relative d-inline-flex" href="{{ url('product/product-detail-swatch-radio')}}" style="white-space: nowrap;">Dynamic checkout
                                                        buttons <span class="position-absolute badge bg-danger rounded-pill fw-normal text-white" style="right:-40px; top: 10px;">Hot</span></a>
                                                </li>
                                                <li>
                                                    <a class="text-muted position-relative d-inline-flex" href="{{ url('product/product-detail-layout-01')}}">Sticky add to
                                                        cart <span class="position-absolute badge bg-danger rounded-pill fw-normal text-white" style="right:-40px; top: 10px;">Hot</span></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <li class="nav-item dropdown dropdown-mega-lg">
                            <a class="nav-link fs-14 text-uppercase fw-medium" href="{{ url('portfolio/portfolio-3-columns')}}" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Portfolio
                            </a>
                        ...
                        <li class="nav-item dropdown dropdown-mega-lg">
                            <a class="nav-link fs-14 text-uppercase fw-medium" href="#!" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Blog
                            </a>
                            <ul class="dropdown-menu dropdown-sub-column">
            ...
            <div class="topbar-toolbar d-flex align-items-center gap-3 sport-header">
