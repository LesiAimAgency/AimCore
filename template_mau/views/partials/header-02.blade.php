<div id="kalles-section-header_top" >
    ...
    <nav class="navbar navbar-expand-lg navbar-custom  py-0 d-flex align-items-center">
        ...
        <div class="container-fluid">
            ...
            <a class="navbar-brand fs-14" href="#">Welcome to our store!</a>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="d-none d-lg-block mx-auto">
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0 ">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="dropdown-sub-column-item">
                                            ...
                                            <ul class="sub-column-menu">
                                                ...
                                                <li><a class="text-muted" href="{{url('home_pages/home-video-banner')}}">Home Video Banner</a></li>
                            ...
                            <div class="dropdown-menu">
                                <div class="row g-0">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="row g-0">
                                            <div class="col-lg-6">
                                                <div class="dropdown-sub-column-item text-center position-relative cat_grid_item overflow-hidden h-100">
                                                    <img src="{{ URL::asset('/build/images/home-classic/mega-bagal-1.jpg')}}" alt="" class="img-fluid">
                                                    <a class="cd chp" href="{{ url('product/product-detail-layout-01')}}">Wash me!</a>
                        ...
                        <li class="nav-item">
                            <a class="navbar-brand nav-link me-0" href="#"><img src="{{ URL::asset('/build/images/svg/kalles.svg')}}" alt="" width="95"></a>
                        </li>
                        <li class="nav-item dropdown dropdown-mega-3xl">
                            <a class="nav-link position-relative text-danger" href="{{ url('shop_pages/shop-filter-sidebar')}}" data-bs-toggle="dropdown" aria-expanded="false">
                                Sale
                                <span class="badge bg-warning fw-normal">Sale</span>
                            </a>
                        </li>
                        <li class="nav-item dropdown dropdown-mega-lg">
                            <a class="nav-link" href="{{ url('portfolio/portfolio-3-columns')}}" role="button" data-bs-toggle="dropdown" aria-expanded="false">
