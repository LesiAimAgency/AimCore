<div id="kalles-section-header_top" class="header-lingeries">
    <nav class="navbar navbar-expand-lg navbar-custom py-0 d-flex align-items-center" :class="{ 'bg-body shadow-sm' : showMenuScroll }" @scroll.window="showMenuScroll = (window.pageYOffset > 0) ? true : false">
        <div class="container-fluid w-100 d-inline-block">
                        ...
                        <div class="d-none d-lg-block">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                <li class="nav-item dropdown dropdown-mega-xxl">
                                    <a class="nav-link fs-16 fw-medium" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                        Demo
                                    </a>
                                    <div class="dropdown-menu ms-0">
                                        <div class="row">
                                            <div class="col-lg-3">
                        ...
                        <div class="dropdown-sub-column-item">
                            ...
                            <ul class="sub-column-menu">
                                ...
                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('product/product-detail-pickup-availability')}}">Pickup
                                        Availability <span class="badge-tag badge bg-teal">new</span></a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <li class="nav-item dropdown dropdown-mega-xxl">
                ...
                <div class="dropdown-menu ms-0 p-3">
                    <div class="row p-0">
                        <div class="col-lg-4">
                            <div class="row g-0">
                                <div class="col-lg-6">
                        ...
                        <div class="col-lg-8">
                            <div class="row p-4">
                                ...
                                <div class="col-lg-6 cat-section px-4 py-2">
                                    <a href="{{url( 'shop_pages.shop-left-sidebar')}}" class="d-block position-relative cat_grid_item overflow-hidden " style="height: 280px;">
                                        <div class="h-100 w-100 cat-grid-img" style="background-image: url('{{ asset('/build/images/home-classic/mega-banner-01.jpg')}}"></div>
            ...
            <li class="nav-item dropdown dropdown-mega-xxl">
                <a class="nav-link fs-16 fw-medium" href="{{ url('product/product-detail-layout-01')}}" data-bs-toggle="dropdown" aria-expanded="false">
                    Product
                </a>
                <div class="dropdown-menu ms-0 pe-3">
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="dropdown-sub-column-item">
                        ...
                        <div class="col-lg-3">
                            <div class="dropdown-sub-column-item">
                                ...
                                <ul class="sub-column-menu">
                                    <li>
                                        <a class="text-muted position-relative d-inline-flex" href="{{ url('product/product-detail-frequently-bought-together')}}">Frequently
            ...
            <li class="nav-item dropdown dropdown-mega-lg">
                <a class="nav-link fs-16 fw-medium" href="{{ url('portfolio/portfolio-3-columns')}}" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    Portfolio
                </a>
                <ul class="dropdown-menu dropdown-sub-column">
                    <li>
                        <a class="text-muted" href="{{ url('portfolio/portfolio')}}">Portfolio 2 Columns</a>
                    </li>
                    <li>
                        <a class="text-muted" href="{{ url('portfolio/portfolio-3-columns')}}">Portfolio 3 Columns</a>
                    </li>
                    <li>
                        <a class="text-muted" href="{{ url('portfolio/portfolio-4-columns')}}">Portfolio 4 Columns</a>
                    </li>
                    <li>
                        <a class="text-muted" href="{{ url('portfolio/single-portfolio-with-shop')}}">Single Portfolio With Shop</a>
                    </li>
                    <li>
                        <a class="text-muted" href="{{ url('portfolio/single-portfolio-with-lookbook')}}">Single Portfolio With Lookbook</a>
                    </li>
                    <li>
                        <a class="text-muted" href="{{ url('portfolio/single-portfolio-with-instagram-shop')}}">Portfolio With Instagram Shop</a>
                    </li>
                </ul>
            </li>
            <li class="nav-item dropdown dropdown-mega-lg">
            ...
            <li class="nav-item dropdown dropdown-mega-lg">
                <a class="nav-link fs-16 fw-medium" href="#!" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    Blog
                </a>
                <ul class="dropdown-menu dropdown-sub-column">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
                        <div class="accordion" id="accordionPanelsStayOpenExample">
                                    ...
                                    <div class="accordion" id="accordi-05xample">
                                        <div class="accordion-item rounded-0">
                                            ...
                                            <div id="collapse-05" class="accordion-collapse collapse" aria-labelledby="heading-05" data-bs-parent="#accordi-05xample">
                                                ...
                                                <ul class="accordion-nav-list list-unstyled mb-0">
                                                    ...
                                                    <li>
                                                        <a href="{{ url('home_pages/home-instagram-shop')}}">Home
                                                            Instagram
                                                            Shop</a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="{{ url('home_pages/home-fashion10')}}">Home Fashion
                                                            10</a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="{{ url('home_pages/home-fashion-vertical')}}">Home
                                                            Fashion
                                                            Vertical</a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="{{ url('home_pages/home-electric-vertical')}}">Home
                                                            Electric
                                                            Vertical</a>
                                                    </li>
                                                </ul>
                                        ...
                                        <div class="accordion-item border-0 rounded-0">
                                            ...
                                            <div id="collapse-06" class="accordion-collapse collapse" aria-labelledby="heading-06" data-bs-parent="#accordi-05xample">
                                                ...
                                                <ul class="accordion-nav-list list-unstyled mb-0">
                                                    <li>
                                                        <a href="{{ url('home_pages.home-header-01') }}">Header Layout
                                                            1</a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ url('home_pages.home-header-02') }}">Header Layout
                                                            2</a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="{{ url('home_pages/home-header-04')}}">Header Layout
                                                            4</a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="{{ ('home_pages.home-header-06')}}">Header Layout
                                                            6</a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ url('home_pages/home-fashion-vertical')}}">Header
                                                            Layout 7</a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ url('home_pages/home-electric-vertical')}}">Header
                                                            Layout
                                                            8</a>
                                                    </li>
                                                    <li>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingThree">
                                    <ul class="accordion-nav-list list-unstyled mb-0">
                                        ...
                                        <li>
                                            <a href="{{ url('product/product-detail-3d-ar-models')}}">Product 3D, AR
                                                models
                                                <span class="badge bg-teal fw-normal rounded-pill">hot</span>
                                            </a>
                                        </li>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="panelsStayOpen-collapseFour" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingFour">
                                    <ul class="accordion-nav-list list-unstyled mb-0">
                                        ...
                                        <li>
                                            <a href="{{ url('portfolio/single-portfolio-with-shop')}}">Single Portfolio
                                                With
                                                Shop</a>
                                        </li>
                                        <li>
                            ...
                            <div class="pill-item col-6 p-0 w-100" role="presentation">
                                <button class="nav-link border-0" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Need
                                    Help?</button>
                    ...
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                        <ul class="accordion-nav-list accordion-navs-list list-unstyled mb-0">
                            <li>
                                <a href="#"><i class="las la-female me-2"></i>Women’s
                                    Clothing</a>
                            </li>
                            <li>
...
<div class="col-lg-2 col-auto">
    <div class="text-center">
        <a class="navbar-brand mx-auto" href="{{ url('index')}}"><img src="{{ URL::asset('/build/images/svg/kalles.svg')}}" alt="" width="95"></a>
    </div>
</div>
<div class="col-lg-5 col-auto">
    <div class="topbar-toolbar ms-auto d-flex align-items-center gap-3 justify-content-end">
        <a data-bs-toggle="offcanvas" href="#searchOffcanvas" aria-controls="searchOffcanvas"><i class="las la-search fs-28"></i></a>
        ...
        <a href="#!"><i class="lar la-heart fs-28"></i><span class="tcount bg-dark text-white rounded-circle d-flex align-items-center justify-content-center">3</span></a>
        <a class="d-none d-md-block" data-bs-toggle="offcanvas" href="#shoppingCartOffcanvas" aria-controls="shoppingCartOffcanvas"><i class="las la-shopping-cart fs-28"></i><span class="tcount bg-dark text-white rounded-circle d-flex align-items-center justify-content-center">5</span></a>
    </div>
</div>
</div>
</div>
