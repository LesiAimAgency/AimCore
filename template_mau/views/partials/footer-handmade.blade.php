<footer class="footer footer-handmade">
    <div class="container">
        <div class="row accordion" id="footer-accordion">
            <div class="col-md-4 col-lg-3 mb-2 footer-accordion-item accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    ...
                    <div class="mt-4 pt-2">
                        <p class="d-flex align-items-starttext-black gap-2">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="mt-md-4 pt-md-2">
                        <ul class="menu list-unstyled">
                            <li class="menu-item">
                                <a href="{{ url('shop_pages/shop-filter-sidebar')}}" class="text-black">Men</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ url('shop_pages/shop-filter-sidebar')}}" class="text-black">Women</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ url('shop_pages/shop-1600px-layout')}}" class="text-black">Accessories</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ url('shop_pages/shop-1600px-layout')}}" class="text-black">Shoes</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ url('shop_pages/shop-1600px-layout')}}" class="text-black">Denim</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ url('shop_pages/shop-1600px-layout')}}" class="text-black">Dress</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-md-3 col-lg-2 mb-2 accordion-item footer-accordion-item">
                ...
                <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="mt-md-4 pt-md-2">
                        <ul class="menu list-unstyled">
                            <li class="menu-item">
                                <a href="#!" class="text-black">Store Location</a>
                            </li>
                            <li class="menu-item">
                                <a href="#!" class="text-black">Latest News</a>
                            </li>
                            <li class="menu-item">
                            ...
                            <li class="menu-item">
                                <a href="#!" class="text-black">FAQs 2</a>
                            </li>
                            <li class="menu-item">
            ...
            <div class="col-md-10 col-lg-3 mb-2 accordion-item footer-accordion-item">
                ...
                <div id="collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="mt-md-4 pt-md-2">
                        <p class="text-black">Subscribe to our newsletter and get 10% off your first purchase</p>
                        ...
                        <div class="mt-3">
                            <img class="img-fluid" src="{{ URL::asset('/build/images/home-hand-made/payment-icon-01.svg')}}" alt="amazon payments">
                            <img class="img-fluid" src="{{ URL::asset('/build/images/home-hand-made/payment-icon-02.svg')}}" alt="litecoin">
                            <img class="img-fluid" src="{{ URL::asset('/build/images/home-hand-made/payment-icon-03.svg')}}" alt="maestro">
                            <img class="img-fluid" src="{{ URL::asset('/build/images/home-hand-made/payment-icon-04.svg')}}" alt="master">
                            <img class="img-fluid" src="{{ URL::asset('/build/images/home-hand-made/payment-icon-05.svg')}}" alt="paypal">
                            <img class="img-fluid" src="{{ URL::asset('/build/images/home-hand-made/payment-icon-06.svg')}}" alt="visa">
                        </div>
                    </div>
                </div>
            </div><!--end col-->
...
<div class="footer-alt mb-5 mb-lg-0 py-4 footer-handmade">
    <div class="container">
        <div class="row">
            <div class="col-sm-6 text-center mb-1">
                Copyright ©
                <script>document.write(new Date().getFullYear())</script> <a href="#!" class="text-reset fw-semibold">Kalles</a> all rights reserved. Powered by srbthemes
            </div>
            <div class="col-sm-6">
                <ul id="footer-menu" class="list-unstyled d-flex align-items-center mb-0 justify-content-end">
                    <li class="menu-item ">
                        <a href="{{ url('shop_pages/shop-filter-sidebar')}}" class="text-black mx-2">Shop</a>
                    </li>
                    <li class="menu-item ">
                        <a href="#!" class="text-black mx-2">About Us</a>
                    </li>
                    <li class="menu-item ">
                        <a href="#!" class="text-black mx-2">Contact</a>
                    </li>
                    <li class="menu-item ">
                        <a href="#!" class="text-black mx-2">Blog</a>
                    </li>
                </ul>
            </div>
        </div>
