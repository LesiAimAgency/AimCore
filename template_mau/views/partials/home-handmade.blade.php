...
<head>
    ...
    {{> partials/title-meta title="Home Handmade" favicon="build/images/k_favicon_32x.png" }}
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-3">
                    <div class="row g-4">
                        <div class="col-lg-12">
                            <a href="#!" class="d-block position-relative cat_grid_item overflow-hidden h-250">
                                <div class="h-100 w-100" style="background-image: url('/build/images/home-jewelry/banner-collection-01.png');background-size: cover;"></div>
                        ...
                        <div class="col-lg-12">
                            <a href="#!" class="d-block position-relative cat_grid_item overflow-hidden h-250">
                                <div class="h-100 w-100" style="background-image: url('/build/images/home-jewelry/banner-collection-05.png');background-size: cover;"></div>
                                <div class="cat-grid-button text-white bg-dark">
                ...
                <div class="col-lg-6">
                    <div class="row g-4">
                        <div class="col-lg-12">
                            <a href="#!" class="d-block position-relative cat_grid_item overflow-hidden h-250">
                                <div class="h-100 w-100" style="background-image: url('{{ asset('/build/images/home-jewelry/banner-collection-02.png')}}"></div>
                            </a>
                        </div><!--end col-->
                        <div class="col-lg-12">
                            <a href="#!" class="d-block position-relative cat_grid_item overflow-hidden h-250">
                                <div class="h-100 w-100" style="background-image: url('/build/images/home-jewelry/banner-collection-04.png');background-size: cover;"></div>
                                <div class="cat-grid-button text-white bg-dark">
                ...
                <div class="col-lg-3">
                    <a href="#!" class="d-block position-relative cat_grid_item overflow-hidden h-524">
                        <div class="h-100 w-100" style="background-image: url('/build/images/home-jewelry/banner-collection-03.png');background-size: cover;"></div>
                        <div class="cat-grid-button text-white bg-dark">
            ...
            <div class="row g-4">
                <div class="col-lg-3">
                    <div x-data="{ imageUrl: '/build/images/home-jewelry/pr-15.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                        <div class="position-relative overflow-hidden">
                            ...
                            <img :src="isHovered ? '/build/images/home-jewelry/pr-16.jpg' : imageUrl" alt="" class="img-fluid">
                            <a href="#" class="wishlistadd position-absolute dark" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>

                            <div class="product-button d-flex flex-column gap-2">
                                <a href="#!" class="btn rounded-0 fs-14"><span>Quick View</span> <i class="iccl iccl-eye"></i></a>
                                <a href="#!" class="btn rounded-0 fs-14"><span>Quick Shop</span> <i class="iccl iccl-cart"></i></a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3">
                    <div x-data="{ imageUrl: '/build/images/home-jewelry/pr-17.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                        <div class="position-relative overflow-hidden">
                            <img :src="isHovered ? '/build/images/home-jewelry/pr-18.jpg' : imageUrl" alt="" class="img-fluid">
                            <a href="#" class="wishlistadd position-absolute dark" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                ...
                <div class="col-lg-3">
                    <div x-data="{ imageUrl: '/build/images/home-jewelry/pr-19.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                        <div class="position-relative overflow-hidden">
                            ...
                            <img :src="isHovered ? '/build/images/home-jewelry/pr-20.jpg' : imageUrl" alt="" class="img-fluid">
                            <a href="#" class="wishlistadd position-absolute dark" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                ...
                <div class="col-lg-3">
                    <div x-data="{ imageUrl: '/build/images/home-jewelry/pr-21.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                        <div class="position-relative overflow-hidden">
                            <img :src="isHovered ? '/build/images/home-jewelry/pr-22.jpg' : imageUrl" alt="" class="img-fluid">
                            <a href="#" class="wishlistadd position-absolute dark" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                ...
                <div class="col-lg-3">
                    <div x-data="{ imageUrl: '/build/images/home-jewelry/pr-23.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                        <div class="position-relative overflow-hidden">
                            ...
                            <img :src="isHovered ? '/build/images/home-jewelry/pr-24.jpg' : imageUrl" alt="" class="img-fluid">
                            <a href="#" class="wishlistadd position-absolute dark" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                ...
                <div class="col-lg-3">
                    <div x-data="{ imageUrl: '/build/images/home-jewelry/pr-25.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                        <div class="position-relative overflow-hidden">
                            <img :src="isHovered ? '/build/images/home-jewelry/pr-26.jpg' : imageUrl" alt="" class="img-fluid">
                            <a href="#" class="wishlistadd position-absolute dark" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                ...
                <div class="col-lg-3">
                    <div x-data="{ imageUrl: '/build/images/home-jewelry/pr-27.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                        <div class="position-relative overflow-hidden">
                            <img :src="isHovered ? '/build/images/home-jewelry/pr-28.jpg' : imageUrl" alt="" class="img-fluid">
                            <a href="#" class="wishlistadd position-absolute dark" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                ...
                <div class="col-lg-3">
                    <div x-data="{ imageUrl: '/build/images/home-jewelry/pr-40.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                        <div class="position-relative overflow-hidden">
                            <img :src="isHovered ? '/build/images/home-jewelry/pr-30.jpg' : imageUrl" alt="" class="img-fluid">
                            <a href="#" class="wishlistadd position-absolute dark" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
            ...
            <div class="row g-4">
                <div class="col-lg-6">
                    <a href="#!" class="position-relative hover-zoom d-block">
                        ...
                        <div class="position-absolute start-0 start-0 end-0 top-0 bottom-0 d-flex align-items-end m-4">
                            <div class="text-white">
                                ...
                                <p class="fw-normal btn btn-dark rounded-0 font-futura mb-0 btn_icon_true d-inline-block position-relative fs-14">Explore Now</p>
                            </div>
                        </div>
                    </a>
                </div><!--end col-->
                <div class="col-lg-6">
                    <a href="#!" class="position-relative hover-zoom d-block">
                        ...
                        <div class="position-absolute start-0 start-0 end-0 top-0 bottom-0 d-flex align-items-center text-center mx-4">
                            <div class="text-white">
                                <h5 class="fs-16 fw-medium">The latest on-trend styles</h5>
                                <h4 class="fs-36 font-playfair fw-semibold mb-4">Check out our latest range</h4>
                                <p class="fw-normal btn btn-dark rounded-0 font-futura mb-0 btn_icon_true d-inline-block position-relative fs-14">Explore Now</p>
            ...
            <div class="row g-4">
                <div class="col-lg-3">
                    <div x-data="{ imageUrl: '/build/images/home-jewelry/pr-41.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                        <div class="position-relative overflow-hidden">
                            <img :src="isHovered ? '/build/images/home-jewelry/pr-42.jpg' : imageUrl" alt="" class="img-fluid">
                            <a href="#" class="wishlistadd position-absolute dark" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                ...
                <div class="col-lg-3">
                    <div x-data="{ imageUrl: '/build/images/home-jewelry/pr-43.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                        <div class="position-relative overflow-hidden">
                            <img :src="isHovered ? '/build/images/home-jewelry/pr-44.jpg' : imageUrl" alt="" class="img-fluid">
                            <a href="#" class="wishlistadd position-absolute dark" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                ...
                <div class="col-lg-3">
                    <div x-data="{ imageUrl: '/build/images/home-jewelry/pr-45.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                        <div class="position-relative overflow-hidden">
                            <img :src="isHovered ? '/build/images/home-jewelry/pr-46.jpg' : imageUrl" alt="" class="img-fluid">
                            <a href="#" class="wishlistadd position-absolute dark" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                ...
                <div class="col-lg-3">
                    <div x-data="{ imageUrl: '/build/images/home-jewelry/pr-47.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                        <div class="position-relative overflow-hidden">
                            ...
                            <img :src="isHovered ? '/build/images/home-jewelry/pr-48.jpg' : imageUrl" alt="" class="img-fluid">
                            <a href="#" class="wishlistadd position-absolute dark" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                ...
                <div class="col-lg-3">
                    <div x-data="{ imageUrl: '/build/images/home-jewelry/pr-49.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                        <div class="position-relative overflow-hidden">
                            <span class="onsale position-absolute bg-warning text-white d-flex align-items-center justify-content-center z-3">Hot</span>
                            <img :src="isHovered ? '/build/images/home-jewelry/pr-50.jpg' : imageUrl" alt="" class="img-fluid">
                            <a href="#" class="wishlistadd position-absolute dark" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                ...
                <div class="col-lg-3">
                    <div x-data="{ imageUrl: '/build/images/home-jewelry/pr-51.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                        <div class="position-relative overflow-hidden">
                            <img :src="isHovered ? '/build/images/home-jewelry/pr-52.jpg' : imageUrl" alt="" class="img-fluid">
                            <a href="#" class="wishlistadd position-absolute dark" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                ...
                <div class="col-lg-3">
                    <div x-data="{ imageUrl: '/build/images/home-jewelry/pr-53.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                        <div class="position-relative overflow-hidden">
                            <span class="onsale position-absolute bg-danger text-white d-flex align-items-center justify-content-center z-3">New</span>
                            <img :src="isHovered ? '/build/images/home-jewelry/pr-54.jpg' : imageUrl" alt="" class="img-fluid">
                            <a href="#" class="wishlistadd position-absolute dark" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                ...
                <div class="col-lg-3">
                    <div x-data="{ imageUrl: '/build/images/home-jewelry/pr-55.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                        <div class="position-relative overflow-hidden">
                            <img :src="isHovered ? '/build/images/home-jewelry/pr-56.jpg' : imageUrl" alt="" class="img-fluid">
                            <a href="#" class="wishlistadd position-absolute dark" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                ...
                <div class="row g-4">
                    <div class="col-lg-4">
                        <div class="blog-card">
                            ...
                            <h6 class="fs-17 font-playfair fw-medium main_link"><a href="{{ url('blog/blog-post-with-instagram-shop')}}" class="text-reset">Unique First Anniversary Gift Ideas</a></h6>
                            <div class="post-content text-muted mt-3">If you’ve been faced with the decision to reschedule or cancel your 2020 wedding, you’re not alone. If only th...</div>
                        </div>
                    </div><!--end col-->
                    <div class="col-lg-4">
                        <div class="blog-card">
                            ...
                            <h6 class="fs-17 font-playfair fw-medium main_link"><a href="{{ url('blog/blog-post-with-instagram-shop')}}" class="text-reset">Glossary Of Jewelry Terms</a></h6>
                            <div class="post-content text-muted mt-3">IS TROILITE IN METEORITE AN IMPERFECTION? This depends entirely on who you ask. And could potentially lead into a h...</div>
                        </div>
                    </div><!--end col-->
                    <div class="col-lg-4">
                        <div class="blog-card">
                            ...
                            <h6 class="fs-17 font-playfair fw-medium main_link"><a href="{{ url('blog/blog-post-with-instagram-shop')}}" class="text-reset">Covid-19 Wedding Planning Advice</a></h6>
                            <div class="post-content text-muted mt-3">The sad reality is that some of us are losing very important people in our lives, including partners of many y...</div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
            ...
            <div class="row g-0">
                <div class="col-lg-2">
                    <div class="overflow-hidden img-zoom">
                        <img src="{{ URL::asset('/build/images/home-jewelry/instagram-01.jpg')}}" alt="" class="img-fluid h-100">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="overflow-hidden img-zoom">
                        <img src="{{ URL::asset('/build/images/home-jewelry/instagram-02.jpg')}}" alt="" class="img-fluid h-100">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="overflow-hidden img-zoom">
                        <img src="{{ URL::asset('/build/images/home-jewelry/instagram-03.jpg')}}" alt="" class="img-fluid h-100">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="overflow-hidden img-zoom">
                        <img src="{{ URL::asset('/build/images/home-jewelry/instagram-04.jpg')}}" alt="" class="img-fluid h-100">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="overflow-hidden img-zoom">
                        <img src="{{ URL::asset('/build/images/home-jewelry/instagram-05.jpg')}}" alt="" class="img-fluid h-100">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="overflow-hidden img-zoom">
                        <img src="{{ URL::asset('/build/images/home-jewelry/instagram-06.jpg')}}" alt="" class="img-fluid h-100">
                    </div>
                </div>
            </div>
        </div>
