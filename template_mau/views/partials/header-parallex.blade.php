<div id="kalles-section-header_top" class="{{ 'class-name' }}">
    ...
    <nav class="navbar navbar-expand-lg navbar-custom py-0 d-flex align-items-center bg-white">
        <div class="container-fluid">
                    ...
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="dropdown-sub-column-item">
                                            ...
                                            <ul class="sub-column-menu">
                                                ...
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-cosmetics')}}">Home Cosmetics <span class="badge-tag badge bg-teal">new</span></a></a></li>
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-glasses')}}">Home Glasses <span class="badge-tag badge bg-teal">new</span></a></a></li>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="dropdown-sub-column-item">
                                            ...
                                            <ul class="sub-column-menu">
                                                ...
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-sport')}}">Home Sport <span class="badge-tag badge bg-teal">new</span></a></a>
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-jewelry')}}">Home Jewelry <span class="badge-tag badge bg-teal">new</span></a></a>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="dropdown-sub-column-item">
                                            ...
                                            <ul class="sub-column-menu">
                                                ...
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-shoes')}}">Compare  <span class="badge-tag badge bg-teal">new</span></a></a></li>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="topbar-product-card pb-3">
                                                                <div class="position-relative">
                                                                    <img src="{{ URL::asset('/build/images/home-classic/mega-bagal-1.jpg')}}" alt="" class="img-fluid">
                                                                ...
                                                                <div class="mt-3 text-center">
                                                                    <h6 class="mb-1"><a href="#!" class="product-title">Wash me</a></h6>
                                                                    <p class="mb-0 fs-14 text-muted">$35.00</p>
                                                                </div>
                                                            </div>
                                                        </div><!--end slide-->
                                                        <div class="swiper-slide">
                                                            <div x-data="{ imageUrl: '/build/images/home-classic/mega-cq-4.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                                                                ...
                                                                <a href="{{ url('product/product-detail-layout-01')}}" class="mt-3 d-block text-center">
                                                                    <h6 class="mb-1"> Woleen Tee</h6>
                        ...
                        <li class="nav-item dropdown dropdown-mega-lg">
                            ...
                            <ul class="dropdown-menu dropdown-sub-column">
                                ...
                                <li><a href="{{ url('portfolio/single-portfolio-with-lookbook')}}">Single Portfolio With Lookbook</a>
                                </li>
                                <li><a href="{{ url('portfolio/single-portfolio-with-instagram-shop')}}">Portfolio With Instagram
                                        Shop</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown dropdown-mega-lg">
                            ...
                            <ul class="dropdown-menu dropdown-sub-column">
                                ...
                                <li><a href="{{ url('blog/blog-post-with-product-listing')}}">Single Post with Product Listing</a>
                                </li>
                                <li><a href="{{ url('blog/blog-post-with-instagram-shop')}}">Single Post with Instagram Shop</a>
                                </li>
