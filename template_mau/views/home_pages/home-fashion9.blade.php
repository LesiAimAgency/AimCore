    ...
    <div>
            ...
            <div class="container">
                <div class="row g-lg-4 g-3 justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <a href="{{ url('shop_pages/shop') }}" class="text-black">
                    ...
                    <div class="col-md-3">
                        <a href="{{ url('shop_pages.shop-left-sidebar') }}"
                            ...
                            <div class="h-100 w-100 cat-grid-img"
                                style="background-image: url('{{ asset('/build/images/home-fashion-9/cat-women.jpg') }}">
                            </div>
                            <div class="cat-grid-button text-body bg-dark">
                                <div class="cat_grid_item__title text-white">Women</div>
                            </div>
                        </a>
                        <a href="{{ url('shop_pages.shop-left-sidebar') }}"
                            class="d-block position-relative cat_grid_item overflow-hidden h-300">
                            <div class="h-100 w-100 cat-grid-img"
                                style="background-image: url('{{ asset('/build/images/home-fashion-9/cat-accessories.jpg') }}">
                            </div>
                            <div class="cat-grid-button text-body bg-dark">
                                <div class="cat_grid_item__title text-white">Accessories</div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-6">
                        <a href="{{ url('shop_pages.shop-left-sidebar') }}"
                            ...
                            <div class="h-100 w-100 cat-grid-img"
                                style="background-image: url('/build/images/home-fashion-9/cat-watch.jpg');background-position: center;">
                            </div>
                            <div class="cat-grid-button text-body bg-dark">
                                <div class="cat_grid_item__title text-white">Watch Collections</div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3">
                        <a href="{{ url('shop_pages.shop-left-sidebar') }}"
                            class="d-block position-relative cat_grid_item overflow-hidden h-300 mb-lg-4 mb-2">
                            <div class="h-100 w-100 cat-grid-img"
                                style="background-image: url('{{ asset('/build/images/home-fashion-9/cat-men.jpg') }}">
                            </div>
                            <div class="cat-grid-button text-body bg-dark">
                                <div class="cat_grid_item__title text-white">Men</div>
                            </div>
                        </a>
                        <a href="{{ url('shop_pages.shop-left-sidebar') }}"
                            class="d-block position-relative cat_grid_item overflow-hidden h-300">
                            <div class="h-100 w-100 cat-grid-img"
                                style="background-image: url('{{ asset('/build/images/home-fashion-9/cat-shoes.jpg') }}">
                            </div>
                            <div class="cat-grid-button text-body bg-dark">
                                <div class="cat_grid_item__title text-white">Shoes</div>
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <section class="type_tab_collection">
            <div class="container">
                ...
                <ul class="nav nav-underline gap-lg-4 justify-content-center mt-4 mb-0" id="pills-tab" role="tablist">
                    ...
                    <div class="tab-pane fade show active" id="women" role="tabpanel"
                            ...
                            <div class="col-md-3 col-6">
                                <div x-data="{ imageUrl: '/build/images/products/pr-01.jpg', isHovered: false }" class="topbar-product-card"
                                    ...
                                    <div class="position-relative overflow-hidden">
                                        ...
                                        <div class="position-absolute d-lg-none bottom-0 end-0 d-flex flex-column bg-black rounded-pill m-2"
                                            style="z-index: 1;">
                                            <a href="#exampleModal" data-bs-toggle="modal"
                                            ...
                                            <button type="button" class="btn responsive-cart rounded-pill fs-14 p-2"
                                                ...
                                                data-bs-target="#cardModal" class="btn rounded-pill text-white fs-14">
                        ...
                        <div class="text-center mt-4 pt-2">
                            <a href="#!" class="btn btn-dark btn-lg min-w-150 px-4 fs-14 py-3 rounded-0">Load
                                More &nbsp;<i class="las la-arrow-down"></i></a>
                        </div>
                    </div><!--end tab pane-->
                                    ...
                                    <div class="position-relative overflow-hidden">
                                        ...
                                        <div class="position-absolute d-lg-none bottom-0 end-0 d-flex flex-column bg-black rounded-pill m-2"
                                            ...
                                            <button type="button"
                                                ...
                                                class="btn rounded-pill text-white fs-14">
                                                <i class="iccl iccl-cart fw-semibold text-white"></i></button>
                                        </div>
                                    </div>
                                    <div class="mt-3 text-center">
                        ...
                        <a href="#!" class="position-relative hover-zoom d-block">
                            ...
                            <div
                                ...
                                <div class="text-center text-white">
                                    ...
                                    <h1 class="mb-0 display-5 fw-semibold">UP TO 70%</h1>
                                </div>
                            </div>
                        </a>
                    </div>
        ...
        @include('partials.follow-instagram-card')
