                ...
                <div class="row g-4 g-2">
                    <div class="col-md-6">
                        <a href="{{ url('shop_pages/shop-right-sidebar')}}"
                            class="d-block position-relative cat_grid_item overflow-hidden h-100">
                            <div class="h-100 w-100 cat-grid-img"
                                style="background-image: url('{{ asset('/build/images/home-header-01/women-cat.jpg')}}"></div>
                    ...
                    <div class="col-md-3">
                        <a href="{{ url('shop_pages/shop-right-sidebar')}}"
                            ...
                            <div class="h-100 w-100 cat-grid-img"
                                style="background-image: url('/build/images/home-01/bn-02.jpg');background-position: center;">
                            </div>
                            <div class="cat-grid-button text-body">
                        ...
                        <a href="{{ url('shop_pages/shop-right-sidebar')}}"
                            ...
                            <div class="h-100 w-100 cat-grid-img"
                                style="background-image: url('/build/images/home-01/bn-03.jpg');background-position: center;">
                            </div>
                            <div class="cat-grid-button text-body">
                    ...
                    <div class="col-md-3">
                        <a href="{{ url('shop_pages/shop-right-sidebar')}}"
                            class="d-block position-relative cat_grid_item overflow-hidden h-100">
                            <div class="h-100 w-100 cat-grid-img"
                                style="background-image: url('/build/images/home-01/bn-04.jpg'); background-position: center;">
                            </div>
                            <div class="cat-grid-button text-body">
