...
<!-- main slide -->
<div style="background-image: url('/build/images/shop/shop-banner.jpg'); background-position: center; background-size: cover;" class="position-relative">
...
<div class="container shop-container">
    <div class=" mt-5 d-flex justify-content-between align-items-center">
        ...
        <ul class=" nav tab_header tab_filter gap-2 justify-content-end justify-content-sm-center" id="pills-tab" role="tablist">
            ...
            <li class="nav-item d-none d-md-block" role="presentation">
                <button class="nav-link" id="sale-tab" data-bs-toggle="pill" data-bs-target="#sale" type="button" role="tab" aria-controls="sale" aria-selected="false">
                    <div class="filter-option d-flex">
                        <div class="grid1"></div>
                        <div class="grid1"></div>
                        <div class="grid1"></div>
            ...
            <li class="nav-item d-none d-xl-block" role="presentation">
                <button class="nav-link active" id="top-product-tab" data-bs-toggle="pill" data-bs-target="#top-product" type="button" role="tab" aria-controls="top-product" aria-selected="false">
                    <div class="filter-option d-flex">
                        <div class="grid1"></div>
                        <div class="grid1"></div>
                        <div class="grid1"></div>
    ...
    <!--  -->
    <!-- tab -->
    <div class="tab-content my-3 my-md-5" id="pills-tabContent">
        <div class="tab-pane fade" id="best-pan1" role="tabpanel" aria-labelledby="best-pan1-tab" tabindex="0">
            <div class="row g-lg-4 g-3">
                <div class="col-12">
                    <div x-data="{ imageUrl: '/build/images/products/pr-01.jpg' }" :class="{ 'w-100': true, 'h-100': true }" class="topbar-product-card pb-3">
                ...
                <div class="col-12">
                    <div x-data="{ imageUrl: '/build/images/megamenu/pr-11.jpg' }" class="topbar-product-card pb-3">
                        <div class="position-relative overflow-hidden">
                            ...
                            <img :src="imageUrl" alt="" class="img-fluid w-100" src="{{ URL::asset('/build/images/products/pr-18.jpg')}}">
                            <a href="#" class="d-lg-none position-absolute " style="z-index: 1; top:10px; left:10px;" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o text-white"></i></a>
                            <a href="#" class="wishlistadd d-none d-lg-flex position-absolute" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o text-white"></i></a>
            ...
            <div class="row g-lg-4 g-3">
                ...
                <div class="col-6">
                    <div x-data="{ imageUrl: '/build/images/shop/pr-01.jpg' }" class="topbar-product-card pb-3">
                        ...
                        <div class="mt-3">
                            <h6 class="mb-1"><a href="{{ url('product/product-detail-layout-01')}}" class="product-title">Chill
                                    Candle</a></h6>
                            <p class="mb-0 fs-14 text-muted">
                                <span>$16.00</span>
                            </p>
        ...
        <div class="tab-pane fade show active" id="top-product" role="tabpanel" aria-labelledby="top-product-tab" tabindex="0">
            <div class="row g-lg-4 g-3">
