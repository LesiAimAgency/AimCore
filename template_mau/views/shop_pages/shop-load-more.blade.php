...
@section('content')
    ...
    <div class="container">
        <div class=" mt-5 d-flex justify-content-between align-items-center">
            <a href="#!" class="text-muted fs-16 d-flex align-items-center" id="filter-icon">
                <i class="iccl fwb iccl-filter fwb me-2 fw-medium" id="icon-filter"></i>
                <i class="pe-7s-close pegk d-none me-2 fw-medium fs-20 fw-semibold" id="icon-close"></i>
            ...
            <ul class=" nav tab_header tab_filter gap-2 justify-content-end justify-content-sm-center" id="pills-tab"
                ...
                <li class="nav-item d-none d-xl-block" role="presentation">
                    <button class="nav-link" id="top-product-tab" data-bs-toggle="pill" data-bs-target="#top-product"
                        type="button" role="tab" aria-controls="top-product" aria-selected="false">
                        <div class="filter-option d-flex">
                            <div class="grid1"></div>
                            <div class="grid1"></div>
                            <div class="grid1"></div>
            ...
            <div class="dropdown">
                <button
                    class="btn d-flex align-items-center justify-content-between featurnBtn rounded-pill dropdown-toggle"
            ...
            <div class="row m-sm-2 g-4 g-sm-2">
                ...
                <div class=" col-sm-6 col-lg-3">
                    ...
                    <form class="form-inline my-2 my-lg-4 filter-search me-3">
                        <input class="form-control fs-12" type="search" placeholder="Search for product title"
                            aria-label="Search">
        ...
        <div class="tab-content my-3 my-md-4" id="pills-tabContent">
                ...
                <div class="row g-lg-4 g-3">
                    <div class="col-12">
                        <div x-data="{ imageUrl: '/build/images/products/pr-01.jpg' }" :class="{ 'w-100': true, 'h-100': true }"
                            class="topbar-product-card pb-3 w-100">
            ...
            <div class="tab-pane fade " id="best-seller" role="tabpanel" aria-labelledby="best-seller-tab"
                ...
                <div class="row g-lg-4 g-3">
                    <div class="col-6">
                        <div x-data="{ imageUrl: '/build/images/products/pr-01.jpg', isHovered: false }" class="topbar-product-card pb-3 w-100"
                    ...
                    <div class="col-6 ">
                        <div x-data="{ imageUrl: '/build/images/products/pr-27.jpg', isHovered: false }" class="topbar-product-card pb-3 w-100"
                            x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                            <div class="position-relative overflow-hidden">
                    ...
                    <div class="col-6">
                        <div x-data="{ imageUrl: '/build/images/products/pr-33.jpg', isHovered: false }" class="topbar-product-card pb-3 w-100"
                            x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                            <div class="position-relative overflow-hidden">
                    ...
                    <div class="col-6 ">
                        <div x-data="{ imageUrl: '/build/images/products/pr-18.jpg', isHovered: false }" class="topbar-product-card pb-3 w-100"
                            x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                            <div class="position-relative overflow-hidden">
                    ...
                    <div class="col-6">
                        <div x-data="{ imageUrl: '/build/images/products/pr-15.jpg', isHovered: false }" class="topbar-product-card pb-3 w-100"
                            x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                            <div class="position-relative overflow-hidden">
                    ...
                    <div class="col-6 ">
                        <div x-data="{ imageUrl: '/build/images/home-fashion-simple/pr-01.jpg', isHovered: false }" class="topbar-product-card pb-3 w-100"
                            x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                            <div class="position-relative overflow-hidden">
                                <img :src="isHovered ? '/build/images/home-fashion-simple/pr-02.jpg' : imageUrl"
                                    alt="" class="img-fluid w-100 w-100 h-100" style="height: 350px;">
                                <a href="#" class="wishlistadd position-absolute" data-bs-toggle="tooltip"
                                    data-bs-placement="top" data-bs-title="Add to Wishlist"><i
                                        class="facl facl-heart-o text-white"></i></a>
                    ...
                    <div class="col-6">
                        <div x-data="{ imageUrl: '/build/images/shop/pr-01.jpg' }" class="topbar-product-card pb-3 w-100">
                            <div class="position-relative overflow-hidden">
                                <img :src="imageUrl" alt="" class="img-fluid w-100">
                                <a href="#" class="wishlistadd text-white position-absolute"
                                    data-bs-toggle="tooltip" data-bs-placement="top"
                            ...
                            <div class="mt-3">
                                <h6 class="mb-1"><a href="{{ URL::asset('/build/images/shop/pr-01.jpg') }}"
                ...
                <div class="row g-lg-4 g-3">
                    ...
                    <div class="col-md-4 col-6 ">
                        <div x-data="{ imageUrl: '/build/images/home-fashion-simple/pr-01.jpg', isHovered: false }" class="topbar-product-card pb-3 w-100"
                            ...
                            <div class="position-relative overflow-hidden">
                                <img :src="isHovered ? '/build/images/home-fashion-simple/pr-02.jpg' : imageUrl"
                                    alt="" class="img-fluid w-100 h-100" style="height: 350px;">
                                <a href="#" class="wishlistadd position-absolute" data-bs-toggle="tooltip"
                                    data-bs-placement="top" data-bs-title="Add to Wishlist"><i
                                        class="facl facl-heart-o text-white"></i></a>
        ...
        <div class="d-flex justify-content-center mb-5">
            <button type="submit" class="btn-load btn btn-custom-dark fw-semibold min-w-150 rounded-pill">
                Lorn more
            </button>
        </div>
    </div>
@endsection
@section('js')
    <script src="{{ URL::asset('build/libs/nouislider/nouislider.js') }}"></script>
@endsection
