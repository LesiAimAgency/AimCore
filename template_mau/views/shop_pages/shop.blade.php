                        ...
                        <div x-data="{ imageUrl: '/build/images/products/pr-01.jpg' }" :class="{ 'w-100': true, 'h-100': true }" class="topbar-product-card pb-3 w-100">
                            <div class="position-relative overflow-hidden">
                                ...
                                <div class="product-button d-flex flex-column gap-2">
                                    ...
                                    <button data-bs-toggle="offcanvas" href="#shoppingCartOffcanvas" aria-controls="shoppingCartOffcanvas" class="btn rounded-pill fs-14"><span>Quick
                                            Cart</span> <i class="iccl iccl-cart"></i></button>
                                </div>
                    ...
                    <div class="col-12">
                        <div x-data="{ imageUrl: '/build/images/megamenu/pr-11.jpg' }" class="topbar-product-card pb-3 w-100">
                            <div class="position-relative overflow-hidden">
                                ...
                                <img :src="imageUrl" alt="" class="img-fluid w-100" src="{{ URL::asset('/build/images/products/pr-33.jpg')}}">
                                <a href="#" class="d-lg-none position-absolute " style="z-index: 1; top:10px; left:10px;" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o text-white"></i></a>
                                <a href="#" class="wishlistadd d-none d-lg-flex position-absolute" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o text-white"></i></a>
...
<div class="row cookies-law d-lg-flex justify-content-lg-between align-items-center">
    <p class="col-lg-8 mb-0 text-muted">We use cookies to improve your experience on our website. By browsing this
        website, you
        agree to our use of
        cookies.</p>
    <div class=" col-lg-4 text-center mt-3 mt-lg-0 text-lg-end">
        <a href="#!" class="btn"> MORE INFO</a>
        <a class="btn btn-teal text-white  px-4 fw-medium rounded-0" href="#!">ACCEPT</a>
    </div>
