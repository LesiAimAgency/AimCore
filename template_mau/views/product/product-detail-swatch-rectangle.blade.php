        ...
        <div class="container">
            <div class="row py-3 gx-xl-1">
                ...
                <div class="col-md-6 mt-5 mt-md-0">
                    ...
                    <div class="custome-radio" x-data="{ colors: 'Gray', color: '#5f5d5e' }">
                        <h6 class="text-uppercase fw-bold mb-3">Color: <span x-text="colors"></span></h6>
                        <div class="color-list mt-2 d-flex align-items-center">
                            <a href="#!" x-on:click.prevent="colors = 'Gray';">
                                <div class="button" :class="{ 'active': colors === 'Gray' }">
                                    <input type="radio" id="gray" name="check-substitution-2" x-model="color" value="Gray" />
                                    <label for="gray">GRAY</label>
                                </div>
                            </a>
                            <a href="#!" x-on:click.prevent="colors = 'Pink';">
                                <div class="button" :class="{ 'active': colors === 'Pink' }">
                                    <input type="radio" id="pink" name="check-substitution-2" x-model="color" value="Pink" checked />
                                    <label for="pink">PINK</label>
                                </div>
                            </a>
                            <a href="#!" x-on:click.prevent="colors = 'Black';">
                                <div class="button" :class="{ 'active': colors === 'Black' }">
                                    <input type="radio" id="black" name="check-substitution-2" x-model="color" value="Black" />
                    ...
                    <div x-data="{ size: 'M', color: '#fff' }" class="py-2">
                        ...
                        <div class="product-color-list size mt-2 gap-2 d-flex align-items-center">
                            <a href="#!" class="d-inline-block d-flex align-items-center justify-content-center">
                                <div class="button" :class="{ 'active': size === 'S' }" x-on:click.prevent="size = 'S';">
                                    <input type="radio" id="a" name="check-substitution-2" x-model="color" value="S" />
                                    <label for="a5" style="width: 32px;">S</label>
                                </div>
                            </a>
                            <a href="#!" class="d-inline-block mx-2 d-flex align-items-center justify-content-center">
                                <div class="button" :class="{ 'active': size === 'M' }" x-on:click.prevent="size = 'M';">
                                    <input type="radio" id="a" name="check-substitution-2" x-model="color" value="M" />
                                    <label for="a4" style="width: 32px;">M</label>
                                </div>
                            </a>

                            <a href="#!" class="d-inline-block d-flex align-items-center justify-content-center">
                                <div class="button" :class="{ 'active': size === 'L' }" x-on:click.prevent="size = 'L';">
                                    <input type="radio" id="a" name="check-substitution-2" x-model="color" value="M" />
                                    <label for="a3" style="width: 32px;">L</label>
                                </div>
                            </a>
    ...
    <div class="mt-4 mb-5 py-5 d-none d-lg-block main-project-section">
        <div class="container">
            <ul class="nav tab_header justify-content-center" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-pill pill-border fw-medium" id="sale-tab" data-bs-toggle="pill" data-bs-target="#sale" type="button" role="tab" aria-controls="sale" aria-selected="false">Warranty
                        & Shipping</button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content mt-5" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="sale" role="tabpanel" aria-labelledby="sale-tab" tabindex="0">
                    ...
                    <p class="mb-0">
                        ...
                        you feel your product meets these requirements, please email <a href="#!">warranty@domain.com</a>
                        explaining the
                                    ...
                                    <button type="button" class="btn btn-warning py-1 px-2">
                                        <svg class="me-1" xmlns="http://www.w3.org/2000/svg" width="18.37" height="17.8" viewBox="0 0 21.682 21.602">
                                            <g id="Symbol_32_2" data-name="Symbol 32 – 2" transform="translate(-961.98 -374.155)">
                                                ...
                                                <path d="M2858.324,3384.6h7.412" transform="translate(-1891.1 -3003.987)" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"></path>
                                                <path d="M2858.324,3384.6h7.412" transform="translate(-1891.1 -2999.611)" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-width="1">
                                                </path>
                                                <path d="M8.952,0H15a2,2,0,0,1,2,2V15a2,2,0,0,1-2,2H2a2,2,0,0,1-2-2V12.162" transform="translate(979.48 391.655) rotate(180)" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"></path>
                                            </g>
                                        </svg> Write a review</button>
