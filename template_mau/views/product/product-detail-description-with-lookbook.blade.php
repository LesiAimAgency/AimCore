                    ...
                    <div class="row g-2">
                            ...
                            <div thumbsSlider="" class="swiper productSmall">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/description-with-lookbook/full-size-01.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/description-with-lookbook/full-size-02.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/description-with-lookbook/full-size-03.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/description-with-lookbook/full-size-01.jpg')}}" class="object-fit-cover" />
                                    </div>
                        ...
                        <div class="col-xl-9 mt-3 order-1 order-xl-2">
                            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper productMain">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/description-with-lookbook/full-size-01.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/description-with-lookbook/full-size-02.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/description-with-lookbook/full-size-03.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/description-with-lookbook/full-size-01.jpg')}}" class="img-fluid w-100" />
                                    </div>
                ...
                <div class="col-md-6 mt-5 mt-md-0">
                    ...
                    <div x-data="{ size: 'M', color: '#fff' }" class="pt-2 mb-4 pb-3">
                        ...
                        <div class="product-color-list size mt-2 gap-2 d-flex align-items-center">
                            ...
                            <a href="#!" class="d-inline-block rounded-circle square-xs d-flex align-items-center justify-content-center" :class="{ 'active': size === 'XL' }" x-on:click.prevent="size = 'XL';">XL</a>
                        </div>
                    </div>
                    ...
                    <div class="mt-5">
                        <div class="position-relative">
                            ...
                            <div class="pin-type position-absolute position-01">
                                ...
                                <a class="bg_color_red text-white rounded-circle d-flex align-items-center justify-content-center position-relative" tabindex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-title="Popover title" data-bs-content="And here's some amazing content. It's very engaging. Right?">
                                    <i class="nav_link_icon position-relative"></i>
                                </a>
                            </div>
                            <div class="pin-type position-absolute position-02">
                                <span class="zoompin"></span>
                                <a href="#pinType2" class="bg_color_red text-white rounded-circle d-flex align-items-center justify-content-center position-relative">
                                    <i class="nav_link_icon position-relative"></i>
                                </a>
                            </div>
                            ...
                            <div class="pin-type position-absolute position-03">
                                <span class="zoompin"></span>
                                <a href="#pinType3" class="bg_color_red text-white rounded-circle d-flex align-items-center justify-content-center position-relative">
                                    <i class="nav_link_icon position-relative"></i>
                                </a>
                            </div>
                            <div class="pin-type position-absolute position-04">
                                <span class="zoompin"></span>
                                <a href="#pinType4" class="bg_color_red text-white rounded-circle d-flex align-items-center justify-content-center position-relative">
                                    <i class="nav_link_icon position-relative"></i>
                                </a>
                            </div>
                            <div class="pin-type position-absolute position-05">
                                <span class="zoompin"></span>
                                <a href="#pinType5" class="bg_color_red text-white rounded-circle d-flex align-items-center justify-content-center position-relative">
                                    <i class="nav_link_icon position-relative"></i>
                                </a>
                            </div>
                        </div>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center py-2">
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    <div>
                        <img alt="" src="{{ URL::asset('/build/images/single-product/description-with-lookbook/thumb-sticky.jpg')}}" style="max-height: 75px; max-width: 65px; Width: auto; height: auto; vertical-align: middle;">
                    </div>
                    <div class="ms-2">
                        <h6 class="mb-1">Analogue Resin Strap</h6>
                        <a href="#" class="text-teal text-decoration-underline fs-12 fw-semibold">XS</a>
                    </div>
                </div>
            </div>
            <div class="col-auto mt-2 mt-md-0">
                <div class="d-flex align-items-center gap-2">
                    <p class="text-muted fs-16 mb-0 d-none d-md-flex"><span class="text-danger">$30.00</span></p>
