...
<div>
            ...
            <div class="d-flex justify-content-between align-items-center py-3">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 fs-13">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">High Waist Skinny Jean</li>
                    </ol>
                </nav>
            ...
            <div class="row py-3 gx-xl-1">
                <div class="col-md-6">
                    <div class="row g-2 g-lg-0">
                            ...
                            <div class="swiper productMain">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="position-relative topbar-product-card overflow-hidden h-100">
                                            <img src="{{ URL::asset('/build/images/single-product/thumb-right/pr-10.jpg')}}" class="img-fluid w-100" />
                                            <span class="new-label bg-danger text-white rounded-circle"> -34% </span>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/thumb-right/thumb-02.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/thumb-right/thumb-03.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/thumb-right/pr-09.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/thumb-right/thumb-05.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/thumb-right/thumb-06.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/thumb-right/thumb-07.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/thumb-right/thumb-08.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/thumb-right/thumb-09.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/thumb-right/thumb-10.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-2 mt-xl-3 mt-2 ms-2">
                            <div class="swiper productSmall">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/thumb-right/pr-10.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/thumb-right/thumb-02.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/thumb-right/thumb-03.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/thumb-right/pr-09.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/thumb-right/thumb-05.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/thumb-right/thumb-06.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/thumb-right/thumb-07.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/thumb-right/thumb-08.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/thumb-right/thumb-09.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/thumb-right/thumb-10.jpg')}}" class="object-fit-cover" />
                                    </div>
                                </div>
                                <div class="swiper-button-next"></div>
                                <div class="swiper-button-prev"></div>
                ...
                <div class="col-md-6 mt-5 mt-md-0">
                    <h4 class="mb-3">High Waist Skinny Jean</h4>
                    <div class="d-flex flex-wrap justify-content-between">
                        <p class="text-muted fs-18 mb-4"><del>$45.00</del><span class="text-danger ms-2">$30.00</span>
                        </p>
                    ...
                    <div x-data="{ size: 'M', color: '#fff' }" class=" pt-2">
                ...
                <div class="tab-pane fade show active" id="best-seller" role="tabpanel" aria-labelledby="best-seller-tab" tabindex="0">
                    ...
                    <div class="mt-5">
                        <div class="position-relative">
                            <img src="{{ URL::asset('/build/images/home-lookbook/slide-01.jpg')}}" class="img-fluid" alt="">
                            ...
                            <div class="pin-type position-absolute position-02">
                                <span class="zoompin"></span>
                                <a href="#pinType2" class="bg_color_red text-white rounded-circle d-flex align-items-center justify-content-center position-relative" data-bs-toggle="modal">
                                    <i class="nav_link_icon position-relative"></i>
                                </a>
                            </div>
                            ...
                            <div class="pin-type position-absolute position-14">
                                <span class="zoompin"></span>
                                <a href="#pinType6" class="bg_color_red text-white rounded-circle d-flex align-items-center justify-content-center position-relative" data-bs-toggle="modal">
                                    <i class="nav_link_icon position-relative"></i>
                                </a>
                            </div>
                        </div>
    ...
    <section class="pt-5 py-lg-5 mb-3">
        <div class="container">
            ...
            <div class="container">
                <div class="row justify-content-center mt-xl-5 pt-2">
                    <div class="col-lg-7">
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center py-2">
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    <div>
                        <img alt="" src="{{ URL::asset('/build/images/single-product/des-02.jpg')}}" style="max-height: 75px; max-width: 65px; Width: auto; height: auto; vertical-align: middle;">
                    </div>
                    <div class="ms-2">
                        <h6 class="mb-1">High Waist Skinny Jean</h6>
                        <a href="#" class="text-teal text-decoration-underline fs-12 fw-semibold">M</a>
                    </div>
                </div>
            </div>
            <div class="col-auto mt-2 mt-md-0">
                <div class="d-flex flex-wrap align-items-center gap-2">
                    <p class="text-muted fs-18 mb-0"><del>$45.00</del><span class="text-danger ms-2">$30.00</span></p>
        ...
        <div class="modal-content">
            <div class="modal-body p-20">
                <div x-data="{ imageUrl: '/build/images/home-lookbook/pinner-p-09.jpg', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false" class="topbar-product-card">
                    ...
                    <div class="mt-3 text-center">
                        <h6 class="mb-2"><a href="{{ url('product/product-detail-layout-01')}}" class="product-title">Ritson Original
                                Mom Jeans</a></h6>
                        <p class="mb-0 fs-14 text-muted">
                            <span>$22.00</span>
                        </p>
