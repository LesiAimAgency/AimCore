            ...
            <div class="d-flex justify-content-between align-items-center py-3">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 fs-13">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Analogue Resin Strap Watch</li>
                    </ol>
                </nav>
        ...
        <div class="container">
            <div class="row py-3 gx-xl-1">
                    ...
                    <div class="row g-2">
                            ...
                            <div thumbsSlider="" class="swiper productSmall">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/back-in-stock-notification/thumb-01.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/back-in-stock-notification/thumb-02.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/back-in-stock-notification/thumb-03.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/back-in-stock-notification/thumb-04.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/back-in-stock-notification/thumb-03.jpg')}}" class="object-fit-cover" />
                                    </div>
                        ...
                        <div class="col-xl-9 mt-3 order-1 order-xl-2">
                            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper productMain">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/back-in-stock-notification/thumb-01.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/back-in-stock-notification/thumb-02.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/back-in-stock-notification/thumb-03.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/back-in-stock-notification/thumb-04.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/back-in-stock-notification/thumb-03.jpg')}}" class="img-fluid w-100" />
                                    </div>
                ...
                <div class="col-md-6 mt-5 mt-md-0">
                    <h4 class="mb-3">Analogue Resin Strap Watch</h4>
                    <div class="d-flex flex-wrap justify-content-between">
                        <p class="text-muted fs-18 mb-4">$85.00</p>
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-2 my-4">
                        <button x-data="{ shake: false }" x-init="
                                ...
                                " :class="{ 'animation-shake': shake }" data-bs-toggle="offcanvas" data-bs-target="#shoppingCartOffcanvas" aria-controls="shoppingCartOffcanvas" class="btn btn-outline-dark fw-medium border-2 fw-semibold rounded-pill min-w-150">
                            Out of Stock
                        </button>
                    ...
                    <div class="mb-3">
                        <h6 class="border-top fs-16 py-3 mt-3">
                            Notify me when this product is available:
                        </h6>
                        <label for="email" role="button" class="text-muted mb-1">Email address*</label>
                        <input class="form-control rounded-0" id="email" type="Email" aria-label="default input example">
                    </div>
                    <a href="#!">
                        <div class="btn btn-outline-dark border-2 fw-semibold rounded-pill min-w-150 mt-2">Email
                            Me When
                            Avilable</div>
                    </a>
                    <div class="mt-4">
            ...
            <div class="tab-content mt-5" id="pills-tabContent">
                <div class="tab-pane fade show active" id="best-seller" role="tabpanel" aria-labelledby="best-seller-tab" tabindex="0">
                    ...
                    <div class="row my-5 g-3">
                        <div class="col-md-4">
                            <img src="{{ URL::asset('/build/images/single-product/back-in-stock-notification/thumb-01.jpg')}}" class="img-fluid" alt="">
                        </div>
                        <div class="col-md-4">
                            <img src="{{ URL::asset('/build/images/single-product/back-in-stock-notification/thumb-02.jpg')}}" class="img-fluid" alt="">
                        </div>
                        <div class="col-md-4">
                            <img src="{{ URL::asset('/build/images/single-product/back-in-stock-notification/thumb-03.jpg')}}" class="img-fluid" alt="">
                        </div>
                    </div>
