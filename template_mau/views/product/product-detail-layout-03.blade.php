...
<div>
            ...
            <div class="d-flex justify-content-between align-items-center py-3">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 fs-13">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Black mountain hat</li>
                    </ol>
                </nav>
            ...
            <div class="row py-3 gx-4">
                <div class="col-md-6">
                    <div class="row g-2">
                        <div class="col-12">
                            <div style="">
                                <img src="{{ URL::asset('/build/images/products/pr-25.png')}}" alt="" class="img-fluid w-100" style="">
                                <img src="{{ URL::asset('/build/images/products/pr-26.png')}}" alt="" class="img-fluid w-100 mt-4" style="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="position-sticky mt-4 mt-md-0" style="top: 1.5rem;">
                        <h4 class="mb-3 fs-20">Black mountain hat</h4>
    ...
    <!-- Accordion -->
    <div class="mt-4 mb-lg-5 d-block d-lg-none">
        <div class="container">
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center py-2">
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    <div>
                        <img alt="" src="{{ URL::asset('/build/images/products/pr-25.png')}}" style="max-height: 75px; max-width: 65px; Width: auto; height: auto; vertical-align: middle;">
                    </div>
                    <div class="ms-2">
                        <h6 class="mb-1 fs-20">Black mountain hat</h6>
                        <a href="#" class="text-teal text-decoration-underline fs-12 fw-semibold">Black</a>
                    </div>
                </div>
            </div>
            <div class="col-auto mt-2 mt-md-0">
                <div class="d-flex align-items-center gap-2">
                    <p class="text-danger fs-18 mb-0 d-none d-md-flex">$50.00</p>
