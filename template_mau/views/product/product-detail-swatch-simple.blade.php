        ...
        <div class="container">
            <div class="row py-3 gx-xl-1">
                ...
                <div class="col-md-6 mt-5 mt-md-0">
                    ...
                    <div>
                        <h6 class="text-uppercase fw-bold mb-3">Color</h6>
                        <select class="form-select mb-3" id="address_country_ship_2">
                            <option value="">---</option>
                            <option value="United States" selected="">Black</option>
                            <option value="United Kingdom">Gray</option>
                            <option value="Italy">Pink</option>

                        </select>
                    </div>

                    <div x-data="{ size: 'M', color: '#fff' }" class="pt-2 mb-4 pb-3">
                        <h6 class="text-uppercase fw-bold">Size: </h6>
                        <select class="form-select mb-3" id="address_country_ship_2">
                            <option value="">---</option>
                            <option value="United States" selected="">S</option>
                            <option value="United Kingdom">M</option>
                            <option value="Italy">L</option>
