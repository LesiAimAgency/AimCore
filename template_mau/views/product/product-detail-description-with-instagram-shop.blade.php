            ...
            <div class="d-flex justify-content-between align-items-center py-3">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 fs-13">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Cream women pants</li>
                    </ol>
                </nav>
        ...
        <div class="container">
            <div class="row py-3 gx-xl-1">
                    ...
                    <div class="row g-2">
                            ...
                            <div thumbsSlider="" class="swiper productSmall">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/simple-product/thumb-01.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/simple-product/thumb-02.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/simple-product/thumb-03.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/simple-product/thumb-02.jpg')}}" class="object-fit-cover" />
                                    </div>
                        ...
                        <div class="col-xl-9 mt-3 order-1 order-xl-2">
                            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper productMain">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/simple-product/thumb-01.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/simple-product/thumb-02.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/simple-product/thumb-03.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/simple-product/thumb-02.jpg')}}" class="img-fluid w-100" />
                                    </div>
                ...
                <div class="col-md-6 mt-5 mt-md-0">
                    <h4 class="mb-3">
                        Cream women pants</h4>
                    <div class="d-flex flex-wrap justify-content-between">
                        <p class="text-muted fs-18 mb-4">$35.00</p>
            ...
            <div class="tab-content mt-5" id="pills-tabContent">
                <div class="tab-pane fade show active" id="best-seller" role="tabpanel" aria-labelledby="best-seller-tab" tabindex="0">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <h3 class="text-center my-4">Shop the look</h3>
                        </div><!--end col-->
                    </div><!--end row-->
                    <div class="row" data-flickity='{"imagesLoaded": 0,"adaptiveHeight": 1, "contain": 1, "groupCells": "100%", "dragThreshold" : 5, "cellAlign": "left","wrapAround": false,"prevNextButtons": true,"percentPosition": 1,"pageDots": false, "autoPlay" : 0, "pauseAutoPlayOnHover" : true, "rightToLeft": false }'>
                        <div class="col-md-3 col-6">
                            <div class="insta-card position-relative">
                                ...
                                <a href="#!" data-bs-toggle="modal" data-bs-target="#exampleModal" class="card-spin position-01 position-absolute fs-14 bg-dark border border-2 text-white border-white rounded-circle fw-semibold">1</a>
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="insta-card position-relative">
                                <img src="{{ URL::asset('/build/images/instagram/ins1_8.jpg')}}" alt="" class="img-fluid">
                                <a href="#!" data-bs-toggle="modal" data-bs-target="#exampleModal" class="card-spin position-02 position-absolute fs-14 bg-dark border border-2 text-white border-white rounded-circle fw-semibold">1</a>
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="insta-card position-relative">
                                <img src="{{ URL::asset('/build/images/instagram/ins1_1.jpg')}}" alt="" class="img-fluid">
                                <a href="#!" data-bs-toggle="modal" data-bs-target="#exampleModal" class="card-spin position-03 position-absolute fs-14 bg-dark border border-2 text-white border-white rounded-circle fw-semibold">1</a>
                                <a href="#!" data-bs-toggle="modal" data-bs-target="#exampleModal" class="card-spin position-04 position-absolute fs-14 bg-dark border border-2 text-white border-white rounded-circle fw-semibold">2</a>
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="insta-card position-relative">
                                <img src="{{ URL::asset('/build/images/instagram/ins1_6.jpg')}}" alt="" class="img-fluid">
                                <a href="#!" data-bs-toggle="modal" data-bs-target="#exampleModal" class="card-spin position-05 position-absolute fs-14 bg-dark border border-2 text-white border-white rounded-circle fw-semibold">1</a>
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="insta-card position-relative">
                                <img src="{{ URL::asset('/build/images/instagram/ins1_5.jpg')}}" alt="" class="img-fluid">
                                <a href="#!" data-bs-toggle="modal" data-bs-target="#exampleModal" class="card-spin position-06 position-absolute fs-14 bg-dark border border-2 text-white border-white rounded-circle fw-semibold">1</a>
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="insta-card position-relative">
                                <img src="{{ URL::asset('/build/images/instagram/ins1_4.jpg')}}" alt="" class="img-fluid">
                                <a href="#!" data-bs-toggle="modal" data-bs-target="#exampleModal" class="card-spin position-07 position-absolute fs-14 bg-dark border border-2 text-white border-white rounded-circle fw-semibold">1</a>
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="insta-card position-relative">
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center py-2">
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    <div>
                        <img alt="" src="{{ URL::asset('/build/images/single-product/simple-product/thumb-sticky.jpg')}}" style="max-height: 75px; max-width: 65px; Width: auto; height: auto; vertical-align: middle;">
                    </div>
                    <div class="ms-2">
            ...
            <div class="col-auto mt-2 mt-md-0">
                <div class="d-flex align-items-center gap-2">
                    <p class="text-danger fs-18 mb-0 d-none d-md-flex">$35.00</p>
