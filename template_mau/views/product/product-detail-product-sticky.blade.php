...
<div>
            ...
            <div class="row py-3 gx-4">
                <div class="col-md-6">
                    <div class="row g-2">
                        <div class="col-12">
                            <div>
                                <img src="{{ URL::asset('/build/images/single-product/thumb-01.jpg')}}" alt="" class="img-fluid w-100">
                                <img src="{{ URL::asset('/build/images/single-product/thumb-02.jpg')}}" alt="" class="img-fluid w-100 mt-4">
                                <img src="{{ URL::asset('/build/images/single-product/thumb-03.jpg')}}" alt="" class="img-fluid w-100 mt-4">
                                <img src="{{ URL::asset('/build/images/single-product/thumb-04.jpg')}}" alt="" class="img-fluid w-100 mt-4">
                                <img src="{{ URL::asset('/build/images/single-product/thumb-05.jpg')}}" alt="" class="img-fluid w-100 mt-4">
                                <img src="{{ URL::asset('/build/images/single-product/thumb-07.jpg')}}" alt="" class="img-fluid w-100 mt-4">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="position-sticky mt-4 mt-md-0" style="top: 1.5rem;">
                        <h4 class="mb-3">Blush Beanie</h4>
                        <div class="d-flex flex-wrap justify-content-between">
                            <p class="text-muted fs-18 mb-4"><span>$50.00</span></p>
    ...
    <!-- tab -->
    <div class="mt-4 mb-5 py-5  d-none d-lg-block bg-light">
        <div class="container">
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center py-2">
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    <div>
                        <img alt="" src="{{ URL::asset('/build/images/single-product/layout-03/thumb-sticky.png')}}" style="max-height: 75px; max-width: 65px; Width: auto; height: auto; vertical-align: middle;">
                    </div>
                    <div class="ms-2">
                        <h6 class="mb-1">
                            Blush Beanie</h6>
            ...
            <div class="col-auto mt-2 mt-md-0">
                <div class="d-flex flex-wrap align-items-center gap-2">
                    <p class="text-muted fs-16 mb-0"> <span class="text-danger">$15 .00</span> </p>
