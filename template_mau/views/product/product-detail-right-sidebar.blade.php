...
<div>
            ...
            <div class="d-flex justify-content-between align-items-center py-3">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 fs-13">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Crosshatch Backpack</li>
                    </ol>
                </nav>
    ...
    <section class="py-4">
        <div class="container">
            <div class="row py-3">
                <div class="col-lg-6 col-xl-5 order-1 order-xl-1">
                    <div>
                        <div>
                            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper productLg">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/right-sidebar/thumb-01.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/right-sidebar/thumb-02.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/right-sidebar/thumb-03.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/right-sidebar/thumb-04.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                </div>
                        ...
                        <div class="mt-3">
                            <div thumbsSlider="" class="swiper productSm">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/right-sidebar/thumb-01.jpg')}}" class="w-100 h-auto object-fit-contain" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/right-sidebar/thumb-02.jpg')}}" class="w-100 h-auto object-fit-contain" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/right-sidebar/thumb-03.jpg')}}" class="w-100 h-auto object-fit-contain" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/right-sidebar/thumb-04.jpg')}}" class="w-100 h-auto object-fit-contain" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 col-xl-4 mt-5 mt-xl-0 order-2 order-xl-3">
                    <h4 class="mb-3">Crosshatch Backpack</h4>
                    <div class="d-flex flex-wrap justify-content-between">
                        <p class="text-muted fs-18 mb-4">$30.00</p>
                ...
                <div class="col-lg-6 col-xl-3 order-3 order-xl-3 mt-5 mt-xl-0">
                    <div>
                    ...
                    <div>
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <div class="d-flex mt-3 mt-sm-0">
                                <a href="#!" class="text-muted me-2 py-1 px-2" style="background-color: #f2f2f2;">Filter
                                    <span><img src="{{ URL::asset('/build/images/single-product/icon-down.svg')}}" alt=""></span></a>
                                <a href="#!" class="text-muted py-1 px-2" style="background-color: #f2f2f2;">Short by:
                                    Latest
                                    <span><img src="{{ URL::asset('/build/images/single-product/icon-down.svg')}}" alt=""></span></a>
                            </div>
                        </div>
        ...
        <div class="row justify-content-between align-items-center py-2">
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-2">
                        <h6 class="mb-1">Crosshatch Backpack</h6>
            ...
            <div class="col-auto mt-2 mt-md-0">
                <div class="d-flex align-items-center gap-2">
                    <p class="text-danger fs-18 mb-0 d-none d-md-flex">$30.00</p>
