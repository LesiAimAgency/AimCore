            ...
            <div class="d-flex justify-content-between align-items-center py-3">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 fs-13">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Boxy Sweatshirt Stripe</li>
                    </ol>
                </nav>
        ...
        <div class="container-fluid">
            <div class="row py-3 gx-xl-1">
                    ...
                    <div class="row g-2">
                            ...
                            <div thumbsSlider="" class="swiper productSmall">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/full-width/thumb-01.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/full-width/thumb-02.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/full-width/thumb-03.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/full-width/thumb-02.jpg')}}" class="object-fit-cover" />
                                    </div>
                        ...
                        <div class="col-xl-9 mt-3 order-1 order-xl-2">
                            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper productMain">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/full-width/thumb-01.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/full-width/thumb-02.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/full-width/thumb-03.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/full-width/thumb-02.jpg')}}" class="img-fluid w-100" />
                                    </div>
                ...
                <div class="col-md-6 mt-5 mt-md-0">
                    ...
                    <div x-data="{ size: 'L', color: '#fff' }" class="pt-2">
                        ...
                        <div class="product-color-list size mt-2 gap-2 d-flex align-items-center">
                            ...
                            <a href="#!" class="d-inline-block rounded-circle square-xs d-flex align-items-center justify-content-center" :class="{ 'active': size === 'L' }" x-on:click.prevent="size = 'L';">XL</a>
                        </div>
                    </div>
            ...
            <div class="tab-content mt-4" id="pills-tabContent">
                <div class="tab-pane fade show active" id="best-seller" role="tabpanel" aria-labelledby="best-seller-tab" tabindex="0">
                    ...
                    <div class="row my-5 g-3">
                        <div class="col-md-4">
                            <img src="{{ URL::asset('/build/images/single-product/full-width/thumb-02.jpg')}}" class="img-fluid" alt="">
                        </div>
                        <div class="col-md-4">
                            <img src="{{ URL::asset('/build/images/single-product/full-width/thumb-01.jpg')}}" class="img-fluid" alt="">
                        </div>
                        <div class="col-md-4">
                            <img src="{{ URL::asset('/build/images/single-product/full-width/thumb-03.jpg')}}" class="img-fluid" alt="">
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center py-2">
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    <div>
                        <img alt="" src="{{ URL::asset('/build/images/single-product/full-width/thumb-01.jpg')}}" style="max-height: 75px; max-width: 65px; Width: auto; height: auto; vertical-align: middle;">
                    </div>
                    <div class="ms-2">
                        <h6 class="mb-1">Boxy Sweatshirt Stripe</h6>
            ...
            <div class="col-auto mt-2 mt-md-0">
                <div class="d-flex align-items-center gap-2">
                    <p class="text-danger fs-16 mb-0 d-none d-md-flex">$18.00</p>
