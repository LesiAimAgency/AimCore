...
<div>
            ...
            <div class="d-flex justify-content-between align-items-center py-3">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 fs-13">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Adidas Copa Primeknit Sneakers</li>
                    </ol>
                </nav>
    ...
    <section class="py-4">
        <div class="container">
            <div class="row py-3 g-0">
                <div class="col-lg-6 m-xl-n3 pe-xl-5">
                    <div class="row g-2">
                        <div class="col-xl-10 order-2 order-xl-1 mt-3">
                            <div class="swiper productMain pickup-arrow">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/pickup-availability/thumb-01.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/pickup-availability/thumb-02.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/pickup-availability/thumb-03.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/pickup-availability/thumb-04.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/pickup-availability/thumb-01.jpg')}}" class="img-fluid w-100" />
                                    </div>
                        ...
                        <div class="col-xl-2 order-1 order-xl-2 mt-3">
                            <div thumbsSlider="" class="swiper productSmall">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide pe-2">
                                        <img src="{{ URL::asset('/build/images/single-product/pickup-availability/thumb-01.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide pe-2">
                                        <img src="{{ URL::asset('/build/images/single-product/pickup-availability/thumb-02.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide pe-2">
                                        <img src="{{ URL::asset('/build/images/single-product/pickup-availability/thumb-03.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide pe-2">
                                        <img src="{{ URL::asset('/build/images/single-product/pickup-availability/thumb-04.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide pe-2">
                                        <img src="{{ URL::asset('/build/images/single-product/pickup-availability/thumb-01.jpg')}}" class="object-fit-cover" />
                                    </div>
                ...
                <div class="col-lg-6 mt-5 mt-xl-0">
                    <h4 class="mb-3">Adidas Copa Primeknit Sneakers</h4>
                    <div class="d-flex justify-content-between">
                        <p class="text-muted fs-18 mb-4">$289.00</p>
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-2 mt-4">
                        ...
                        <button x-data="{ shake: false }" x-init="
                                ...
                                " :class="{ 'animation-shake': shake }" data-bs-toggle="offcanvas" data-bs-target="#shoppingCartOffcanvas" aria-controls="shoppingCartOffcanvas" class="btn btn-danger-dark text-uppercase rounded-pill min-w-150">
                            Add to Cart
                        </button>
                    ...
                    <div class="text-black fs-12 d-flex mt-5">
                        <i class="las la-truck fading_true fs__20 mr__5 mt-1 fs-16"></i>
                        <p class="ms-1">Order in the next 15 hours 13 minutes to get it between <span class="fw-medium border-bottom">Friday, 29th January and
                                Wednesday,
                                3rd February</span></p>
                    </div>
                    <div class="text-black fs-12 d-flex">
                        <i class="cd mr__5 fading_true fs__20 las la-eye mt-1 fs-16"></i>
                        <p class="ms-1"><span class="fw-medium border-bottom">85 People </span> are viewing this right
                            now</p>
                    </div>
                </div>
            </div>
    ...
    <!-- tab -->
    <div class="mt-4 mb-5 py-5 bg-light d-none d-xl-block">
        <div class="container">
            <ul class="nav tab_header justify-content-center" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-pill pill-border fw-medium" id="featured-tab" data-bs-toggle="pill" data-bs-target="#featured" type="button" role="tab" aria-controls="featured" aria-selected="false">Wash & Care</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-pill pill-border fw-medium" id="sale-tab" data-bs-toggle="pill" data-bs-target="#sale" type="button" role="tab" aria-controls="sale" aria-selected="false">Review</button>
                </li>
            ...
            <div class="tab-content mt-4" id="pills-tabContent">
                <div class="tab-pane fade show active" id="best-seller" role="tabpanel" aria-labelledby="best-seller-tab" tabindex="0">
                    ...
                    <h5 class="mt-4 mb-3">Composition</h5>
                    <ul class="list-unstyled">
                        <li class="pb-3 text-muted">Outer: Suede 100%</li>
                        <li class="pb-3 text-muted">Lining: Polyamide 100%</li>
                        <li class="pb-3 text-muted">Sole: Rubber 100%</li>
                        <li class="pb-3 text-muted">Designer Style ID: EE5730</li>
                    </ul>
                    <h5 class="mt-4 mb-3">Wearing</h5>
                    <ul class="list-unstyled">
                        <li class="text-muted">Model is 1.85 m wearing size 10 (UK)</li>
                    </ul>
                </div><!--end tab pane-->
    ...
    <!-- Accordion -->
    <div class="mt-4 mb-3 d-xl-none ">
        <div class="container">
            <div class="accordion accordion-flush product-accordion product-pickup" id="accordionFlushExample">
                    ...
                    <div id="flush-collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-2">
                                    <button type="button" class="btn btn-warning py-1 px-2">
                                        <svg class="me-1" xmlns="http://www.w3.org/2000/svg" width="18.37" height="17.8" viewBox="0 0 21.682 21.602">
                                            <g id="Symbol_32_2" data-name="Symbol 32 – 2" transform="translate(-961.98 -374.155)">
                                                <path d="M0,0H4V11.2L1.937,14h0L0,11.2Z" transform="translate(979.891 381.756) rotate(40)" fill="none" stroke="#ffffff" stroke-linejoin="round" stroke-width="1">
                                                </path>
                                                <path d="M0,0H4" transform="translate(972.692 390.335) rotate(40)" fill="none" stroke="#ffffff" stroke-width="1"></path>
                                                <g transform="translate(981.126 380.964) rotate(40)" fill="none" stroke="#ffffff" stroke-width="1">
                                                    <rect width="3.128" height="1.4" stroke="none"></rect>
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <p class="text-muted mb-0">Showing 1 - 6 of 13 reviews</p>
                                <div class="d-flex mt-3 mt-sm-0">
                                    <a href="#!" class="text-muted me-2 py-1 px-2 sub-gray bg-light">Filter
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h6>Contrary to popular belief</h6>
                                            <p class="text-muted mb-2">It is a long established fact that a reader
                                                will
                                                be
                                                distracted
                                                by the readable content of a page</p>
                                                ...
                                                <div class="d-flex align-items-center gap-1">
                                                    <svg fill="#878787" width="14" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.762 17.659" class="r--icon-dislike">
                                                        <g transform="translate(956.922 435.325) rotate(180)">
                                                            ...
                                                            <path d="M945.558,421.946v10.321l-2.9.261V421.777Z" transform="translate(-1 2.296)" class="cls-2">
                                                            </path>
                                                        </g>
                                                    </svg>
                                                    <span class="text-muted">08</span>
    ...
    <section class="pt-md-5 mb-md-3 xl:hidden">
        <div class="container">
            ...
            <div class="row my-4 py-2" data-flickity='{"imagesLoaded": 0,"adaptiveHeight": 0, "contain": 1, "groupCells": "100%", "dragThreshold" : 5, "cellAlign": "left","wrapAround": true,"prevNextButtons": false,"percentPosition": 1,"pageDots": false, "autoPlay" : 0, "pauseAutoPlayOnHover" : true, "rightToLeft": false }'>
                        ...
                        <div class="card-body">
                            <div x-data="{ imageUrl: '/build/images/home-shoes/pr-04.jpg', isHovered: false }" class="topbar-product-card overlay-hover" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                                <div class="position-relative overflow-hidden main">
                                    ...
                                    <div class="product-button d-none d-lg-flex flex-column gap-2" style="  box-shadow: 1px 1px 1px rgba(0, 0, 0, .1);">
                ...
                <div class="col-md-3 col-6">
                    <div class="card rounded-0 mb-0 border-start-0">
                        <div class="card-body">
                ...
                <div class="col-md-3 col-6">
                    <div class="card rounded-0 mb-0 border-start-0">
                        <div class="card-body">
                            <div x-data="{ imageUrl: '/build/images/home-shoes/pr-15.jpg', isHovered: false }" class="topbar-product-card overlay-hover" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                                <div class="position-relative overflow-hidden main">
                                    <img :src="isHovered ? '/build/images/home-shoes/pr-15.jpg' : imageUrl" alt="" class="img-fluid">
                                    <a href="#" class="wishlistadd position-absolute" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                                    <a href="#!" class="compare_add position-absolute" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Compare">
                                        <i class="las la-sync"></i>
                                    </a>
                                    ...
                                    <p class="product-size mb-0 text-center text-white fw-medium">40, 41, 42, 43, 44, 45
                                    </p>
                                </div>
                                <div class="mt-3">
                                    ...
                                    <div class="product-color-list mt-2 gap-2 d-flex align-items-center">
                                        <a href="#!" x-on:click.prevent="imageUrl = '/build/images/home-shoes/pr-14.jpg'; isHovered = false" class="d-inline-block bg-warning-subtle rounded-circle"></a>
                                        <a href="#!" x-on:click.prevent="imageUrl = '/build/images/home-shoes/pr-15.jpg'; isHovered = false" class="d-inline-block bg-dark rounded-circle"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row justify-content-center mt-lg-5 pt-lg-2">
                <div class="col-lg-7">
                    ...
                    <div class="card rounded-0 mb-0">
                        <div class="card-body">
                            <div x-data="{ imageUrl: '/build/images/home-shoes/pr-21.jpg', isHovered: false }" class="topbar-product-card overlay-hover" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                                <div class="position-relative overflow-hidden main">
                                    <img :src="isHovered ? '/build/images/home-shoes/pr-22.jpg' : imageUrl" alt="" class="img-fluid">
                                    <a href="#!" class="wishlistadd position-absolute" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                                    <a href="#!" class="compare_add position-absolute" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Compare">
                                        <i class="las la-sync"></i>
                                    </a>
                    ...
                    <div class="card rounded-0 mb-0 border-start-0">
                        <div class="card-body">
                            <div x-data="{ imageUrl: '/build/images/home-shoes/pr-06.jpg', isHovered: false }" class="topbar-product-card overlay-hover" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                                <div class="position-relative overflow-hidden main">
                                    <span class="new-label bg-danger text-white rounded-circle"> -29% </span>
                                    <img :src="isHovered ? '/build/images/home-shoes/pr-07.jpg' : imageUrl" alt="" class="img-fluid">
                                    <a href="#!" class="wishlistadd position-absolute" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o"></i></a>
                                    <a href="#!" class="compare_add position-absolute" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Compare">
                                        <i class="las la-sync"></i>
                                    </a>
                    ...
                    <div class="card rounded-0 mb-0 border-start-0">
                        <div class="card-body">
                            <div x-data="{ imageUrl: '/build/images/home-shoes/pr-01.jpg', isHovered: false }" class="topbar-product-card overlay-hover" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                                ...
                                <div class="mt-4">
                                    <h6 class="mb-1 fw-medium lh-base"><a href="{{ url('product/product-detail-layout-01')}}" class="main_link_red">Deluxe Brand Donna Star Scarpe</a></h6>
                                    <p class="mb-0 fs-14 text-muted">
                                        <span>$52.00</span>
                                    </p>
                                </div>
        ...
        <div class="row justify-content-between align-items-center py-2">
            <div class="col-auto">
                <div class="d-none d-md-flex align-items-center">
                    <div>
                        <img alt="" src="{{ URL::asset('/build/images/single-product/pickup-availability/thumb-sticky.jpg')}}" style="max-height: 75px; max-width: 65px; Width: auto; height: auto; vertical-align: middle;">
                    </div>
                    <div class="ms-2">
                        <h6 class="mb-1">Adidas Copa Primeknit Sneakers</h6>
                    </div>
                </div>
            </div>
            <div class="col-auto mt-2 mt-md-0">
                <div class="d-flex align-items-center gap-2">
                    <p class="text-danger mb-0 d-none d-md-flex" style="font-size: 16px;">$289.00</p>
                    <div class="input-step border">
                        <button type="button" class="minus material-shadow text-dark fw-bold">–</button>
                        <input type="number" class="product-quantity fw-bold fs-6" value="1" min="0" max="100">
                        <button type="button" class="plus material-shadow text-dark fw-bold">+</button>
                    </div>
                    <button data-bs-toggle="offcanvas" data-bs-target="#shoppingCartOffcanvas" aria-controls="shoppingCartOffcanvas" class="btn bg-danger-dark text-white text-uppercase rounded-0 min-w-150">
                        Add to Cart
                    </button>
