            ...
            <div class="d-flex justify-content-between align-items-center py-3">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 fs-13">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Mercury Tee</li>
                    </ol>
                </nav>
    ...
    <section class="py-4">
        <div class="container">
            <div class="row py-3">
                    ...
                    <div>
                            ...
                            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper productLg">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/products/pr-15.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/products/pr-16.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/products/thumb-05.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/products/thumb-06.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                </div>
                        ...
                        <div class="mt-3">
                            <div thumbsSlider="" class="swiper productSm">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/products/pr-15.jpg')}}" class="w-100 h-auto object-fit-contain" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/products/pr-16.jpg')}}" class="w-100 h-auto object-fit-contain" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/products/thumb-05.jpg')}}" class="w-100 h-auto object-fit-contain" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/products/thumb-06.jpg')}}" class="w-100 h-auto object-fit-contain" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 mt-5 mt-xl-0">
                    <h4 class="mb-3">Mercury Tee</h4>
                    <div class="d-flex flex-wrap justify-content-between">
                        <p class="text-muted fs-18 mb-4">$68.00</p>
                    ...
                    <div x-data="{ color: 'White Cream' }">
                        ...
                        <div class="product-color-list mt-2 gap-2 d-flex align-items-center">
                            <a href="#!" class="d-inline-block rounded-circle active square-xs" style="background: url('/build/images/products/dot-01.jpg') no-repeat center / cover; " data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="White Cream" x-on:click.prevent="color = 'White Cream'; $event.target.classList.add('active'); $event.target.nextElementSibling.classList.remove('active');">
                            </a>
                            <a href="#!" class="d-inline-block rounded-circle square-xs" style="background: url('/build/images/products/dot-02.jpg') no-repeat center / cover;" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="HEART DOTTED" x-on:click.prevent="color = 'HEART DOTTED'; $event.target.classList.add('active'); $event.target.previousElementSibling.classList.remove('active');">
                            </a>
                        </div>
                    </div>
                ...
                <div class="tab-pane fade show active" id="best-seller" role="tabpanel" aria-labelledby="best-seller-tab" tabindex="0">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <p class="cb">Typography is the work of<em> typesetters, compositors, typographers,
                                ...
                                <blockquote class="product-blockquote fs-13">
                                    <p class="mb-0">As the capability to create typography has become ubiquitous, the
                                ...
                                <p class="cb">Until the Digital Age, typography was a specialized occupation.
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <div class="text-center">
                                            <i class="pegk pe-7s-car fs-1 text-muted mb-3"></i>
                                    ...
                                    <div class="col-md-6">
                                        <div class="text-center">
                                            <i class="pegk pe-7s-help2 fs-1 text-muted mb-3"></i>
                                            <div class="info-box-content">
                                                <h5>SUPPORT 24/7</h5>
                                    ...
                                    <div class="col-md-6">
                                        <div class="text-center">
                                            <i class="pegk pe-7s-refresh fs-1 text-muted mb-3"></i>
                                            <div class="info-box-content">
                                    ...
                                    <div class="col-md-6">
                                        <div class="text-center">
                                            <i class="pegk pe-7s-door-lock fs-1 text-muted mb-3"></i>
                                            <div class="info-box-content">
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body border border-top-0 border-light">
                            <div class="container">
                                <div class="row align-items-center">
                                    <div class="col-md-6">
                                        <p class="cb">Typography is the work of<em> typesetters, compositors,
                                        ...
                                        <blockquote class="product-blockquote fs-13">
                                            <p class="mb-0">As the capability to create typography has become
            ...
            <div class="row justify-content-center">
                ...
                <div class="row g-lg-4 g-3">
                    <div class="col-md-4 col-lg-3 col-6">
                        <div x-data="{ imageUrl: '/build/images/products/pr-33.jpg' }" class="topbar-product-card pb-3">
                            ...
                            <div class="mt-3">
                                <h6 class="mb-1"><a href="{{ url('product/product-detail-layout-01')}}" class="product-title">City Backpack
                                        Black</a></h6>
                    ...
                    <div class="col-md-4 col-lg-3 col-6">
                        <div x-data="{ imageUrl: '/build/images/products/pr-s-49.jpg' }" class="topbar-product-card pb-3">
                            <div class="position-relative overflow-hidden">
                                <img :src="imageUrl" alt="" class="img-fluid">
                            ...
                            <div class="mt-3">
                                <h6 class="mb-1"><a href="{{ url('product/product-detail-layout-01')}}" class="product-title">Women Black
                                        Pants</a></h6>
                                <p class="mb-0 fs-14 text-muted">
                                    <del>$75.00</del>
                                ...
                                <div class="product-color-list mt-2 gap-2 d-flex align-items-center">
                                    <a href="#!" x-on:mouseover="imageUrl = '/build/images/products/pr-12.jpg'" x-on:click.prevent="imageUrl = '/build/images/products/pr-12.jpg'" class="d-inline-block bg-pink2 bg-opacity-50 rounded-circle"></a>
                                    <a href="#!" x-on:mouseover="imageUrl = '/build/images/products/pr-34.jpg'" x-on:click.prevent="imageUrl = '/build/images/products/pr-34.jpg'" class="d-inline-block bg-success bg-opacity-50 rounded-circle"></a>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-md-4 col-lg-3 col-6">
                        <div x-data="{ imageUrl: '/build/images/products/pr-12.jpg' }" class="topbar-product-card pb-3">
                            ...
                            <div class="mt-3">
                                <h6 class="mb-1"><a href="{{ url('product/product-detail-layout-01')}}" class="product-title">Men pants</a>
                                </h6>
                                <p class="mb-0 fs-14 text-muted">
        ...
        <div class="row justify-content-between align-items-center py-2">
            ...
            <div class="col-auto mt-2 mt-md-0">
                <div class="d-flex flex-wrap align-items-center gap-2">
                    <p class="text-danger fs-18 mb-0">$68.00</p>
