        ...
        <div class="container">
            <div class="row py-3 gx-xl-1">
                ...
                <div class="col-md-6 mt-5 mt-md-0">
                    ...
                    <div x-data="{ size: 'S', color: '#fff' }" class="pt-2">
                        ...
                        <div class="product-color-list size mt-2 gap-2 d-flex align-items-center">
                            <a href="#!" class="d-inline-block rounded-circle  d-flex align-items-center justify-content-center">
                            ...
                            <a href="#!" class="d-inline-block mx-2 rounded-circle d-flex align-items-center justify-content-center">
