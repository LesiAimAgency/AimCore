            ...
            <div class="d-flex justify-content-between align-items-center py-3">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 fs-13">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Felt Cowboy Hat</li>
                    </ol>
                </nav>
        ...
        <div class="container">
            <div class="row py-3 gx-xl-1">
                    ...
                    <div class="row g-2">
                            ...
                            <div thumbsSlider="" class="swiper productSmall">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/tab-accordion/thumb-01.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/tab-accordion/thumb-02.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/tab-accordion/thumb-03.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/tab-accordion/thumb-02.jpg')}}" class="object-fit-cover" />
                                    </div>
                        ...
                        <div class="col-xl-9 mt-3 order-1 order-xl-2">
                            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper productMain">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/tab-accordion/thumb-01.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/tab-accordion/thumb-02.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/tab-accordion/thumb-03.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/tab-accordion/thumb-02.jpg')}}" class="img-fluid w-100" />
                                    </div>
                ...
                <div class="col-md-6 mt-5 mt-md-0">
                    <h4 class="mb-3">Felt Cowboy Hat</h4>
                    <div class="d-flex flex-wrap justify-content-between">
                        <p class="text-muted fs-18 mb-4">$22.00
                        </p>
                    ...
                    <p class="text-muted"><span><i class="cd mr__5 fading_true fs__20 las la-fire me-1"></i></span>
                        <span class="text-black">25</span> sold in last <span class="text-black">21</span>
                        hours
                    </p>
                    <p class="text-muted">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-2 mt-4">
                        ...
                        <div class="product_wishlist square-40 rounded-circle border border-dark bg-transparent text-center d-flex justify-content-center align-items-center" style="line-height: 40px;">
                            <a href="#"><i class="facl facl-heart-o"></i></a>
                        </div>
                    </div>

                    <p class="text-black text-center mt-4"><span><i class="cd mr__5 fading_true fs__20 las la-hourglass-half"></i></span>
                        HURRY! ONLY <span class="text-danger">15</span> LEFT IN STOCK.
                    </p>
                    <div class="progress stock-progress mb-5" role="progressbar" aria-label="Animated striped example" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                        <div class="progress-bar progress-bar-striped progress-bar-animated" style="width: 75%"></div>
                    </div>

                    <div class="mt-4 d-flex justify-content-center">
                        <img src="{{ URL::asset('/build/images/single-product/cart_image.png')}}" alt="" class="img-fluid">
                    </div>
                    ...
                    <p class="text-black">
                        ...
                        <span class="border-bottom fw-medium">Friday, 29th January and Wednesday, 3rd
                            February</span>
                    </p>
                    <p class="text-black">
                        <i class="cd mr__5 fading_true fs__20 las la-eye"></i>
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body border border-top-0 border-light">
                            ...
                            <div class="row my-5 g-3">
                                <div class="col-md-6">
                                    <img src="{{ URL::asset('/build/images/single-product/tab-accordion/thumb-01.jpg')}}" class="img-fluid" alt="">
                                </div>
                                <div class="col-md-6">
                                    <img src="{{ URL::asset('/build/images/single-product/tab-accordion/thumb-02.jpg')}}" class="img-fluid" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center py-2">
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    <div>
                        <img alt="" src="{{ URL::asset('/build/images/single-product/tab-accordion/thumb-sticky.jpg')}}" style="max-height: 75px; max-width: 65px; Width: auto; height: auto; vertical-align: middle;">
                    </div>
                    <div class="ms-2">
                        <h6 class="mb-1">
                            Felt Cowboy Hat</h6>
            ...
            <div class="col-auto mt-2 mt-md-0">
                <div class="d-flex align-items-center gap-2">
                    <p class="text-muted fs-16 mb-0 d-none d-md-flex"><span class="text-danger ms-1">$20.00</span>
                    </p>
