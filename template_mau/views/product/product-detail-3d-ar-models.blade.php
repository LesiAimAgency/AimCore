...
<div>
            ...
            <div class="d-flex justify-content-between align-items-center py-3">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 fs-13">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Dance Bag Nylon</li>
                    </ol>
                </nav>
    ...
    <section class="py-4">
        <div class="container">
            <div class="row py-3 gx-xl-1">
                <div class="col-md-6">
                    <div class="row g-2">
                        <div class="col-xl-2 mt-xl-3 mt-2 order-2 order-xl-1 bag-swiper">
                            <div thumbsSlider="" class="swiper productSmall">
                                <div class="swiper-wrapper ">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/3d-ar-models/thumb-01.png')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/3d-ar-models/thumb-04.png')}}" class="object-fit-cover" />
                                        <i class="las la-cube"></i>
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/3d-ar-models/thumb-03.png')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/3d-ar-models/thumb-01.png')}}" class="object-fit-cover" />
                                    </div>
                            ...
                            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper productMain">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide" style="height: 500px;">
                                        <img src="{{ URL::asset('/build/images/single-product/3d-ar-models/thumb-01.png')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <model-viewer src="/build/images/single-product/3d-ar-models/dance-bag.glb" alt="A 3D model of a dance bag" camera-controls background-color="#f0f0f0" style="width: 100%; height: 500px;">
                                        </model-viewer>
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/3d-ar-models/thumb-03.png')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/3d-ar-models/thumb-01.png')}}" class="img-fluid w-100" />
                                    </div>
                ...
                <div class="col-md-6 mt-5 mt-md-0">
                    <h4 class="mb-3">Dance Bag Nylon</h4>
                    <div class="d-flex flex-wrap justify-content-between">
                        <p class="text-muted fs-18 mb-4">$18.00</p>
    ...
    <!-- tab -->
    <div class="mb-5 py-5 d-none d-lg-block main-project-section">
        <div class="container">
            ...
            <div class="tab-content mt-4" id="pills-tabContent">
                <div class="tab-pane fade show active" id="best-seller" role="tabpanel" aria-labelledby="best-seller-tab" tabindex="0">
                    ...
                    <div class="row align-items-center pt-5">
                        ...
                        <div class="col-md-6">
                            <img src="{{ URL::asset('/build/images/single-product/3d-ar-models/thumb-03.png')}}" class="img-fluid" alt="">
                        </div>
                        <div class="col-md-3">
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center py-2">
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    <div>
                        <img alt="" src="{{ URL::asset('/build/images/single-product/3d-ar-models/thumb-sticky.png')}}" style="max-height: 75px; max-width: 65px; Width: auto; height: auto; vertical-align: middle;">
                    </div>
                    <div class="ms-2">
                        <h6 class="mb-1">Dance Bag Nylon</h6>
                    </div>
                </div>
            </div>
            <div class="col-auto mt-2 mt-md-0">
                <div class="d-flex flex-wrap align-items-center gap-2">
                    <p class="text-danger fs-18 mb-0">$18.00</p>
