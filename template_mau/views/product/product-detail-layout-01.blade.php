    ...
    <section class="py-4">
        <div class="container">
            <div class="row py-3 gx-xl-4">
                                ...
                                <div class="swiper-wrapper product-container">
                                    ...
                                    <div class="swiper-slide product">
                                        <div class="thumbnail-container">
                                            <img class="drift-demo-trigger img-fluid w-100" data-zoom="./build/images/products/pr-04.jpg" src="{{ URL::asset('/build/images/products/pr-04.jpg')}}">
                                        </div>
                                    </div>
                                    <div class="swiper-slide product">
                                        <div class="thumbnail-container">
                                            <img class="drift-demo-trigger img-fluid w-100" data-zoom="./build/images/products/pr-05.jpg" src="{{ URL::asset('/build/images/products/pr-05.jpg')}}">
                                        </div>
                                    </div>
                                    <div class="swiper-slide product">
                                        <div class="thumbnail-container">
                                            <img class="drift-demo-trigger img-fluid w-100" data-zoom="./build/images/products/pr-31.jpg" src="{{ URL::asset('/build/images/products/pr-31.jpg')}}">
                                        </div>
                                    </div>
                                    <div class="swiper-slide product">
                                        <div class="thumbnail-container">
                                            <img class="drift-demo-trigger img-fluid w-100" data-zoom="./build/images/products/pr-42.jpg" src="{{ URL::asset('/build/images/products/pr-42.jpg')}}">
                                        </div>
                                    </div>
                                    <div class="swiper-slide product">
                                        <div class="thumbnail-container">
                                            <img class="drift-demo-trigger img-fluid w-100" data-zoom="./build/images/products/pr-43.jpg" src="{{ URL::asset('/build/images/products/pr-43.jpg')}}">
                                        </div>
                                    </div>
                                    <div class="swiper-slide product">
                                        <div class="thumbnail-container">
                                            <img class="drift-demo-trigger img-fluid w-100" data-zoom="./build/images/products/pr-32.jpg" src="{{ URL::asset('/build/images/products/pr-32.jpg')}}">
                                        </div>
                                    </div>
                                    <div class="swiper-slide product">
                                        <div class="thumbnail-container">
                                            <img class="drift-demo-trigger img-fluid w-100" data-zoom="./build/images/products/pr-44.jpg" src="{{ URL::asset('/build/images/products/pr-44.jpg')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-button-next"></div>
                ...
                <div class="col-md-6 mt-5 mt-md-0 product-details">
                    <div class="p_i_zoom">
...
<div class="position-fixed bottom-0 bg-body start-0 end-0 z-1 productCart d-none" style="box-shadow: 0 0 9px rgba(0, 0, 0, 0.12);">
    <div class="container">
        <div class="row d-md-flex justify-content-between align-items-center py-2">
            <div class="col-auto d-md-none w-100 ">
                <a href="#" class="text-teal text-decoration-underline fs-12 fw-semibold d-block text-center">Grey / S</a>
            </div>
            ...
            <div class="col-auto mt-2 mt-md-0">
                <div class="d-flex align-items-center gap-2 justify-content-center justify-md-content-end">
