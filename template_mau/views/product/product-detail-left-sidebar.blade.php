...
<div>
            ...
            <div class="d-flex justify-content-between align-items-center py-3">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 fs-13">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Men pants</li>
                    </ol>
                </nav>
    ...
    <section class="py-4">
        <div class="container">
            <div class="row py-3">
                <div class="col-lg-6 col-xl-3 order-3 order-xl-1 mt-5 mt-xl-0">
                    <div>
                        <h5 class="mb-5"><span class="widget-title">Shipping</span> & Delivery</h5>
                        <div>
                            <div class="d-flex gap-3 mb-3">
                                <div class="flex-shrink-0 fs-36">
                                    <i class="las la-truck align-top"></i>
                                </div>
                                <div class="flex-grow-1">
                                    <h6>FREE SHIPPING</h6>
                                    <p class="text-muted">Free shipping on all US order</p>
                                </div>
                            </div>
                            <div class="d-flex gap-3 mb-3">
                                <div class="flex-shrink-0 fs-36">
                                    <i class="las la-headset align-top"></i>
                                </div>
                                <div class="flex-grow-1">
                                    <h6>SUPPORT 24/7</h6>
                                    <p class="text-muted">Contact us 24 hours a day</p>
                                </div>
                            </div>
                            <div class="d-flex gap-3 mb-3">
                                <div class="flex-shrink-0 fs-36">
                                    <i class="las la-exchange-alt align-top"></i>
                                </div>
                                <div class="flex-grow-1">
                    ...
                    <div>
                        <h5 class="mb-4"><span class="widget-title">Instagram</h5>
                        <div>
                            <div class="row g-1">
                                <div class="col-4">
                                    <div>
                                        <a href="{{ url('index')}}" class="insta-card insta-icon d-block">
                                            <img src="{{ URL::asset('/build/images/instagram/ins1_1.jpg')}}" alt="" class="img-fluid">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div>
                                        <a href="{{ url('index')}}" class="insta-card insta-icon d-block">
                                            <img src="{{ URL::asset('/build/images/instagram/ins1_2.jpg')}}" alt="" class="img-fluid">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div>
                                        <a href="{{ url('index')}}" class="insta-card insta-icon d-block">
                                            <img src="{{ URL::asset('/build/images/instagram/ins1_4.jpg')}}" alt="" class="img-fluid">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div>
                                        <a href="{{ url('index')}}" class="insta-card insta-icon d-block">
                                            <img src="{{ URL::asset('/build/images/instagram/ins1_5.jpg')}}" alt="" class="img-fluid">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div>
                                        <a href="{{ url('index')}}" class="insta-card insta-icon d-block">
                                            <img src="{{ URL::asset('/build/images/instagram/ins1_6.jpg')}}" alt="" class="img-fluid">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div>
                                        <a href="{{ url('index')}}" class="insta-card insta-icon d-block">
                                            <img src="{{ URL::asset('/build/images/instagram/ins1_7.jpg')}}" alt="" class="img-fluid">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div>
                                        <a href="{{ url('index')}}" class="insta-card insta-icon d-block">
                                            <img src="{{ URL::asset('/build/images/instagram/ins1_8.jpg')}}" alt="" class="img-fluid">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div>
                                        <a href="{{ url('index')}}" class="insta-card insta-icon d-block">
                                            <img src="{{ URL::asset('/build/images/instagram/ins1_13.jpg')}}" alt="" class="img-fluid">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div>
                                        <a href="{{ url('index')}}" class="insta-card insta-icon d-block">
                                            <img src="{{ URL::asset('/build/images/instagram/ins1_14.jpg')}}" alt="" class="img-fluid">
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-6 col-xl-4 order-1 order-xl-2">
                    <div>
                        <div>
                            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper productLg">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/left-sidebar/thumb-01.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/left-sidebar/thumb-02.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/left-sidebar/thumb-03.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/left-sidebar/thumb-04.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/left-sidebar/thumb-05.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/left-sidebar/thumb-06.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                </div>
                        ...
                        <div class="mt-3">
                            <div thumbsSlider="" class="swiper productSm">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/left-sidebar/thumb-01.jpg')}}" class="w-100 h-auto object-fit-contain" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/left-sidebar/thumb-02.jpg')}}" class="w-100 h-auto object-fit-contain" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/left-sidebar/thumb-03.jpg')}}" class="w-100 h-auto object-fit-contain" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/left-sidebar/thumb-04.jpg')}}" class="w-100 h-auto object-fit-contain" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/left-sidebar/thumb-05.jpg')}}" class="w-100 h-auto object-fit-contain" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/left-sidebar/thumb-06.jpg')}}" class="w-100 h-auto object-fit-contain" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 col-xl-5 mt-5 mt-xl-0 order-2 order-xl-3">
                    <h4 class="mb-3">Men pants</h4>
                    <div class="d-flex flex-wrap justify-content-between">
                        <p class="text-muted fs-18 mb-4">$56.00</p>
                    ...
                    <div x-data="{ color: 'Blue' }">
                        ...
                        <div class="product-color-list mt-2 gap-2 d-flex align-items-center">
                            <a href="#!" class="bg-blue-dark bg-opacity-50 d-inline-block rounded-circle active square-xs" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Blue" x-on:click.prevent="color = 'Blue'; $event.target.classList.add('active'); $event.target.nextElementSibling.classList.remove('active');">
                            </a>
                            <a href="#!" class="bg-black d-inline-block rounded-circle square-xs" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Black" x-on:click.prevent="color = 'Black'; $event.target.classList.add('active'); $event.target.previousElementSibling.classList.remove('active');">
                            </a>
                        </div>
                    </div>
            ...
            <div class="tab-content mt-5" id="pills-tabContent">
                <div class="tab-pane fade show active" id="best-seller" role="tabpanel" aria-labelledby="best-seller-tab" tabindex="0">
                    ...
                    <div class="row my-5 g-0">
                        <div class="col-md-4">
                            <img src="{{ URL::asset('/build/images/single-product/left-sidebar/thumb-03.jpg')}}" class="w-100 h-auto" alt="">
                        </div>
                        <div class="col-md-4">
                            <img src="{{ URL::asset('/build/images/single-product/left-sidebar/thumb-01.jpg')}}" class="w-100 h-auto" alt="">
                        </div>
                        <div class="col-md-4">
                            <img src="{{ URL::asset('/build/images/single-product/left-sidebar/thumb-06.jpg')}}" class="w-100 h-auto" alt="">
                        </div>
                    </div>
                    <div class="container">
                    ...
                    <div class="container">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <div class="d-flex mt-3 mt-sm-0">
                                ...
                                <a href="#!" class="text-muted py-1 px-2 sub-gray">Short by:
                                    Latest
                                    <span><img src="{{ URL::asset('/build/images/single-product/icon-down.svg')}}" alt=""></span></a>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center pt-5">
                                    <div class="col-md-3">
                                        ...
                                        <div class="text-center text-md-end d-md-flex flex-md-row-reverse align-items-center justify-md-content-end mb-5">
                                            ...
                                            <p class="me-2 mb-0 text-muted text-md-end">Corrosion Resistance<br>to Sea
                                                water</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
    ...
    <section class="pt-5 py-lg-5 mb-3">
        <div class="container">
            <div class="row justify-content-center">
                ...
                @include('partials.product-like-card')<!--end row-->
            </div>

            <div class="container">
                <div class="row justify-content-center mt-0 mt-xl-5 pt-2">
                    <div class="col-lg-7">
                ...
                <div class="row g-lg-4 g-3 mt-4 mt-lg-0">
                        ...
                        <div x-data="{ imageUrl: '/build/images/products/pr-50.jpg' }" class="topbar-product-card pb-3">
                            <div class="position-relative overflow-hidden">
                                ...
                                <div class="product-button d-flex flex-column gap-2">
                                    ...
                                    <a href="#cardModal" data-bs-toggle="modal" class="btn rounded-pill fs-14"><span>Quick
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center py-2">
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    <div>
                        <img alt="" src="{{ URL::asset('/build/images/products/dot-01.jpg')}}" style="max-height: 75px; max-width: 65px; Width: auto; height: auto; vertical-align: middle;">
                    </div>
                    <div class="ms-2">
                        <h6 class="mb-1">Men pants</h6>
                        <a href="#" class="text-teal text-decoration-underline fs-12 fw-semibold">White Cream / S</a>
                    </div>
                </div>
            </div>
            <div class="col-auto mt-2 mt-md-0">
                <div class="d-flex align-items-center gap-2">
                    <p class="text-danger fs-18 mb-0 d-none d-md-flex">$56.00</p>
