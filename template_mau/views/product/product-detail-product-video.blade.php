        ...
        <div class="container">
            <div class="row py-3 gx-xl-1">
                    ...
                    <div class="row g-2">
                            ...
                            <div thumbsSlider="" class="swiper productSmall">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/product-video/thumb-01.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/product-video/thumb-02.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <i class="las la-play"></i>
                                        <img src="{{ URL::asset('/build/images/single-product/product-video/thumb-03.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <i class="lab la-youtube"></i>
                                        <img src="{{ URL::asset('/build/images/shop/collection-list/cat-01.jpg')}}" class="object-fit-cover" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-9 mt-3 order-1 order-xl-2">
                            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper productMain">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/product-video/thumb-01.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/product-video/thumb-02.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <video controls autoplay loop name="media" style="width: 100%;" id="videoPlayer">
                                            <source src="http://localhost:3000build/images/video.mp4" type="video/mp4">
                                        </video>
                                                                           </div>
                                    <div class="swiper-slide">
                                        <div class="iframe-container" style="width:100%; height: 500px">
                                            <!-- <iframe frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="allowfullscreen" class="media-video pa t__0 l__0 w__100 h__100" src="https://www.youtube.com/embed/dvW81bvexh8?controls=1&amp;enablejsapi=1&amp;modestbranding=1&amp;playsinline=1&amp;rel=0" title="Chloe | Spring Summer 2019 Full Fashion Show | Exclusive" id="widget2"></iframe> -->

                                            <iframe width="560"  src="https://www.youtube.com/embed/X4t0JxiBeO0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" loading="lazy" allowfullscreen></iframe>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-md-6 mt-5 mt-md-0">
                    <h4 class="mb-3">Jersey Puff Sleeve</h4>
                    ...
                    <div x-data="{ size: 'M', color: '#fff' }" class="pt-2 mb-4 pb-3">
                        <h6 class="text-uppercase fw-bold my-3">Size: <span x-text="size"></span></h6>
            ...
            <div class="tab-content mt-5" id="pills-tabContent">
                <div class="tab-pane fade show active" id="best-seller" role="tabpanel" aria-labelledby="best-seller-tab" tabindex="0">
                    ...
                    <div class="row my-5 g-3">
                        <div class="col-md-4">
                            <img src="{{ URL::asset('/build/images/single-product/product-video/des-01.jpg')}}" class="img-fluid" alt="">
                        </div>
                        <div class="col-md-4">
                            <img src="{{ URL::asset('/build/images/single-product/product-video/des-02.jpg')}}" class="img-fluid" alt="">
                        </div>
                        <div class="col-md-4">
                            <img src="{{ URL::asset('/build/images/single-product/product-video/des-03.jpg')}}" class="img-fluid" alt="">
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center py-2">
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    <div>
                        <img alt="" src="{{ URL::asset('/build/images/single-product/product-video/thumb-sticky.jpg')}}" style="max-height: 75px; max-width: 65px; Width: auto; height: auto; vertical-align: middle;">
                    </div>
                    <div class="ms-2">
                        <h6 class="mb-1">Jersey Puff Sleeve</h6>
                        <a href="#" class="text-teal text-decoration-underline fs-12 fw-semibold">Wheat</a>
                    </div>
                </div>
            </div>
            <div class="col-auto mt-2 mt-md-0">
                <div class="d-flex align-items-center gap-2">
                    <p class="text-danger fs-18 mb-0 d-none d-md-flex">$18.00</p>
