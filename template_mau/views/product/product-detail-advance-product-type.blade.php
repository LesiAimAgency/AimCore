        ...
        <div class="container">
            <div class="row py-3 gx-xl-1">
                    ...
                    <div class="row g-2">
                            ...
                            <div thumbsSlider="" class="swiper productSmall">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/advance-product-type/full-size-01.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/advance-product-type/full-size-02.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/advance-product-type/full-size-03.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/advance-product-type/full-size-04.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/advance-product-type/full-size-02.jpg')}}" class="object-fit-cover" />
                                    </div>
                        ...
                        <div class="col-xl-9 mt-3 order-1 order-xl-2">
                            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper productMain">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/advance-product-type/full-size-01.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/advance-product-type/full-size-02.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/advance-product-type/full-size-03.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/advance-product-type/full-size-04.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/advance-product-type/full-size-03.jpg')}}" class="img-fluid w-100" />
                                    </div>
                ...
                <div class="col-md-6 mt-5 mt-md-0">
                    ...
                    <h6 class="text-uppercase fw-bold mt-3">CHOOSE STYLE:</h6>
                    <div class="row">
                        <div class=" col-sm-8">
                            <div class="row g-2">
                                <div class="col-4">
                                    <div class="p-1 product-advance-card rounded">
                                        <img src="{{ URL::asset('/build/images/single-product/advance-product-type/advance-type-01.jpg')}}" class="img-fluid w-100" style="height: 120px;" alt="">
                                        <p class="text-black text-center my-1">Tank</p>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="p-1 product-advance-card advance-card1 rounded">
                                        <img src="{{ URL::asset('/build/images/single-product/advance-product-type/advance-type-03.jpg')}}" class="img-fluid w-100" style="height: 120px;" alt="">
                                        <p class="text-black text-center my-1">Hoodie</p>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="p-1 product-advance-card advance-card1 rounded">
                                        <img src="{{ URL::asset('/build/images/single-product/advance-product-type/advance-type-05.jpg')}}" class="img-fluid w-100" style="height: 120px;" alt="">
                                        <p class="text-black text-center my-1">Long Sleeve</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div x-data="{ size: 'white', color: '#fff' }" class="pt-2">
                        <h6 class="text-uppercase fw-bold mt-3">Color: <span x-text="size"></span></h6>
                        <div class="product-color-list size mt-2 gap-2 d-flex align-items-center">
                            <a href="#!" class="d-inline-block rounded-circle px-4 square-xs d-flex align-items-center justify-content-center" :class="{ 'active': size === 'blue' }" x-on:click.prevent="size = 'blue';" style="border-radius: 30px !important; ">Blue</a>
                            <a href="#!" class="d-inline-block rounded-circle px-4 square-xs d-flex align-items-center justify-content-center" :class="{ 'active': size === 'white' }" x-on:click.prevent="size = 'white';" style="border-radius: 30px !important; ">White</a>
                            <a href="#!" class="d-inline-block rounded-circle px-4 square-xs d-flex align-items-center justify-content-center" :class="{ 'active': size === 'black' }" x-on:click.prevent="size = 'black';" style="border-radius: 30px !important; ">Black</a>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center py-2">
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    <div>
                        <img alt="" src="{{ URL::asset('/build/images/single-product/advance-product-type/thumb-sticky.jpg')}}" style="max-height: 75px; max-width: 65px; Width: auto; height: auto; vertical-align: middle;">
                    </div>
                    <div class="ms-2">
                        <h6 class="mb-1"> Blue Jean</h6>
                        <a href="#" class="text-teal text-decoration-underline fs-12 fw-semibold">Blue / S</a>
                    </div>
                </div>
            </div>
            <div class="col-auto mt-2 mt-md-0">
                <div class="d-flex align-items-center gap-2">
                    <p class="text-danger d-none d-md-flex fs-16 mb-0">$25.00</p>
