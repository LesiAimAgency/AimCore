        ...
        <div class="container">
            <div class="row py-3 gx-xl-1">
                ...
                <div class="col-md-6 mt-5 mt-md-0">
                    ...
                    <div class="custome-radio" x-data="{ colors: 'Grey' }">
                        <h6 class="text-uppercase fw-bold mb-3">Color: <span x-text="colors"></span></h6>
                        <div class="image_radio_button_control">
                            <label class="radio-button-label" :class="{ 'active': colors === 'Grey' }">
                                <input type="radio" name="radio-control" value="Grey" x-model="colors">
                                <img src="{{ URL::asset('/build/images/swatch-color/option-grey.jpg')}}">
                            </label>
                            <label class="radio-button-label" :class="{ 'active': colors === 'Pink' }">
                                <input type="radio" name="radio-control" value="Pink" x-model="colors">
                                <img src="{{ URL::asset('/build/images/swatch-color/option-pink.jpg')}}">
                            </label>
                            <label class="radio-button-label" :class="{ 'active': colors === 'Black' }" checked>
                                <input type="radio" name="radio-control" value="Black" x-model="colors">
                                <img src="{{ URL::asset('/build/images/swatch-color/option-black.jpg')}}">
                            </label>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="tab-content mt-5" id="pills-tabContent">
                <div class="tab-pane fade show active" id="best-seller" role="tabpanel" aria-labelledby="best-seller-tab" tabindex="0">
                    <div class="row pt-3">
                        <div class="col-lg-6">
                            <h5 class="fw-semibold text-center mb-3">FIGHTING FIT</h5>
                        ...
                        <div class="col-lg-6">
                            <h5 class="fw-semibold text-center mb-3">FIND YOUR SIZE</h5>
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th scope="col" class="bg-transparent fw-medium">SIZE</th>
                                        <th scope="col" class="bg-transparent fw-medium">CHEST</th>
                                        <th scope="col" class="bg-transparent fw-medium">WAIST</th>
                                        <th scope="col" class="bg-transparent fw-medium">HIPS</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <th class="bg-transparent fw-medium" scope="row">S</th>
                                        <td class="bg-transparent">39</td>
                                        <td class="bg-transparent">31</td>
                                        <td class="bg-transparent">35</td>
                                    </tr>
                                    <tr>
                                        <th class="bg-transparent fw-medium" scope="row">M</th>
                                        <td class="bg-transparent">41</td>
                                        <td class="bg-transparent">44</td>
                                        <td class="bg-transparent">37</td>
                                    </tr>
                                    <tr>
                                        <th class="bg-transparent fw-medium" scope="row">L</th>
                                        <td class="bg-transparent">43</td>
                                        <td class="bg-transparent">35</td>
                                        <td class="bg-transparent">39</td>
                                    </tr>
                                    <tr>
                                        <th class="bg-transparent fw-medium" scope="row">XL</th>
                                        <td class="bg-transparent">45</td>
                                        <td class="bg-transparent">37</td>
                                        <td class="bg-transparent">41</td>
                                    </tr>
                                    <tr>
                                        <th class="bg-transparent fw-medium" scope="row">XXL</th>
                                        <td class="bg-transparent">47</td>
                                        <td class="bg-transparent">39</td>
                                        <td class="bg-transparent">43</td>
                                    </tr>
                                </tbody>
