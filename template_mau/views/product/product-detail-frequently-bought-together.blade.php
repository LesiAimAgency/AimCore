        ...
        <div class="container">
            <div class="row py-3 gx-xl-1">
                    ...
                    <div class="row g-2">
                            ...
                            <div thumbsSlider="" class="swiper productSmall">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/layout-02/full-size-01.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/layout-02/thumb-02.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/layout-02/thumb-03.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/layout-02/thumb-04.jpg')}}" class="object-fit-cover" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/layout-02/thumb-02.jpg')}}" class="object-fit-cover" />
                                    </div>
                        ...
                        <div class="col-xl-9 mt-3 order-1 order-xl-2">
                            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper productMain">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/layout-02/full-size-01.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/layout-02/thumb-02.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/layout-02/thumb-03.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/layout-02/thumb-04.jpg')}}" class="img-fluid w-100" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ URL::asset('/build/images/single-product/layout-02/thumb-02.jpg')}}" class="img-fluid w-100" />
                                    </div>
                ...
                <div class="col-md-6 mt-5 mt-md-0">
                    <h4 class="mb-3">Striped Long Sleeve Top</h4>
                    <div class="d-flex flex-wrap justify-content-between">
                        <p class="text-muted fs-18 mb-4"><del>$45.00</del> <span class="text-danger">$20.00</span></p>
            ...
            <div class="tab-content mt-5" id="pills-tabContent">
                <div class="tab-pane fade show active" id="best-seller" role="tabpanel" aria-labelledby="best-seller-tab" tabindex="0">
                    ...
                    <div class="row my-5 g-3">
                        <div class="col-md-4">
                            <img src="{{ URL::asset('/build/images/single-product/layout-02/full-size-01.jpg')}}" class="img-fluid" alt="">
                        </div>
                        <div class="col-md-4">
                            <img src="{{ URL::asset('/build/images/single-product/layout-02/full-size-03.jpg')}}" class="img-fluid" alt="">
                        </div>
                        <div class="col-md-4">
                            <img src="{{ URL::asset('/build/images/single-product/layout-02/full-size-02.jpg')}}" class="img-fluid" alt="">
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center py-2">
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    <div>
                        <img alt="" src="{{ URL::asset('/build/images/single-product/layout-02/thumb-sticky.jpg')}}" style="max-height: 75px; max-width: 65px; Width: auto; height: auto; vertical-align: middle;">
                    </div>
                    <div class="ms-2">
            ...
            <div class="col-auto mt-2 mt-md-0">
                <div class="d-flex flex-wrap align-items-center gap-2">
                    <p class="text-muted fs-16 mb-0"><del>$45.00</del><span class="text-danger ms-1">$20.00</span></p>
