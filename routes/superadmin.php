...
Route::middleware([
    ...
    Route::get('my-tasks/completed', [MyTaskController::class, 'completed'])->name('my-tasks.completed');
    Route::post('my-tasks/reorder', [MyTaskController::class, 'reorder'])->name('my-tasks.reorder');
    Route::patch('my-tasks/{task}/complete', [MyTaskController::class, 'complete'])->name('my-tasks.complete');
    Route::patch('my-tasks/{task}/approve-gold', [MyTaskController::class, 'approveGold'])->name('my-tasks.approve-gold');
    Route::patch('my-tasks/{task}/restore', [MyTaskController::class, 'restore'])->name('my-tasks.restore');
    Route::patch('my-tasks/{task}/approve', [MyTaskController::class, 'approve'])->name('my-tasks.approve');
    Route::patch('my-tasks/{task}/reject-approval', [MyTaskController::class, 'rejectApproval'])->name('my-tasks.reject-approval');
    Route::patch('my-tasks/{task}/accept', [MyTaskController::class, 'accept'])->name('my-tasks.accept');
    Route::patch('my-tasks/{task}/decline', [MyTaskController::class, 'decline'])->name('my-tasks.decline');
    Route::patch('my-tasks/{task}/reassign', [MyTaskController::class, 'reassign'])->name('my-tasks.reassign');
    ...
    Route::get('projects/{project}/deploy-logs', [ProjectController::class, 'getDeployLogs'])->name('projects.deploy-logs');
