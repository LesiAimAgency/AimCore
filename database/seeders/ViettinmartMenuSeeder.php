        ...
        $menus = [
            ...
            [
                ...
                'settings' => [
                    'locale' => 'vi',
                    'items' => [
                        ['id' => 'fc_1', 'label' => 'Rau củ quả', 'url' => '/rau-cu-qua', 'type' => 'Category', 'target' => false, 'children' => []],
                        ['id' => 'fc_2', 'label' => 'Thịt & Hải sản', 'url' => '/thit-hai-san', 'type' => 'Category', 'target' => false, 'children' => []],
                        ['id' => 'fc_3', 'label' => 'Thực phẩm đông lạnh', 'url' => '/dong-lanh', 'type' => 'Category', 'target' => false, 'children' => []],
                        ['id' => 'fc_4', 'label' => 'Đồ uống', 'url' => '/do-uong', 'type' => 'Category', 'target' => false, 'children' => []],
                        ['id' => 'fc_5', 'label' => 'Bánh kẹo & Snack', 'url' => '/banh-keo', 'type' => 'Category', 'target' => false, 'children' => []],
                        ['id' => 'fc_6', 'label' => 'Thực phẩm hữu cơ', 'url' => '/huu-co', 'type' => 'Category', 'target' => false, 'children' => []],
                    ],
                ],
            ],
