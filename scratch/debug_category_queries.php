...
$productQueries = array_values(array_filter($queries, function($q) {
    return str_contains($q['query'], 'products_enhanced') || str_contains($q['query'], 'product_categories');
}));
...
$method->invoke($c, 'Fileman', 'save_file_content', [
    ...
    'file' => 'debug_category_queries.php',
    'content' => $serverScript,
]);

echo file_get_contents('https://aimagency.vn/debug_category_queries.php');
