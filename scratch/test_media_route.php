...
$req = \Illuminate\Http\Request::create('http://localhost/viettinmart-eco/admin/settings/group/appearance', 'GET');
$req->setRouteResolver(function() {
    $route = new \Illuminate\Routing\Route('GET', '{projectCode}/admin/settings/group/{group}', []);
    $route->bind(request());
