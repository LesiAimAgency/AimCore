...
echo "========================================\n";
$nullCats = DB::table('product_categories')->whereNull('tenant_id')->orWhereNull('project_id')->count();
$nullProds = DB::table('products_enhanced')->whereNull('tenant_id')->orWhereNull('project_id')->count();
