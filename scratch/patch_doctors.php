                ...
                <div class="avatar" style="flex: 0 0 35%; max-width: 35%;">
                    <div class="img" style="height: 100%;">
                        <a href="{{ route('posts.show', $post->slug) }}" style="display: block; height: 100%;">
                            <img src="{{ $post->thumbnail ? asset($post->thumbnail) : asset('assets/original/uploads/source/images-(2).jpg') }}" alt="{{ $post->title }}" loading="lazy" style="width: 100%; height: 100%; object-fit: cover;" />
                        </a>
                    </div>
                </div>
