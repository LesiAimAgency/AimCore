...
document.addEventListener("DOMContentLoaded", () => {
  ...
  mm.add("(min-width: 1024px)", () => {
    ...
    const wallSec = document.getElementById("community-wall");
    const communitySec = document.getElementById("community");

    // SECTION 1: #community-wall
    if (wallSec) {
      ...
      // Curated 3D parallax drift vectors for the 10 floating collage cards
      const driftVectors = [
        { x: -90, y: -60, r: -4, s: 0.9 },
        { x: -50, y: -90, r: 3, s: 0.88 },
        { x: -60, y: 70, r: -3, s: 0.9 },
        { x: 50, y: -70, r: 3, s: 0.88 },
        { x: 40, y: 80, r: -3, s: 0.9 },
        { x: 80, y: 50, r: 3, s: 0.9 },
        { x: 90, y: -70, r: -3, s: 0.88 },
        { x: 100, y: 40, r: 3, s: 0.9 },
        { x: -70, y: 60, r: -3, s: 0.9 },
        { x: -100, y: 70, r: 3, s: 0.88 }
      ];

      wallCards.forEach((card, idx) => {
        const drift = driftVectors[idx % driftVectors.length];
        wallTL.to(card, {
          x: drift.x,
          y: drift.y,
          rotation: drift.r,
    ...
    if (communitySec) {
      ...
      gsap.set(["#sec2-title-top", "#sec2-logo", "#sec2-title-bot", "#sec2-subtitle", "#sec2-ctas", "#sec2-card-1", "#sec2-card-3", "#sec2-card-2", "#sec2-card-4"], {
        opacity: 0
      });

      // 1. Center statement reveals ("THE COMMUNITY" + logo + "CREATING")
      ...
      // 2. 4 Cards reveal in requested priority sequence:
      // Priority 1: Top Left (#sec2-card-1)
      commTL.fromTo("#sec2-card-1",
        { opacity: 0, y: 40, scale: 0.94 },
        { opacity: 1, y: 0, scale: 1.0, duration: 0.2, ease: "power2.out" },
        0.25
      );

      // Priority 2: Top Right (#sec2-card-3)
      ...
      // Priority 3: Bottom Left (#sec2-card-2)
      ...
      // Priority 4: Bottom Right (#sec2-card-4)
  ...
  mm.add("(max-width: 1023px)", () => {
    ...
    // Section 1 (#community-wall) Mobile Scroll
    if (document.getElementById("community-wall") && centerLogo) {
      ...
      wallTLMobile.to(centerLogo, {
        scale: 1.05,
        duration: 0.6
      }, 0.3);
    }

    // Section 2 (#community) Mobile Scroll (Natural vertical flow)
    const communitySec = document.getElementById("community");
    if (communitySec) {
      gsap.fromTo(["#sec2-title-top", "#sec2-logo", "#sec2-title-bot", "#sec2-subtitle", "#sec2-ctas"],
        { opacity: 0, y: 25 },
        {
          opacity: 1,
          y: 0,
  ...
  mm.add("(prefers-reduced-motion: reduce)", () => {
    gsap.set(["#wall-center-logo", "#community-wall .floating-card", "#sec2-card-1", "#sec2-card-2", "#sec2-card-3", "#sec2-card-4", "#sec2-title-top", "#sec2-logo", "#sec2-title-bot", "#sec2-subtitle", "#sec2-ctas"], {
      clearProps: "all",
      opacity: 1,
      visibility: "visible",
      transform: "none",
  ...
  if (founderSec) {
    ...
    founderTL.fromTo("#founder-mission-slogan",
      { opacity: 0, y: 35 },
      { opacity: 1, y: 0, duration: 0.8, ease: "power2.out" },
      0.4
    );
  ...
  if (footerSec) {
    ...
    footerTL.fromTo("#brand-statement-banner h1, #brand-statement-banner h2",
      { opacity: 0, y: 45 },
