...
@section('title', 'Dữ liệu Khách hàng | Super Admin')
@section('page-title', 'Dữ liệu Khách hàng')
...
<div class="px-1 sm:px-6 py-3 sm:py-8 w-full max-w-7xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-6 gap-3 sm:gap-4">
        <div>
            <h1 class="text-xl sm:text-3xl font-bold text-[#001B4E]">Danh sách Hợp đồng</h1>
            <p class="text-gray-500 text-xs sm:text-sm mt-0.5 sm:mt-1">Quản lý và theo dõi hợp đồng theo nhóm dịch vụ</p>
        </div>
        <div>
            <a href="{{ route('superadmin.contracts.create') }}" class="w-full sm:w-auto justify-center px-4 sm:px-6 py-2 sm:py-2.5 bg-[#001B4E] text-white rounded-lg hover:bg-[#002D80] font-medium inline-flex items-center transition-colors shadow-xs text-xs sm:text-sm">
    ...
    <div class="fixed inset-0 z-10 overflow-y-auto">
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <div class="relative transform overflow-hidden rounded-xl bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-4xl">
                ...
                <!-- Footer -->
                <div class="bg-white px-4 py-3 sm:flex sm:flex-row-reverse sm:justify-between sm:px-6 border-t border-gray-100">
                    ...
                    <div class="mt-3 sm:mt-0 flex items-center justify-center sm:justify-start">
                        <span class="text-sm font-medium text-gray-500 mr-3 hidden sm:inline-block">Xuất Word:</span>
                        <div class="flex rounded-md shadow-sm" role="group">
                            <a href="#" id="modal-btn-export-hdnt" class="px-3 py-2 text-sm font-medium text-blue-700 bg-blue-100 border border-blue-200 rounded-l-lg hover:bg-blue-200 hover:text-blue-800 transition-colors" title="Hợp đồng Nguyên tắc">
                                HĐNT
                            </a>
                            <a href="#" id="modal-btn-export-hddvtk" class="px-3 py-2 text-sm font-medium text-blue-700 bg-blue-100 border-t border-b border-r border-blue-200 hover:bg-blue-200 hover:text-blue-800 transition-colors" title="Hợp đồng Dịch vụ Thiết kế">
                                HĐDVTK
                            </a>
                            <a href="#" id="modal-btn-export-bbnt" class="px-3 py-2 text-sm font-medium text-blue-700 bg-blue-100 border-t border-b border-r border-blue-200 hover:bg-blue-200 hover:text-blue-800 transition-colors" title="Biên bản Nghiệm thu">
                                BBNT
                            </a>
                            <a href="#" id="modal-btn-export-dntt" class="px-3 py-2 text-sm font-medium text-blue-700 bg-blue-100 border-t border-b border-r border-blue-200 rounded-r-lg hover:bg-blue-200 hover:text-blue-800 transition-colors" title="Đề nghị Thanh toán">
                                ĐNTT
                            </a>
                        </div>
                    </div>
...
<script>
    function openContractModal(id) {
        ...
        // Cập nhật link xuất Word
        document.getElementById('modal-btn-export-hdnt').href = "/superadmin/contracts/" + id + "/export/hdnt";
        document.getElementById('modal-btn-export-hddvtk').href = "/superadmin/contracts/" + id + "/export/hddvtk";
        document.getElementById('modal-btn-export-bbnt').href = "/superadmin/contracts/" + id + "/export/bbnt";
        document.getElementById('modal-btn-export-dntt').href = "/superadmin/contracts/" + id + "/export/dntt";
