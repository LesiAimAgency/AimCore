                ...
                <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <x-form.input name="client_name" :value="old('client_name')" required="true" placeholder="Tên cá nhân/công ty" />
                        </div>

                        <div>
                            <x-form.label value="Tên người đại diện" />
                            <x-form.input name="representative_name" :value="old('representative_name')" placeholder="Người đứng tên HĐ..." />
                        </div>

                        <div>
                            <x-form.label value="Chức vụ" />
                            <x-form.input name="representative_title" :value="old('representative_title')" placeholder="Giám đốc..." />
                        </div>

                        <div>
                            <x-form.label value="Số điện thoại" />
                            <x-form.input name="client_phone" :value="old('client_phone')" placeholder="09xxxxxxx" />
                        </div>

                        <div>
                            <x-form.label value="Địa chỉ" />
                            <x-form.input name="client_address" :value="old('client_address')" placeholder="Địa chỉ thường trú/trụ sở..." />
                        </div>

                        <div>
                            <x-form.label value="Mã số thuế" />
                            <x-form.input name="tax_code" :value="old('tax_code')" placeholder="MST công ty nếu có..." />
                        </div>
