...
<div class="px-1 sm:px-6 py-3 sm:py-8 w-full max-w-7xl mx-auto">
    <div class="mb-4 sm:mb-6">
        <a href="{{ route('superadmin.briefs.index') }}" class="text-gray-500 hover:text-[#001B4E] inline-flex items-center transition-colors text-xs sm:text-sm">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div class="lg:col-span-2 space-y-4 sm:space-y-6">
            <form action="{{ route('superadmin.briefs.update', $brief->id) }}" method="POST" id="edit-form">
                ...
                <!-- Basic Info Card -->
                <div class="bg-white rounded-xl shadow-xs p-4 sm:p-6 border border-gray-100 mb-6">
