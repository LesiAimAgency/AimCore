...
<head>
    ...
    <title>@yield('code') - @yield('title') | {{ get_setting('site_name', 'WKcomputer') }}</title>
...
<body>
    ...
    <div class="error-card">
        ...
        <a href="{{ url('/wkcomputer') }}" class="btn-home">
            Quay về trang chủ
        </a>
    </div>
    ...
    <div style="position: fixed; bottom: 30px; text-align: center; width: 100%;">
        <p style="font-size: 10px; font-weight: 800; color: #cbd5e1; text-transform: uppercase; letter-spacing: 0.3em;">
            &copy; {{ date('Y') }} {{ get_setting('site_name', 'WKcomputer') }} - Ultimate Reliability
        </p>
    </div>
</body>
</html>
