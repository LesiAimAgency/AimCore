    ...
    <aside id="sidebar" class="custom-scroll">
        ...
        <nav class="flex-1 py-2">
            ...
            <div x-show="open==='shop'" x-cloak x-collapse class="sub-menu">
                <a href="{{ route('admin.products.index', ['locale' => 'vi']) }}" class="sub-item {{ request()->routeIs('admin.products.index') ? 'active' : '' }}"><span class="dot"></span> Danh sách</a>
                @if(auth()->user()->isAdmin() || auth()->user()->isManager() || auth()->user()->isWebAdmin())
                <a href="{{ route('admin.products.create') }}" class="sub-item {{ request()->routeIs('admin.products.create') ? 'active' : '' }}"><span class="dot"></span> Thêm mới</a>
                <a href="{{ route('admin.categories.index', ['type' => 'product']) }}" class="sub-item {{ request()->routeIs('admin.categories.*') && request()->get('type','product') === 'product' ? 'active' : '' }}"><span class="dot"></span> Chuyên mục</a>
                <a href="{{ route('admin.attributes.index') }}" class="sub-item {{ request()->routeIs('admin.attributes.*') ? 'active' : '' }}"><span class="dot"></span> Thuộc tính</a>
                @endif
            </div>
            @endif
            ...
            <a href="{{ route('admin.flash-sales.index') }}" class="nav-item {{ request()->routeIs('admin.flash-sales.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.form-submissions.overview') }}" class="nav-item {{ request()->routeIs('admin.form-submissions.*') ? 'active' : '' }}">
                <span class="nav-icon"><i class="fa-solid fa-envelope-open-text"></i></span>
                Khách liên hệ
                @if(isset($newSubmissionsCount) && $newSubmissionsCount > 0)
                <span style="background:#dc2626;color:#fff;font-size:10px;font-weight:700;padding:2px 6px;border-radius:10px;margin-left:auto;">{{ $newSubmissionsCount }}</span>
                @endif
            </a>
            @endif --}}
            ...
            <div x-show="open==='content'" x-cloak x-collapse class="sub-menu">
                <a href="{{ route('admin.posts.index') }}" class="sub-item {{ request()->routeIs('admin.posts.*') ? 'active' : '' }}"><span class="dot"></span> Blog</a>
                <a href="{{ route('admin.pages.index') }}" class="sub-item {{ request()->routeIs('admin.pages.*') ? 'active' : '' }}"><span class="dot"></span> Trang tĩnh</a>
                @if(auth()->user()->canAccess('form-templates'))
                <a href="{{ route('admin.form-templates.index') }}" class="sub-item {{ request()->routeIs('admin.form-templates.*') ? 'active' : '' }}"><span class="dot"></span> Form Templates</a>
                @endif
                <a href="{{ route('admin.categories.index', ['type' => 'post']) }}" class="sub-item {{ request()->routeIs('admin.categories.*') && request()->get('type') === 'post' ? 'active' : '' }}"><span class="dot"></span> Chuyên mục tin</a>
            </div>
            @endif
            ...
            <div x-show="open==='appearance'" x-cloak x-collapse class="sub-menu">
                <a href="{{ route('admin.settings.group', 'appearance') }}" class="sub-item {{ request()->is('admin/settings/group/appearance') ? 'active' : '' }}"><span class="dot"></span> Cấu hình UX</a>
                <a href="{{ route('admin.menus.index') }}" class="sub-item {{ request()->routeIs('admin.menus.*') ? 'active' : '' }}"><span class="dot"></span> Menu</a>
                <a href="{{ route('admin.widgets.index') }}" class="sub-item {{ request()->routeIs('admin.widgets.*') ? 'active' : '' }}"><span class="dot"></span> Widgets</a>
                <a href="{{ route('admin.media.index') }}" class="sub-item {{ request()->routeIs('admin.media.*') ? 'active' : '' }}"><span class="dot"></span> Media</a>
            </div>
            @endif
            ...
            <a href="{{ route('admin.spam.dashboard') }}" class="nav-item {{ request()->routeIs('admin.spam.*') ? 'active' : '' }}">
            ...
            <div x-show="open==='system'" x-cloak x-collapse class="sub-menu">
                ...
                <a href="{{ route('admin.modules.index') }}" class="sub-item {{ request()->routeIs('admin.modules.*') ? 'active' : '' }}"><span class="dot"></span> Modules</a>
                @endif
                @if(auth()->user()->canAccess('seo'))
                <a href="{{ route('admin.seo.index') }}" class="sub-item {{ request()->routeIs('admin.seo.*') ? 'active' : '' }}"><span class="dot"></span> SEO</a>
                @endif
                @if(auth()->user()->canAccess('logs'))
                <a href="{{ route('admin.logs.index') }}" class="sub-item {{ request()->routeIs('admin.logs.*') ? 'active' : '' }}"><span class="dot"></span> Logs</a>
                @endif
            </div>
            @endif
