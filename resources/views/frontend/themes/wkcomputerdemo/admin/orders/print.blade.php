    ...
    <div class="invoice-wrapper">
        <div class="header">
            <div class="logo-box">
                ...
                @else
                    <h2>{{ setting('site_name', 'WKcomputer') }}</h2>
                @endif
            </div>
            <div class="company-info">
                <p><strong>{{ strtoupper(setting('site_name', 'WKcomputer')) }}</strong></p>
        ...
        <div class="footer-note">
            <p>Kiểm tra kỹ hàng trước khi nhận. Cảm ơn quý khách đã mua sắm tại <strong>{{ setting('site_name', 'WKcomputer') }}</strong>!</p>
        </div>
    </div>
</body>
</html>
