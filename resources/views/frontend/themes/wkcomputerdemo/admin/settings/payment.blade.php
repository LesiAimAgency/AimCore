...
$gateways = [
    [
        'id'          => 'cod',
        'name'        => __('common.checkout') . ' khi nhận hàng (COD)',
    ...
    [
        ...
        'description' => __('common.checkout') . ' bằng cách quét mã QR qua app ngân hàng. Hỗ trợ tất cả ngân hàng Việt Nam.',
        ...
        'fields'      => [
            ...
            ['key'=>'vietqr_bank_name',    'label'=> __('common.save') . ' ẩn',     'type'=>'hidden'],
    ...
    [
        'id'          => 'baokim',
        'name'        => 'Bảo Kim',
        'description' => 'Cổng thanh toán Bảo Kim — Hỗ trợ thẻ ATM nội địa, Thẻ quốc tế, Trả góp.',
        'icon'        => '<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#2563eb" stroke-width="1.8"><circle cx="12" cy="12" r="10"/><path d="M12 8v8"/><path d="M8 12h8"/></svg>',
        'icon_bg'     => '#eff6ff',
        'enabled_key' => 'baokim_enabled',
        'fields'      => [
            ['key'=>'baokim_api_key', 'label'=>'API Key', 'type'=>'text', 'placeholder'=>'Bảo Kim API Key'],
            ['key'=>'baokim_api_secret', 'label'=>'API Secret', 'type'=>'text', 'placeholder'=>'Bảo Kim API Secret'],
        ],
    ],
    [
        'id'          => 'kredivo',
        'name'        => 'Kredivo',
        'description' => 'Mua trước trả sau Kredivo — Giải pháp trả góp linh hoạt.',
        'icon'        => '<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#f97316" stroke-width="1.8"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>',
        'icon_bg'     => '#fff7ed',
        'enabled_key' => 'kredivo_enabled',
        'fields'      => [
            ['key'=>'kredivo_server_key', 'label'=>'Server Key', 'type'=>'text', 'placeholder'=>'Kredivo Server Key', 'desc'=>'Sandbox Server Key: <strong>kvecom123</strong><br>Test Account: +84-989979797 / 447462 (OTP: 4567)'],
            ['key'=>'kredivo_mode', 'label'=>'Môi trường', 'type'=>'select', 'options'=>['sandbox'=>'Sandbox', 'production'=>'Production']],
        ],
    ],
    [
        'id'          => 'fundiin',
        'name'        => 'Fundiin',
        'description' => 'Trả góp qua Fundiin — Mua trước trả sau linh hoạt.',
        'icon'        => '<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#8b5cf6" stroke-width="1.8"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>',
        'icon_bg'     => '#f5f3ff',
        'enabled_key' => 'fundiin_enabled',
        'fields'      => [
            ['key'=>'fundiin_environment', 'label'=>'Môi trường', 'type'=>'select', 'options'=>['sandbox'=>'Sandbox (Thử nghiệm)', 'production'=>'Production (Thực tế)']],
            ['key'=>'fundiin_merchant_name', 'label'=>'Tên Merchant', 'type'=>'text', 'placeholder'=>'WKcomputer', 'desc'=>'Tên doanh nghiệp của bạn hiển thị trên Fundiin'],
            ['key'=>'fundiin_client_id', 'label'=>'Client ID', 'type'=>'text', 'placeholder'=>'Client ID', 'desc'=>'Client ID được cấp bởi Fundiin'],
            ['key'=>'fundiin_merchant_id', 'label'=>'Merchant ID', 'type'=>'text', 'placeholder'=>'Merchant ID', 'desc'=>'Merchant ID được cấp bởi Fundiin'],
            ['key'=>'fundiin_secret_key', 'label'=>'Secret Key', 'type'=>'text', 'placeholder'=>'Secret Key', 'desc'=>'Khóa bí mật dùng tạo HMAC signature'],
            ['key'=>'fundiin_store_id', 'label'=>'Store ID', 'type'=>'text', 'placeholder'=>'Store ID (không bắt buộc)', 'desc'=>'Mã cửa hàng của bạn. Để trống nếu không sử dụng'],
        ],
    ],
];
@endphp
