...
<head>
    ...
    <title>login — {{ get_setting('site_name', 'WKcomputer') }}</title>
...
<div class="w-full max-w-sm">
    ...
    <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-bold text-white">{{ get_setting('site_name', 'WKcomputer') }}</h1>
    ...
    <p class="text-center text-xs text-slate-600 mt-6">
        © {{ date('Y') }} {{ get_setting('site_name', 'WKcomputer') }}. Bảo lưu mọi quyền.
    </p>
</div>
