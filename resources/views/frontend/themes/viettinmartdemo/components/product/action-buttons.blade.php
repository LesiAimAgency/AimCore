            ...
            <div class="flex items-center gap-1">
                @if($showWishlist)
                    <x-ui.button 
                        ...
                        title="{{ __('product_add_to_wishlist') }}"
                        class="aspect-square">
                    </x-ui.button>
                @endif
                ...
                @if($showCompare)
                    <x-ui.button 
                        ...
                        title="{{ __('product_add_to_compare') }}"
                        class="aspect-square">
                    </x-ui.button>
                @endif
        ...
        <div class="grid grid-cols-2 gap-1">
            ...
            @elseif($hasContactPrice)
                <x-ui.button 
                    ...
                    icon="fa-phone"
                    href="tel:{{ setting('site_phone') }}"
                    title="{{ __('product_contact_price') }}"
                    class="col-span-2">
                </x-ui.button>
            @else
                <x-ui.button 
