...
<style>
    ...
    #sidebar.vtm-sidebar::-webkit-scrollbar { width: 3px; }
    #sidebar.vtm-sidebar::-webkit-scrollbar-thumb { background: rgba(255,255,255,.06); }
    .vtm-sidebar .sb-logo {
        padding: 16px 14px;
        display: flex;
        align-items: center;
    ...
    .vtm-sidebar .sb-logo-icon i { color: #fff; font-size: 14px; }
    .vtm-sidebar .sb-logo-text p { font-size: 13px; font-weight: 700; color: #fff; margin: 0; line-height: 1.2; }
    .vtm-sidebar .sb-logo-text span { font-size: 10px; color: #475569; font-weight: 500; display: block; margin-top: 1px; }

    .vtm-sidebar .nav-label {
    ...
    .vtm-sidebar .nav-item:hover { color: #cbd5e1; }
    .vtm-sidebar .nav-item.active { color: #fff; background: rgba(255,255,255,.04); }
    .vtm-sidebar .nav-item.active .nav-icon { background: #2563eb; color: #fff; }
    .vtm-sidebar .nav-icon {
    ...
    .vtm-sidebar .nav-item:hover .nav-icon { background: rgba(255,255,255,.07); color: #94a3b8; }
    .vtm-sidebar .sub-menu { padding: 2px 0; }
    .vtm-sidebar .sub-item {
        display: flex;
        align-items: center;
        gap: 10px;
    ...
    .vtm-sidebar .sub-item:hover { color: #94a3b8; }
    .vtm-sidebar .sub-item.active { color: #e2e8f0; font-weight: 600; }
    .vtm-sidebar .sub-item .dot {
        width: 4px; height: 4px;
        border-radius: 50%;
        background: #334155;
        flex-shrink: 0;
    }
    .vtm-sidebar .sub-item.active .dot { background: #3b82f6; }
</style>
@endonce

<aside id="sidebar" class="vtm-sidebar custom-scroll" x-data="{ open: '{{ $inShop ? 'shop' : ($inContent ? 'content' : ($inMedia ? 'appearance' : ($inSettings ? 'settings' : ($inSystem ? 'system' : '')))) }}' }">
    <div class="sb-logo">
