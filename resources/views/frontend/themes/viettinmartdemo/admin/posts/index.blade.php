            ...
            <tr class="tbl-tr">
                <td class="tbl-td">
                    <div style="display:flex;align-items:center;gap:12px;">
                        ...
                        @endif
                        <div>
                            <p style="font-size:13.5px;font-weight:600;color:#0f172a;">{{ $post->translate('title', $locale) ?: $post->title }}</p>
                            <p style="font-size:11.5px;color:#94a3b8;font-family:monospace;margin-top:2px;">{{ $post->slug }}</p>
                        </div>
                    </div>
                </td>
                <td class="tbl-td" style="color:#64748b;font-size:13px;">{{ $post->category ? ($post->category->translate('name', $locale) ?: $post->category->name) : '—' }}</td>
