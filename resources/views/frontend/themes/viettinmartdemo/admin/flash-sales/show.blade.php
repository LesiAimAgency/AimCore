                ...
                <tr>
                    ...
                    <td class="tbl-td">
                        ...
                        <div style="display:flex;align-items:center;gap:8px;">
                            @php $thumb = $item->product?->thumbnail_url ?: asset('theme/images/grocery/01.jpg'); @endphp
                        ...
                        <p class="text-sm font-medium text-gray-800">
                            <i class="fa-solid fa-folder text-purple-400 mr-1"></i>{{ $item->category?->name ?? '—' }}
                        </p>
                        @endif
                    </td>
                    <td class="tbl-td">
                        ...
                        @php $flashPrice = $item->calcFlashPrice((float)$item->product->price); @endphp
                        <p class="text-xs text-green-600 mt-1 font-semibold">
                            → <strong>{{ number_format($flashPrice, 0, ',', '.') }}₫</strong>
                            <span class="text-gray-400 font-normal">(tiết kiệm {{ number_format($item->product->price - $flashPrice, 0, ',', '.') }}₫)</span>
                        </p>
                        @endif
                    </td>
                    <td class="tbl-td">
