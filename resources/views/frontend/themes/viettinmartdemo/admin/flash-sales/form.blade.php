...
@section('title', isset($campaign) ? __('common.edit') . ' Flash Sale' : 'Tạo Flash Sale')
                            ...
                            <tr class="item-row">
                                <td class="tbl-td">
                                    ...
                                    <span class="text-xs font-medium {{ $item->product_id ? 'text-blue-600' : 'text-purple-600' }}">
                                        {{ $item->product_id ? __('common.products') : __('common.categories') }}
                                    </span>
                                </td>
                                <td class="tbl-td">
    ...
    <div style="background:#fff;border-radius:12px;width:600px;max-height:80vh;display:flex;flex-direction:column;overflow:hidden;">
        ...
        <div id="product-list" style="overflow-y:auto;flex:1;padding:8px 0;">
            ...
            <div class="product-option" data-name="{{ strtolower($product->name) }}"
                ...
                @php $thumb = $product->thumbnail_url ?: asset('theme/images/grocery/01.jpg'); @endphp
                <img src="{{ $thumb }}" style="width:36px;height:36px;object-fit:cover;border-radius:6px;flex-shrink:0;">
                <div style="flex:1;min-width:0;">
                    <p style="font-size:13px;font-weight:600;color:#1e293b;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">{{ $product->name }}</p>
