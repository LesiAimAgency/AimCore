...
<div style="display:grid;grid-template-columns:repeat(2,1fr);gap:16px;margin-top:16px;">
    <a href="{{ locale_route('admin.languages.index') }}"
       ...
       onmouseover="this.style.borderColor='#e2e8f0';this.style.boxShadow='0 4px 16px rgba(0,0,0,.08)';this.style.transform='translateY(-2px)'"
       onmouseout="this.style.borderColor='#f1f5f9';this.style.boxShadow='0 1px 4px rgba(0,0,0,.05)';this.style.transform='none'">
        <div style="width:44px;height:44px;border-radius:12px;background:#0891b218;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
            <i class="fa-solid fa-language" style="color:#0891b2;font-size:18px;"></i>
        </div>
        <div style="min-width:0;flex:1;">
            <p style="font-size:13.5px;font-weight:700;color:#0f172a;">Ngôn ngữ</p>
            <p style="font-size:12px;color:#94a3b8;margin-top:4px;line-height:1.5;">Quản lý ngôn ngữ, bật đa ngôn ngữ</p>
        </div>
        <i class="fa-solid fa-chevron-right" style="color:#cbd5e1;font-size:11px;flex-shrink:0;margin-top:4px;"></i>
    </a>
</div>
