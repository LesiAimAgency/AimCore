...
<div x-data="mediaManager()" x-init="init()">
    ...
    <div class="card" style="border-radius:40px; overflow:hidden;">
        ...
        {{-- Content Area --}}
        <div class="p-5 bg-white" style="min-height: calc(100vh - 280px);">
    ...
    <div x-show="showMoveModal" x-cloak class="fixed inset-0 z-[9999] flex items-center justify-center p-4" @keydown.window.escape="showMoveModal=false">
        ...
        <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-md p-5"
            ...
            <h3 class="card-title mb-1">Chuyển vào thư mục</h3>
            <p class="form-hint mb-4">Chọn thư mục đích cho <span x-text="selected.length"></span> tệp đã chọn</p>
            <label class="form-label">Thư mục đích</label>
            <select x-model="moveTarget" class="form-select mb-4">
            ...
            <div class="flex gap-2 justify-end">
                <button @click="showMoveModal=false" class="btn btn-secondary btn-sm">Hủy</button>
                <button @click="confirmMove()" class="btn btn-primary btn-sm"><i class="fa-solid fa-check"></i> Xác nhận</button>
            </div>
        </div>
    </div>
    ...
    <div x-show="toast" x-cloak x-transition
         class="fixed top-20 right-6 bg-slate-900 text-white px-6 py-3 rounded-2xl text-[12px] font-black z-[9999] flex items-center gap-3 shadow-2xl">
    ...
    <div id="upload-modal" class="fixed inset-0 z-[9999] items-center justify-center p-4" style="display:none;">
        ...
        <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-lg overflow-hidden">
            <div style="padding:14px 16px;border-bottom:1px solid #f1f5f9;display:flex;align-items:center;justify-content:space-between;">
                <div>
                    <h3 class="card-title">Tải lên tệp mới</h3>
                    <p class="form-hint mt-0.5">PNG, JPG, GIF, PDF... Không giới hạn số lượng</p>
                </div>
                <button onclick="document.getElementById('upload-modal').style.display='none'" class="act-btn">
            ...
            <div class="p-5 flex flex-col gap-4">
                ...
                <div id="drop-zone" onclick="document.getElementById('file-input').click()"
                     class="border-2 border-dashed border-slate-200 rounded-xl p-8 flex flex-col items-center justify-center gap-3 cursor-pointer hover:border-blue-400 hover:bg-blue-50/30 transition-all text-center">
                    <i class="fa-solid fa-cloud-arrow-up text-3xl text-slate-300"></i>
                    <p style="font-size:12px;font-weight:600;color:#64748b;">Kéo thả hoặc <span style="color:#2563eb;">nhấn để chọn</span></p>
                    <div id="file-preview" style="font-size:11px;color:#475569;margin-top:4px;"></div>
                </div>
