...
<head>
    ...
    <title>login — {{ get_setting('site_name', 'VietTinMart') }}</title>
...
<div class="w-full max-w-sm">
    ...
    <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-bold text-white">{{ get_setting('site_name', 'VietTinMart') }}</h1>
        <p class="text-slate-400 text-sm mt-1">login vào trang quản trị</p>
    </div>
    ...
    <p class="text-center text-xs text-slate-600 mt-6">
        © {{ date('Y') }} {{ get_setting('site_name', 'VietTinMart') }}. Bảo lưu mọi quyền.
    </p>
</div>
