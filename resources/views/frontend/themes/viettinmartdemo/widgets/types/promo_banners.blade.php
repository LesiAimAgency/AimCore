...
<div class="category-feature-area rts-section-gapTop" {!! $sectionStyles ?? '' !!}>
    <div class="container">
        <div class="row g-4">
            ...
            <div class="{{ $gridClass }}">
                <div class="single-feature-card bg_image {{ $item['bg_style'] ?? 'one' }}"
                     @if(!empty($item['image'])) style="background-image: url('{{ $item['image'] }}'); background-size: cover; background-position: center; background-repeat: no-repeat;" @endif>
