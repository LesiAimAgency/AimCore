            ...
            <div class="tab-pane fade {{ $i == 0 ? 'show active' : '' }}" id="tab-content-{{ $widgetId }}-{{ $i }}">
                ...
                <div class="category-area-main-wrapper-one" style="position: relative;">
                    <div class="swiper swiper-data" data-swiper='{
                        ...
                        "observeParents": true,
                        "navigation":{
                            "nextEl":".{{ $commonUniqueId }}-next",
                            "prevEl":".{{ $commonUniqueId }}-prev"
                        },
                        "breakpoints":{
                    ...
                    <div class="swiper-prev {{ $commonUniqueId }}-prev"><i class="fa-regular fa-chevron-left"></i></div>
                    <div class="swiper-next {{ $commonUniqueId }}-next"><i class="fa-regular fa-chevron-right"></i></div>
                </div>
            </div>
            @endforeach
        </div>
