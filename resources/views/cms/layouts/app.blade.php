...
<body class="bg-gray-100" x-data="{ showAlert: false, alertMessage: '', alertType: 'success' }">
    ...
    <div class="min-h-screen flex w-full">
        ...
        <!-- Main Content -->
        <div class="flex-1 flex flex-col {{ $hasCustomSidebar ? 'ml-[250px]' : 'ml-72' }} min-w-0">
            <!-- Header -->
