        ...
        <table class="w-full text-left border-collapse">
            <thead>
                <tr class="border-b border-gray-100 bg-gray-50/50">
                    <th class="px-4 py-3 text-sm font-medium text-gray-500 w-10">Mã NV</th>
                    <th class="px-4 py-3 text-sm font-medium text-gray-500">Tên / Email</th>
                    <th class="px-4 py-3 text-sm font-medium text-gray-500">Phòng ban</th>
            ...
            <tbody class="divide-y divide-gray-100">
                @forelse($users as $user)
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        <td class="px-4 py-3 text-sm text-gray-500 font-medium">{{ $user->employee_code ?? '-' }}</td>
                        <td class="px-4 py-3">
