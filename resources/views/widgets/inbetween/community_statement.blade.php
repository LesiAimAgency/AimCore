  ...
  <div id="community" class="absolute inset-0 flex items-center justify-center z-20">
    <div class="relative w-full max-w-[1440px] mx-auto flex flex-col justify-center px-6 lg:px-16 z-10">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div class="lg:col-span-4 flex flex-col items-center text-center my-6 z-20" style="margin-top: 19vh;">
          <div class="flex flex-col" style="gap: 80px;">
            ...
            <h2 id="sec2-title-bot" class="text-2xl sm:text-3xl lg:text-[40px] font-bold uppercase tracking-tight text-white m-0 leading-tight">
              {{ $settings['title_bot'] }}
            </h2>
          </div>

          <p id="sec2-subtitle" class="text-xs sm:text-sm text-silver font-light leading-relaxed my-6 max-w-[320px]">
