<div id="kalles-section-header_top" class="header-glasses">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="d-none d-lg-block mx-auto">
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0 glasses-header">
                        ...
                        <li class="nav-item dropdown dropdown-mega-xxl">
                            <a class="nav-link position-relative fw-medium" href="{{ url('shop_pages/shop-filter-sidebar')}}" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <div class="row p-4">
                                            <div class="col-lg-6 cat-section p-0">
                                                <a href="{{url( 'shop_pages.shop-left-sidebar')}}" class="d-block position-relative cat_grid_item overflow-hidden " style="height: 350px;">
                                                    <div class="h-100 w-100 cat-grid-img" style="background-image: url('{{ asset('/build/images/home-glasses/mega-menu-slide-01.jpg')}}"></div>
                                                    <div class="cat-grid-button text-body">
                                                        <div class="cat_grid_item__title">Eyeglasses</div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="col-lg-6 cat-section ps-4 p-0">
                                                <a href="{{url( 'shop_pages.shop-left-sidebar')}}" class="d-block position-relative cat_grid_item overflow-hidden " style="height: 350px;">
                                                    <div class="h-100 w-100 cat-grid-img" style="background-image: url('{{ asset('/build/images/home-glasses/mega-menu-slide-02.jpg')}}"></div>
                                                    <div class="cat-grid-button text-body">
                                                        <div class="cat_grid_item__title">Sunglasses</div>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                        ...
                        <li class="nav-item dropdown dropdown-mega-3xl">
                            <a class="nav-link position-relative text-danger fw-medium" href="{{ url('shop_pages/shop-filter-sidebar')}}" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="topbar-toolbar d-flex align-items-center gap-3 glasses-header">
