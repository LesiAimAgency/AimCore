<div id="kalles-section-header_top" class="navbar-green">
                    ...
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="dropdown-sub-column-item">
                                            ...
                                            <ul class="sub-column-menu">
                                                ...
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-glasses')}}">Home Glasses <span class="badge-tag badge bg-green2">new</span></a></li>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="dropdown-sub-column-item">
                                            ...
                                            <ul class="sub-column-menu">
                                                ...
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-sport')}}">Home Sport <span class="badge-tag badge bg-green2">new</span></a>
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-jewelry')}}">Home Jewelry <span class="badge-tag badge bg-green2">new</span></a>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="dropdown-sub-column-item">
                                            ...
                                            <ul class="sub-column-menu">
                                                ...
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-shoes')}}">Compare  <span class="badge-tag badge bg-green2">new</span></a></li>
                                                <li><a class="text-muted position-relative d-inline-flex" href="{{ url('product/product-detail-pickup-availability')}}">Pickup
                                                        Availability <span class="position-absolute bg-green2 badge rounded-pill fw-normal text-white" style="right:-40px; top: -5px; ">Selling feature</span></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <li class="nav-item dropdown dropdown-mega-xxl">
                            <a class="nav-link position-relative" href="{{ url('shop_pages/shop-filter-sidebar')}}" data-bs-toggle="dropdown" aria-expanded="false">
                                Shop <span class="badge fw-normal" style="background-color: #94ccb9;">New</span>
                            </a>
                                        ...
                                        <div class="row p-4">
                                            <div class="col-lg-6 cat-section p-0">
                                                <a href="{{url( 'shop_pages.shop-left-sidebar')}}" class="d-block position-relative cat_grid_item overflow-hidden " style="height: 350px;">
                                                    <div class="h-100 w-100 cat-grid-img" style="background-image: url('{{ asset('/build/images/home-flower/mega-banner-01.jpg')}}"></div>
                                                    <div class="cat-grid-button text-body">
                                                        <div class="cat_grid_item__title">Celebrations</div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="col-lg-6 cat-section ps-4 p-0">
                                                <a href="{{url( 'shop_pages.shop-left-sidebar')}}" class="d-block position-relative cat_grid_item overflow-hidden " style="height: 350px;">
                                                    <div class="h-100 w-100 cat-grid-img" style="background-image: url('{{ asset('/build/images/home-flower/mega-banner-02.jpg')}}"></div>
                                                    <div class="cat-grid-button text-body">
                                        ...
                                        <div class="swiper mySwiper">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <div x-data="{ imageUrl: '/build/images/home-flower/pr-trending-03.png', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                                                        <div class="position-relative overflow-hidden">
                                                            <span class="new-label bg-danger text-white rounded-circle"> -31% </span>
                                                            <img :src="isHovered ? '/build/images/home-flower/pr-trending-04.png' : imageUrl" alt="" class="img-fluid">
                                                            ...
                                                            <div class="product-button d-none d-lg-flex flex-column gap-2">
                                                                <a href="#exampleModal" data-bs-toggle="modal" class="btn rounded-pill bg-pink2 text-white fs-14"><span>Quick View</span> <i class="iccl iccl-eye"></i></a>
                                                                <button type="button" class="btn bg-pink2 text-white rounded-pill fs-14" data-bs-toggle="modal" data-bs-target="#cardModal" class="btn rounded-pill fs-14"><span>Quick Shop</span>
                                                            ...
                                                            <div class="position-absolute d-lg-none bottom-0 end-0 d-flex flex-column bg-white rounded-pill m-2" style="z-index: 1;">
                                                                <a href="#exampleModal" data-bs-toggle="modal" class="btn bg-pink2 text-white responsive-cart rounded-pill fs-14 p-2" style="width:36px; height: 36px;"><i class="iccl iccl-eye fw-semibold text-white"></i></a>
                                                                <button type="button" class="btn responsive-cart bg-pink2 rounded-pill fs-14 p-2" style="width:36px; height: 36px;" data-bs-toggle="modal" data-bs-target="#cardModal" class="btn rounded-pill fs-14">
                                                                    <i class="iccl iccl-cart fw-semibold text-white"></i></button>
                                                            </div>
                                                        </div>
                                                        <div class="mt-3">
                                                            <h6 class="mb-2 fw-normal"><a href="{{ url('product/product-detail-layout-01')}}" class="text-pink2">Shade Of Green</a></h6>
                                                ...
                                                <div class="swiper-slide">
                                                    <div x-data="{ imageUrl: '/build/images/home-flower/pr-trending-05.png', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                                                        <div class="position-relative overflow-hidden">
                                                            <img :src="isHovered ? '/build/images/home-flower/pr-trending-06.png' : imageUrl" alt="" class="img-fluid">
                                                            <a href="#" class="d-lg-none position-absolute " style="z-index: 1; top:10px; left:10px;" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o text-white"></i></a>
                                                            <a href="#" class="wishlistadd d-none d-lg-flex position-absolute" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o text-white"></i></a>
                                                        ...
                                                        <div class="mt-3">
                                                            <h6 class="mb-2 fw-normal"><a href="{{ url('product/product-detail-layout-01')}}" class="text-pink2">Seasonal Arrangement</a></h6>
                                                            <p class="mb-0 fs-14 text-muted">
                                                                <span>$95.00</span>
                                                            </p>
                                                        </div>
                                                ...
                                                <div class="swiper-slide">
                                                    <div x-data="{ imageUrl: '/build/images/home-flower/pr-trending-01.png', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                                                        <div class="position-relative overflow-hidden">
                                                            <img :src="isHovered ? '/build/images/home-flower/pr-trending-02.png' : imageUrl" alt="" class="img-fluid">
                                                            <a href="#" class="d-lg-none position-absolute " style="z-index: 1; top:10px; left:10px;" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o text-white"></i></a>
                                                            <a href="#" class="wishlistadd d-none d-lg-flex position-absolute" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o text-white"></i></a>
                                                        ...
                                                        <div class="mt-3">
                                                            <h6 class="mb-2 fw-normal text-pink2"><a href="{{ url('product/product-detail-layout-01')}}" class="text-pink2">Regular Succulent Shebang</a></h6>
                                                            <p class="mb-0 fs-14 text-muted">
                                                                <span>$125.00</span>
                                                            </p>
                                                        </div>
                                                ...
                                                <div class="swiper-slide">
                                                    <div x-data="{ imageUrl: '/build/images/home-flower/pr-trending-09.png', isHovered: false }" class="topbar-product-card" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                                                        <div class="position-relative overflow-hidden">
                                                            <span class="new-label bg-success text-white rounded-circle text-center"> Sold Out
                                                            </span>
                                                            <img :src="isHovered ? '/build/images/home-flower/pr-trending-10.png' : imageUrl" alt="" class="img-fluid">
                                                            <a href="#" class="d-lg-none position-absolute " style="z-index: 1; top:10px; left:10px;" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o text-white"></i></a>
                                                            <a href="#" class="wishlistadd d-none d-lg-flex position-absolute" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to Wishlist"><i class="facl facl-heart-o text-white"></i></a>
                                                        ...
                                                        <div class="mt-3">
                                                            <h6 class="mb-2 fw-normal"><a href="{{ url('product/product-detail-layout-01')}}" class="text-pink2">Floral Garden Arrangement</a></h6>
                                                            <p class="mb-0 fs-14 text-muted">
                                                                <span>$195.00</span>
                                                            </p>
                                                        </div>
