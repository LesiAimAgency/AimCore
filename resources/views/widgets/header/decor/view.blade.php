<div id="kalles-section-header_top" class="header-decor">
    <nav class="navbar navbar-expand-lg navbar-custom py-0 d-flex align-items-center px-lg-3" :class="{ 'bg-body navbar-scroll shadow-sm' : showMenuScroll }" @scroll.window="showMenuScroll = (window.pageYOffset > 0) ? true : false">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <a class="d-lg-none" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
                        <svg xmlns="http://www.w3.org/2000/svg" class="header-toggle" width="30" height="16" viewBox="0 0 30 16">
                        ...
                        <div class="d-none d-lg-block mx-auto">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                <li class="nav-item dropdown dropdown-mega-xxl">
                                    <a class="nav-link fw-medium fs-16" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                        Demo
                                    </a>
                                    <div class="dropdown-menu ms-0" style="width: 720px;">
                                        <div class="row">
                                            <div class="col-lg-4">
                                ...
                                <li class="nav-item dropdown dropdown-mega-xxl">
                                    <a class="nav-link fw-medium fs-16 position-relative" href="{{ url('shop_pages/shop-filter-sidebar')}}" data-bs-toggle="dropdown" aria-expanded="false">
                                        Shop
                                    </a>
                                                ...
                                                <div class="row p-4">
                                                        ...
                                                        <div class="swiper saleSwiper ">
                                                            <div class="swiper-wrapper">
                                                                <div class="swiper-slide me-2">
                                                                    <div x-data="{ imageUrl: '/build/images/home-decor/pr-01.jpg', isHovered: false }" class="topbar-product-card px-3 pt-2" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                                                                ...
                                                                <div class="swiper-slide pe-2">
                                                                    <div x-data="{ imageUrl: '/build/images/home-decor/pr-03.jpg', isHovered: false }" class="topbar-product-card px-3 pt-2 overlay-hover" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                                                                        <div class="position-relative overflow-hidden shadow rounded">
                                                                ...
                                                                <div class="swiper-slide">
                                                                    <div x-data="{ imageUrl: '/build/images/home-decor/pr-05.jpg', isHovered: false }" class="topbar-product-card px-3 pt-2 overlay-hover" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                                                                ...
                                                                <div class="swiper-slide">
                                                                    <div x-data="{ imageUrl: '/build/images/home-decor/pr-07.jpg', isHovered: false }" class="topbar-product-card px-3 pt-2 overlay-hover" x-on:mouseenter="isHovered = true" x-on:mouseleave="isHovered = false">
                                                                        <div class="position-relative overflow-hidden shadow rounded main">
                                                    ...
                                                    <div class="col-lg-6 cat-section px-4 py-2">
                                                        <a href="{{url( 'shop_pages.shop-left-sidebar')}}" class="d-block position-relative cat_grid_item overflow-hidden " style="height: 280px;">
                                                            <div class="h-100 w-100 cat-grid-img" style="background-image: url('{{ asset('/build/images/home-decor/mega-cat.jpg')}}"></div>
                                                            <div class="cat-grid-button text-body">
                                                                <div class="cat_grid_item__title">Decor</div>
                                                            </div>
                                                        </a>
                                                    </div>
                                                </div>
                                ...
                                <li class="nav-item dropdown dropdown-mega-xxl">
                                    <a class="nav-link fw-medium fs-16" href="{{ url('product/product-detail-layout-01')}}" data-bs-toggle="dropdown" aria-expanded="false">
                                        Product
                                    </a>
                                ...
                                <li class="nav-item dropdown dropdown-mega-lg">
                                    <a class="nav-link fw-medium fs-16" href="{{ url('portfolio/portfolio-3-columns')}}" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        Lookbook
                                    </a>
                                    <ul class="dropdown-menu dropdown-sub-column ms-0">
                                ...
                                <li class="nav-item dropdown dropdown-mega-lg">
                                    <a class="nav-link fw-medium fs-16" href="#!" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        Blog
                                    </a>
                ...
                <div>
                    <div class="text-center">
                        <a class="navbar-brand mx-auto" href="{{ url('index')}}">
                            <img src="{{ URL::asset('/build/images/home-decor/head-logo-white.png')}}" alt="" width="95" class="logo-light">
                            <img src="{{ URL::asset('/build/images/home-decor/head-logo.png')}}" alt="" width="95" class="logo-dark">
                        </a>
                    </div>
                </div>
                <div>
                    <div class="topbar-toolbar ms-auto d-flex align-items-center gap-3 justify-content-end ">
                        <a href="#!" role="presentation" data-bs-toggle="modal" data-bs-target="#searchModal">
                            <i class="iccl iccl-search" style="transform: rotate(90deg);"></i>
                        </a>
