    ...
    <nav class="navbar navbar-expand-lg navbar-custom py-0 d-flex align-items-center" :class="{ 'bg-white shadow-sm' : showMenuScroll }" @scroll.window="showMenuScroll = (window.pageYOffset > 0) ? true : false">
        <div class="container-fluid w-100 d-inline-block">
            <div class="row align-items-center justify-content-between">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="dropdown-sub-column-item">
                                                    ...
                                                    <ul class="sub-column-menu">
                                                        ...
                                                        <li><a class="text-muted position-relative d-inline-flex" href="{{ url('home_pages/home-medical')}}">Home Medical <span class="badge-tag badge bg-danger">Hot</span></a></li>
                                            ...
                                            <div class="col-lg-7 p-4">
                                                <div class="row ">
                                                    <div class="col-lg-6 cat-section p-0">
                                                        <a href="{{url( 'shop_pages.shop-left-sidebar')}}" class="d-block position-relative cat_grid_item overflow-hidden " style="height: 370px;">
                                                            <div class="h-100 w-100 cat-grid-img" style="background-image: url('{{ asset('/build/images/home-lingerie/mega-menu-cat-01.jpg')}}"></div>
                                                            <div class="cat-grid-button text-body">
                                                                <div class="cat_grid_item__title">Strapless</div>
                                                            </div>
                                                        </a>
                                                    </div>
                                                    <div class="col-lg-6 cat-section ps-4 p-0">
                                                        <a href="{{url( 'shop_pages.shop-left-sidebar')}}" class="d-block position-relative cat_grid_item overflow-hidden " style="height: 370px;">
                                                            <div class="h-100 w-100 cat-grid-img" style="background-image: url('{{ asset('/build/images/home-lingerie/mega-menu-cat-02.jpg')}}"></div>
                                                            <div class="cat-grid-button text-body">
                                                                <div class="cat_grid_item__title">Trikini</div>
                                                            </div>
                                                        </a>
                                                    </div>
                ...
                <div class="col-lg-5 col-auto">
                    <div class="topbar-toolbar ms-auto d-flex align-items-center gap-3 justify-content-end lingeries-header">
