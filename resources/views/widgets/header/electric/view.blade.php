<div id="kalles-section-header_top " class="">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center py-3 py-xl-0">
                <div class="col-md-5 col-lg-3 col-12">
                    <div class="nt-social text-center text-lg-start">
                        <a href="#" class="facebook cb ttip_nt tooltip_bottom_right text-black fs-16 me-3">
                            <i class="facl facl-facebook"></i>
                        </a>
                        <a href="#" class="twitter cb ttip_nt tooltip_bottom_right text-black fs-16 me-3">
                            <i class="facl facl-twitter"></i>
                        </a>
                        <a href="#" class="instagram cb ttip_nt tooltip_bottom_right text-black fs-16 me-3">
                            <i class="facl facl-instagram"></i>
                        </a>
                        <a href="#" class="linkedin cb ttip_nt tooltip_bottom_right text-black fs-16 me-3">
                            <i class="facl facl-linkedin"></i>
                        </a>
                        <a href="#" class="pinterest cb ttip_nt tooltip_bottom_right text-black fs-16 me-3">
                ...
                <div class="col-md-5 col-lg-6 col-12">
                    <div class="header-text text-center fs-12 py-1 py-lg-0">
                        Summer sale discount off <span class="cr">20%</span>use code “SUMMER20”! <a href="{{ url('shop_pages/shop')}}" class="text-reset"><span class="text-danger">Shop Now</span></a>
                    </div>
                </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom pt-4 pb-0 d-block align-items-center ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-lg-3">
                            <form action="#" method="get" class="electrict-input" role="search">
                                <div class="footer-subscribe position-relative electrict-input">
                                    ...
                                    <div>
                                        <input type="text" name="email" placeholder="I'm shopping for..." value="" data-bs-toggle="dropdown" aria-expanded="false" class="input-text input-search form-control w-100 rounded-pill dropdown-toggle" autocomplete="off" required="required">
                                        <div class="dropdown-menu end-0 overflow-x-hidden overflow-y-auto" style="max-height: 50vh;">
                                            <div class="d-flex flex-wrap align-items-center">
                                                <div class="flex-shrink-0">
                                                    <a href="{{ url('product/product-detail-layout-01')}}">
                                                        <img src="{{ URL::asset('/build/images/home-electronic-vertical/pr-01-80x.jpg')}}" data-src="{{ URL::asset('/build/images/home-electronic-vertical/pr-01-80x.jpg')}}" class="w__100 lz_op_ef ls-is-cached lazyloaded" alt="Ysamsung Camera">                                                  

                                                    </a>
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    <a class="product-title" href="{{ url('product/product-detail-layout-01')}}">Ysamsung Camera</a>
                                                    <div>
                                                        <del class="text-muted">$35.00</del>
                                                        <span class="text-danger">$25.00</span>
                                                        <span class="text-white bg-danger fs-10 p-1">-29%</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="d-flex flex-wrap align-items-center">
                                                <div class="flex-shrink-0">
                                                    <a href="{{ url('product/product-detail-layout-01')}}">
                                                        <img src="{{ URL::asset('/build/images/home-electronic-vertical/pr-02-80x.jpg')}}" data-src="{{ URL::asset('/build/images/home-electronic-vertical/pr-02-80x.jpg')}}" class="w__100 lz_op_ef ls-is-cached lazyloaded" alt="Beats Solo3 Wireless">
                                                    </a>
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    <a class="product-title" href="{{ url('product/product-detail-layout-01')}}">Beats Solo3 Wireless</a>
                                                    <div>
                                            ...
                                            <div class="d-flex flex-wrap align-items-center">
                                                <div class="flex-shrink-0">
                                                    <a href="{{ url('product/product-detail-layout-01')}}">
                                                        <img src="{{ URL::asset('/build/images/home-electronic-vertical/pr-03-80x.jpg')}}" data-src="{{ URL::asset('/build/images/home-electronic-vertical/pr-03-80x.jpg')}}" class="w__100 lz_op_ef ls-is-cached lazyloaded" alt="Lomo Sanremo Edition">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    <a class="product-title" href="{{ url('product/product-detail-layout-01')}}">Lomo Sanremo Edition</a>
                                                    <div>
                                            ...
                                            <div class="d-flex flex-wrap align-items-center">
                                                <div class="flex-shrink-0">
                                                    <a href="{{ url('product/product-detail-layout-01')}}">
                                                        <img src="{{ URL::asset('/build/images/home-electronic-vertical/pr-04-80x.jpg')}}" data-src="{{ URL::asset('/build/images/home-electronic-vertical/pr-04-80x.jpg')}}" class="w__100 lz_op_ef ls-is-cached lazyloaded" alt="Ygoogle Speaker">
                                                    </a>
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    <a class="product-title" href="{{ url('product/product-detail-layout-01')}}">Ygoogle Speaker</a>
                                                    <div>
                                                        <span class="text-muted">$65.00</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="d-flex flex-wrap align-items-center">
                                                <div class="flex-shrink-0">
                                                    <a href="{{ url('product/product-detail-layout-01')}}">
                                                        <img src="{{ URL::asset('/build/images/home-electronic-vertical/pr-05-80x.jpg')}}" data-src="{{ URL::asset('/build/images/home-electronic-vertical/pr-05-80x.jpg')}}" class="w__100 lz_op_ef ls-is-cached lazyloaded" alt="Ybeoplay H9i">
                                                    </a>
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    <a class="product-title" href="{{ url('product/product-detail-layout-01')}}">Ybeoplay H9i</a>
                                                    <div>
                                                        <span class="text-muted">$55.00</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <a href="#" class="btn detail_link">View All(107)
                                                <i class="facl facl-right"></i>
                                            </a>
                                        </div>
                                    </div>
                                    <button type="submit" class="btn btn-teal position-absolute search-btn rounded-pill top-0 end-0">
                                        <span>Search</span>
                                    </button>
                                </div>
                            </form>
                        ...
                        <div class="col-3">
                            <div class="topbar-toolbar d-flex justify-content-end align-items-center gap-3">
                                ...
                                <a class="d-md-block d-none" href="#!"><i class="iccl iccl-heart"></i><span class="tcount bg-dark text-white rounded-circle d-flex align-items-center justify-content-center">3</span></a>
        ...
        <div class="bg-teal text-white d-none d-lg-block">
            <div class="container">
                <!-- nav-list -->
                <div class="d-flex justify-content-between">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        <li class="nav-item dropdown dropdown-mega-lg">
                            <a class="nav-link text-uppercase text-white d-flex align-items-center fw-medium" style="background-color: #007e91; height: 50px;" href="{{ url('portfolio/portfolio-3-columns')}}" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <li class="nav-item dropdown dropdown-mega-xxl nav-electric-item">
                            <a class="nav-link position-relative text-white" style="height: 50px ;"" href=" {{ url('shop_pages.shop-filter-sidebar')}}" data-bs-toggle="dropdown" aria-expanded="false">
                                Shop
                            </a>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="row p-4">
                                            ...
                                            <div class="col-lg-6 cat-section p-0 ps-4">
                        ...
                        <li class="nav-item dropdown dropdown-mega-lg nav-electric-item">
                            ...
                            <ul class="dropdown-menu dropdown-sub-column">
                                ...
                                <li><a class="text-muted" href="{{ url('product/product-detail-description-with-lookbook')}}">Lookbook in product</a>
                                </li>
