<footer class="footer footer-lingerie">
    <div class="container">
        <div class="row accordion" id="footer-accordion">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="mt-md-4 pt-md-2">
                        <ul class="menu list-unstyled">
                            <li class="menu-item">
                                <a href="{{ url('shop_pages/shop-filter-sidebar')}}" class="text-muted">Strapless</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ url('shop_pages/shop-filter-sidebar')}}" class="text-muted">Micro Bikini</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ url('shop_pages/shop-1600px-layout')}}" class="text-muted">High Waisted</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ url('shop_pages/shop-1600px-layout')}}" class="text-muted">Trikini</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ url('shop_pages/shop-1600px-layout')}}" class="text-muted">Flounce</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ url('shop_pages/shop-1600px-layout')}}" class="text-muted">Sling Bikini</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-md-3 col-lg-2 mb-2 accordion-item footer-accordion-item">
                ...
                <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="mt-md-4 pt-md-2">
                        <ul class="menu list-unstyled">
                            <li class="menu-item">
                                <a href="#!" class="text-muted">Our Location</a>
                            </li>
                            <li class="menu-item">
            ...
            <div class="col-md-6 mb-2 col-lg-3 accordion-item footer-accordion-item mt-3">
                ...
                <h6 class="fw-medium d-none d-md-block">Newsletter</h6>
                    ...
                    <div class="pt-md-2">
                        ...
                        <form id="contact_form" class="d-block">
                            <div class="footer-subscribe position-relative">
                                <input type="email" name="email" placeholder="Your email address" value="" class="input-text form-control w-100 rounded-0 bg-transparent border-dark border-opacity-50" required="required">
                                <button type="submit" class="btn btn-dark position-absolute rounded-0">
                                    <span>Subscribe</span>
                                </button>
                            </div>
                        </form>
                        <div class="mt-4">
                            <img src="{{ URL::asset('/build/images/home-lingerie/payment-method.png')}}" alt="">
                        </div>
                    </div>
                </div>
            </div><!--end col-->
...
<div class="footer-alt mb-5 py-4 mb-lg-0">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 text-lg-start text-center text-muted">
                Copyright ©
                <script>document.write(new Date().getFullYear())</script> <a href="#!" class="text-dark">Kalles</a> all
