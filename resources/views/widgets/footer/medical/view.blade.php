<footer class="footer border-top">
    <div class="container">
        <div class="row accordion" id="footer-accordion">
            <div class="col-lg-3 col-md-6 mb-2 footer-accordion-item accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <a href="#!">
                        <img src="{{ URL::asset('/build/images/home-medical/footer-logo.png')}}" alt="" height="29">
                    </a>
                    <div class="mt-4 pt-2">
                        <p class="d-flex align-items-start text-muted gap-2">
                            <i class="pegk pe-7s-map-marker fs-24"></i>
                            <span>184 Main Rd E, St Albans <span class="pl__30">VIC 3021, Australia</span></span>
                        </p>
                        <p class="d-flex align-items-start text-muted gap-2">
                        ...
                        <div class="footer-social d-flex align-items-center gap-4 mt-3">
            ...
            <div class="col-lg-2 col-md-6 mb-2 accordion-item footer-accordion-item">
            ...
            <div class="col-12 col-lg-3 mb-2 accordion-item footer-accordion-item">
                ...
                <h5 class="d-none d-md-block">Newsletter Signup</h5>
                    ...
                    <div class="mt-md-4 pt-md-2">
                        ...
                        <form id="contact_form" class="d-block">
                            <div class="footer-subscribe position-relative">
                                ...
                                <button type="submit" class="btn btn-primary position-absolute rounded-pill">
                                    <span>Subscribe</span>
                                </button>
                            </div>
                        </form>
...
<div class="footer-alt mb-5 mb-lg-0 py-4 bg-light border-top">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 text-lg-start text-center text-muted">
                Copyright ©
                <script>document.write(new Date().getFullYear())</script> <a href="#!" class="link-primary">Kalles</a>
