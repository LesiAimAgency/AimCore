<footer class="footer">
    <div class="container">
        <div class="row accordion" id="footer-accordion">
            <div class="col-md-6 col-lg-4 mb-2 footer-accordion-item accordion-item">
            ...
            <div class="col-md-6 col-lg-2 mb-2 accordion-item footer-accordion-item">
            ...
            <div class="col-md-6 col-lg-2 mb-2 accordion-item footer-accordion-item">
                ...
                <h5 class="fw-medium d-none d-md-block">Follow Us</h5>
                <div id="collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="mt-md-4 pt-md-2">
                        <ul class="menu list-unstyled">
                            ...
                            <li class="menu-item">
                                <a href="#!" class="text-muted">Google Plus</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<div class="footer-alt mb-5 mb-lg-0 bg-light">
    <div class="container">
        <div class="row justify-content-center text-center text-lg-start">
            <div class="col-sm-6 text-muted">
                Copyright ©
                <script>document.write(new Date().getFullYear())</script> <a href="#!" class="text-danger-dark">Kalles</a> all rights reserved. Powered by srbthemes
            </div>
        </div>
    </div>
</div>
